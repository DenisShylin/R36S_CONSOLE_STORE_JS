import{i as L}from"./assets/vendor-C77IuWVK.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();function Q(e,o){try{const t=sessionStorage.getItem("detectedBrowserLanguage");if(t&&e.includes(t))return console.log("Using cached browser language detection:",t),t;if(!Array.isArray(e)||e.length===0)return console.warn("Invalid supportedLanguages array, using default language"),o;console.log("Detecting user language with:",{supportedLanguages:e,defaultLanguage:o});const n=m=>{if(!m)return!1;const d=m.split("-")[0].toLowerCase();return e.includes(d)?d:null},s=localStorage.getItem("userLanguage");console.log("Saved language in localStorage:",s);const i=s&&s.trim()!==""&&n(s);if(i)return console.log("Using saved language preference:",i),i;let l=[];navigator.languages&&navigator.languages.length?l=[...navigator.languages]:navigator.language?l=[navigator.language]:navigator.userLanguage?l=[navigator.userLanguage]:navigator.browserLanguage?l=[navigator.browserLanguage]:navigator.systemLanguage&&(l=[navigator.systemLanguage]),console.log("Browser language preferences:",l);for(const m of l){const d=n(m);if(d)return console.log("Found supported browser language:",d),sessionStorage.setItem("detectedBrowserLanguage",d),d}return console.log("No matching language found, using default:",o),o}catch(t){return console.error("Error in detectUserLanguage:",t),console.error("Stack trace:",t.stack),o}}function z(e){try{if(!Array.isArray(e)||e.length===0)return console.warn("Invalid supportedLanguages array passed to getLanguageFromURL"),null;const o=window.location.pathname,t="/R36S_CONSOLE_STORE_JS/";if(console.log("Current path for language detection:",o),console.log("Base URL for language detection:",t),!o||o==="/")return console.log("Empty path, no language prefix"),null;let n=o;t!=="/"&&o.startsWith(t)&&(n=o.substring(t.length)||"/"),console.log("Path without base for language detection:",n);const s=n.split("/").filter(i=>i.trim()!=="");if(console.log("Path parts for language detection:",s),s.length>0){const i=s[0].toLowerCase();if(e.includes(i))return console.log(`Found language in URL: ${i}`),i}return null}catch(o){return console.error("Error getting language from URL:",o),null}}function W(e){try{if(!e){console.warn("No language provided to updateLanguageURL");return}if(typeof e!="string"||e.trim()===""){console.warn("Invalid language value provided to updateLanguageURL");return}if(z(["en","ru","ar","be","de","es","fr","it","ja","ko","nl","pt","tr","uk"])===e){console.log("URL already has the correct language prefix, no update needed");return}console.log("Current localStorage userLanguage before URL update:",localStorage.getItem("userLanguage")),console.log("Before language URL update, current URL:",window.location.href),console.log("Updating URL for language:",e);try{if(e==="en"){const m="/R36S_CONSOLE_STORE_JS/";console.log(`Updating URL to base URL for English: ${m}`),window.history.pushState({},"",m);return}const n=new URL(window.location.href).pathname;if(n.includes(".")&&!n.endsWith("index.html")){console.log("Skipping URL update for resource file");return}const s="/R36S_CONSOLE_STORE_JS/";let l=`${s.endsWith("/")?s:s+"/"}${e}/`;if(console.log("New path with language:",l),l===n){console.log("No URL change needed, paths are identical");return}window.history.pushState({},"",l),console.log("URL updated successfully")}catch(t){console.error("Error updating URL with language:",t)}}catch(o){console.error("Error updating URL with language:",o)}}const A={},O=e=>{try{const t=`${L.language}_${e}`;if(A[t])return A[t];let n=L.t(`hero.pricing.${e}`,{defaultValue:null});return n||(e==="current"?n="$35.48 US":e==="original"?n="US $108.06":e==="discount"&&(n="-68%")),A[t]=n,n}catch(o){return console.error("Error in getLocalizedPrice:",o),""}},N=()=>{for(const e in A)delete A[e]},I={},B=["en","ru","ar","be","de","es","fr","it","ja","ko","nl","pt","tr","uk"],X={en:"English",ru:"Русский",ar:"العربية",be:"Беларуская",de:"Deutsch",es:"Español",fr:"Français",it:"Italiano",ja:"日本語",ko:"한국어",nl:"Nederlands",pt:"Português",tr:"Türkçe",uk:"Українська"},q=["hero"],ee="languageChanged",te=(e,o)=>`/R36S_CONSOLE_STORE_JS/locales/${e}/${o}.json`,j=async(e,o)=>{const t=`${e}_${o}`;if(I[t])return I[t];try{const n=te(e,o);console.log(`Загрузка перевода: ${n}`);const s=await fetch(n,{cache:"no-store",headers:{"Cache-Control":"no-cache"}});if(!s.ok){if(console.warn(`Не удалось загрузить перевод ${e}/${o}: ${s.status}`),fallbackTranslations[e]&&fallbackTranslations[e][o]){console.log(`Используем встроенный перевод для ${e}/${o}`);const l=fallbackTranslations[e][o];return I[t]=l,l}return e!=="en"?(console.log(`Пробуем загрузить запасной перевод (en) для ${o}`),j("en",o)):{}}const i=await s.json();return I[t]=i,i}catch(n){if(console.error(`Ошибка загрузки ${e}/${o} переводов:`,n),fallbackTranslations[e]&&fallbackTranslations[e][o]){console.log(`Используем встроенный перевод для ${e}/${o} после ошибки`);const s=fallbackTranslations[e][o];return I[t]=s,s}return e!=="en"?(console.log(`Пробуем загрузить запасной перевод (en) для ${o} после ошибки`),j("en",o)):{}}},P=async e=>{try{const o=await Promise.allSettled(q.map(n=>j(e,n))),t={};return o.forEach((n,s)=>{if(n.status==="fulfilled"){const i=n.value,l=q[s];t[l]=i}else console.warn(`Не удалось загрузить секцию: ${q[s]}`)}),t}catch(o){return console.error(`Ошибка загрузки переводов для ${e}:`,o),{}}},oe=()=>{try{document.querySelectorAll("[data-i18n]").forEach(e=>{const o=e.getAttribute("data-i18n");if(o)if(o.startsWith("[")){const t=o.match(/^\[(.*)\](.*)$/);if(t){const[,n,s]=t,i=L.t(s);i&&e.setAttribute(n,i)}}else{const t=L.t(o);t&&(e.hasAttribute("content")?e.setAttribute("content",t):e.textContent=t)}})}catch(e){console.error("Ошибка обновления текстовых элементов:",e)}},ne=()=>{try{const e=["ar"];document.documentElement.dir=e.includes(L.language)?"rtl":"ltr",document.documentElement.setAttribute("lang",L.language)}catch(e){console.error("Ошибка обновления поддержки RTL:",e)}},$=async()=>{try{oe(),ne(),window.dispatchEvent(new CustomEvent(ee,{detail:{language:L.language}}))}catch(e){console.error("Ошибка в updateAllContent:",e)}};async function ie(e={}){try{console.log("Setting up i18n with options:",e),console.log("Current localStorage userLanguage:",localStorage.getItem("userLanguage")),console.log("Current BASE_URL:","/R36S_CONSOLE_STORE_JS/");const{forcedLanguage:o}=e,t=localStorage.getItem("userLanguage"),n=t&&B.includes(t),s=o||(n?t:null)||Q(B,"en");console.log("Selected user language:",s);const i=await P(s);console.log(`Загруженные переводы для ${s}:`,i);const l=s!=="en"?await P("en"):null,m={[s]:{translation:i}};return l&&(m.en={translation:l}),await L.init({lng:s,fallbackLng:"en",resources:m,interpolation:{escapeValue:!1},debug:!0,load:"languageOnly",returnNull:!1,returnEmptyString:!1,missingKeyHandler:(d,g,h)=>{console.warn(`Отсутствует ключ перевода: ${h} для языка ${d} в пространстве ${g}`)}}),localStorage.setItem("userLanguage",s),L.on("languageChanged",d=>{console.log("Language changed to:",d),localStorage.setItem("userLanguage",d),W(d),typeof N=="function"&&N(),$()}),window.updateContent=$,await $(),L}catch(o){throw console.error("Error in setupI18n:",o),o}}function re(){const e=document.getElementById("language-selector");if(e)try{if(e.childElementCount===0){const o=document.createDocumentFragment();B.forEach(t=>{const n=document.createElement("option");n.value=t,n.textContent=X[t]||t,o.appendChild(n)}),e.appendChild(o)}e.value=L.language,e.addEventListener("change",async o=>{try{const t=o.target.value;if(console.log(`Language selector changed to: ${t}`),!L.hasResourceBundle(t,"translation")){const n=await P(t);L.addResourceBundle(t,"translation",n,!0,!0)}localStorage.setItem("userLanguage",t),await L.changeLanguage(t),W(t),typeof window.updateContent=="function"&&window.updateContent()}catch(t){console.error("Error changing language:",t),e.value=L.language}})}catch(o){console.error("Error setting up language selector:",o)}}function se(){let e=!1,o=window.scrollY,t=null;const n=document.querySelector(".header"),s=document.querySelector(".burger-btn"),i=document.querySelector(".burger-line"),l=document.querySelector(".mobile-menu"),m=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function d(){const c=window.scrollY,a=o<c;t&&clearTimeout(t),c>100?y(!a):y(!0),o=c,w(c>0),t=setTimeout(()=>{},150)}function g(){e=!e,h()}function h(){e?(n.classList.add("menu-open"),s.setAttribute("aria-expanded","true"),i.classList.add("open"),l.classList.add("open"),document.body.style.overflow="hidden"):(n.classList.remove("menu-open"),s.setAttribute("aria-expanded","false"),i.classList.remove("open"),l.classList.remove("open"),document.body.style.overflow="unset")}function w(c){c?n.classList.add("scrolled"):n.classList.remove("scrolled")}function y(c){c?(n.classList.add("visible"),n.classList.remove("hidden")):(n.classList.add("hidden"),n.classList.remove("visible"))}function b(c){c.preventDefault();const a=c.currentTarget.getAttribute("href"),v=a.replace("#",""),r=document.getElementById(v);r&&(y(!0),setTimeout(()=>{n.offsetHeight;const f=r.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:f,behavior:"smooth"}),e&&(e=!1,h()),window.history.replaceState(null,"",`${window.location.pathname}${a}`),setTimeout(()=>{o=window.scrollY},100)},50))}function p(){if(window.location.hash){const c=window.location.hash.replace("#",""),a=document.getElementById(c);a&&setTimeout(()=>{const v=n.offsetHeight,u=a.getBoundingClientRect().top+window.scrollY-v;window.scrollTo({top:u,behavior:"smooth"})},100)}}window.addEventListener("scroll",d),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&e&&(e=!1,h())}),s&&s.addEventListener("click",g),m.forEach(c=>{c.addEventListener("click",b)}),p()}function ae(){const e=document.querySelector(".mobile-menu");if(!e){console.error("Мобильное меню не найдено в DOM");return}const o=e.querySelector(".close-button");if(!o){console.error("Кнопка закрытия не найдена в мобильном меню");return}o.addEventListener("click",()=>{t()});function t(){e.classList.remove("open");const l=document.querySelector(".burger-line");l&&l.classList.remove("open"),document.body.style.overflow="unset";const m=document.querySelector(".header");m&&m.classList.remove("menu-open");const d=document.querySelector(".burger-btn");d&&d.setAttribute("aria-expanded","false")}e.querySelectorAll(".mobile-menu__link").forEach(l=>{l.addEventListener("click",()=>{setTimeout(()=>{t()},150)})});const s=e.querySelector(".mobile-menu__background");s&&s.addEventListener("click",()=>{t()});function i(){e.querySelectorAll(".mobile-menu__icon").forEach((m,d)=>{m.style.opacity="0",m.style.transform="translateX(-20px)",new MutationObserver(h=>{h.forEach(w=>{w.attributeName==="class"&&(e.classList.contains("open")?setTimeout(()=>{m.style.transition="all 0.4s ease",m.style.opacity="1",m.style.transform="translateX(0)"},100+d*70):(m.style.opacity="0",m.style.transform="translateX(-20px)"))})}).observe(e,{attributes:!0})})}i(),console.log("Мобильное меню с иконками инициализировано")}function le(){const e=document.querySelector(".hero"),o=document.querySelector(".hero__console-img"),t=document.querySelector(".hero__content"),n=document.querySelector(".hero__description--desktop"),s=document.querySelector(".hero__description--mobile");document.querySelector(".hero__pricing");const i=document.getElementById("buy-button"),l=document.getElementById("more-details-button"),m=document.querySelector(".hero__current-price"),d=document.querySelector(".hero__original-price"),g=document.querySelector(".hero__discount-badge");let h=null,w,y;function b(){try{if(m){const S=O("current");S&&(m.innerHTML=S)}if(d){const S=O("original");S&&(d.textContent=S)}if(g){const S=O("discount");S&&(g.textContent=S)}}catch(S){console.error("Ошибка при обновлении цен:",S)}}function p(){!o||!e||(o.onload=()=>e.classList.add("hero--loaded"),o.onerror=()=>{console.error("Не удалось загрузить изображение:",o.src),e.classList.add("hero--loaded")},o.complete&&e.classList.add("hero--loaded"))}function c(){if(!n||!s)return;const S=window.innerWidth>992;n.style.display=S?"block":"none",s.style.display=S?"none":"block"}function a(){t&&(h&&(h.disconnect(),h=null),h=new IntersectionObserver(S=>{S.forEach(_=>{var R;_.isIntersecting&&((R=_.target)!=null&&R.isConnected)&&(_.target.classList.add("animate-in"),h==null||h.unobserve(_.target))})},{threshold:.1}),t.isConnected&&h.observe(t))}function v(){i&&i.addEventListener("click",u),l&&l.addEventListener("click",f)}function r(){y=S=>{console.log("Hero секция получила событие изменения языка:",S.detail),b()},window.addEventListener("languageChanged",y)}function u(){window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}function f(S){S.preventDefault();const _=document.getElementById("features");if(!_){window.location.hash="features";return}const C=_.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:C,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}function x(){h&&h.disconnect(),clearTimeout(w),window.removeEventListener("resize",k),y&&window.removeEventListener("languageChanged",y),i&&i.removeEventListener("click",u),l&&l.removeEventListener("click",f)}function k(){clearTimeout(w),w=setTimeout(c,200)}return p(),c(),a(),v(),r(),b(),window.addEventListener("resize",k),x}function ce(e){let o=null,t=null,n=!1,s=0,i=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function m(a){a.key==="Escape"&&n&&p()}function d(){const a=document.createElement("div");return a.className="modal-about-overlay",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("tabindex","-1"),a.style.display="none",a.addEventListener("click",p),e.appendChild(a),a}function g(){return t?t.title==="Extensive color selection"&&t.colorImages?`
      <img
        src="${t.colorImages[s]}"
...
- Classic Black
- Vibrant Orange
- Mesmerizing Purple ...`,colorImages:[Y,J,de,ue],imageAlt:"R36S Color Variants"},{id:5,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
• Quick startup for instant gaming access`,videoUrl:ge,imageAlt:"R36S Portability"}];function i(){console.log("Начинаем рендеринг карточек..."),e.innerHTML="";const p=s.map(a=>`
