...
• Quick startup for instant gaming access`,videoUrl:V,imageAlt:"R36S Portability"}];function r(){console.log("Начинаем рендеринг карточек..."),t.innerHTML="";const p=n.map(s=>`
    ...
    `).join("");t.innerHTML=p;const a=t.querySelectorAll(".about-card");console.log(`Отрендерено ${a.length} карточек из ${n.length} необходимых`),a.length!==n.length?console.warn(`Ошибка рендеринга: отрендерено ${a.length} карточек вместо ${n.length}`):console.log("Рендеринг карточек успешно завершен")}const d=m(function(p){if(!p||!p.currentTarget)return;const a=p.currentTarget;if(!a||!a.getBoundingClientRect){console.warn("handleMouseMove: элемент карточки не существует или недоступен");return}try{const s=a.getBoundingClientRect();i={x:p.clientX-s.left,y:p.clientY-s.top},a.style.setProperty("--mouse-x",`${i.x}px`),a.style.setProperty("--mouse-y",`${i.y}px`)}catch(s){console.error("Ошибка при обработке движения мыши:",s)}},16);function m(p,a){let s,f;return function(){const o=this,c=arguments;f?(clearTimeout(s),s=setTimeout(function(){Date.now()-f>=a&&(p.apply(o,c),f=Date.now())},a-(Date.now()-f))):(p.apply(o,c),f=Date.now())}}function u(p){if(!p||!p.currentTarget){console.warn("handleButtonClick: событие или цель события не существует");return}p.stopPropagation();try{const a=parseInt(p.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",a);const s=n.find(f=>f.id===a);if(!s){console.error("Данные для карточки не найдены");return}e&&e.open(s)}catch(a){console.error("Ошибка при обработке клика по кнопке:",a)}}function g(p,a){let s;return function(){const f=this,o=arguments;clearTimeout(s),s=setTimeout(()=>{p.apply(f,o)},a)}}function w(){console.log("Очистка обработчиков событий карточек...");try{const p=document.querySelectorAll(".about-card");p&&p.length>0&&p.forEach(s=>{s&&(s.removeEventListener("mouseenter",()=>{}),s.removeEventListener("mouseleave",()=>{}),s.removeEventListener("mousemove",d))});const a=document.querySelectorAll(".about-card__button");a&&a.length>0&&a.forEach(s=>{s&&s.removeEventListener("click",u)}),t&&t.removeEventListener("click",()=>{}),console.log("Очистка обработчиков завершена")}catch(p){console.error("Ошибка при очистке обработчиков событий:",p)}}function v(){console.log("Настройка обработчиков событий для карточек...");const p=()=>{console.log("Проверяем наличие карточек для установки обработчиков...");const a=document.querySelectorAll(".about-card");if(!a||a.length===0){console.warn("Не найдены карточки для установки обработчиков событий"),setTimeout(p,200);return}console.log(`Устанавливаем обработчики событий для ${a.length} карточек`);const s=window.matchMedia("(max-width: 768px)").matches;!s&&t&&t.addEventListener("click",function(o){const c=o.target.closest(".about-card");if(c&&!o.target.closest(".about-card__button")){const h=parseInt(c.dataset.id);console.log("Клик по карточке ID:",h);const _=n.find(S=>S.id===h);if(!_){console.error("Данные для карточки не найдены");return}e&&e.open(_)}}),a.forEach(o=>{o&&(o.addEventListener("mouseenter",function(){o&&(parseInt(o.dataset.id),o.classList.add("active"))}),o.addEventListener("mouseleave",function(){o&&o.classList.remove("active")}),o.addEventListener("mousemove",d))});const f=document.querySelectorAll(".about-card__button");f&&f.length>0?(f.forEach(o=>{o&&o.addEventListener("click",u)}),console.log(`Установлены обработчики для ${f.length} кнопок`)):console.warn("Не найдены кнопки карточек"),window.addEventListener("resize",g(()=>{const o=!s,c=!window.matchMedia("(max-width: 768px)").matches;o!==c&&(w(),v())},250)),console.log("Настройка обработчиков событий успешно завершена")};document.readyState==="complete"||document.readyState==="interactive"?setTimeout(p,10):document.addEventListener("DOMContentLoaded",p)}function b(){console.log("Очистка всех обработчиков событий..."),w(),window.removeEventListener("resize",g),e=null,console.log("Очистка обработчиков событий завершена")}function y(){return function(){console.log("Запуск функции очистки секции About"),b()}}try{return console.log("Начинаем инициализацию секции About..."),console.log("Рендерим карточки..."),r(),console.log("Устанавливаем обработчики событий..."),v(),console.log("Инициализация About завершена успешно"),y()}catch(p){return console.error("Ошибка при инициализации About:",p),null}}function X(){const t=document.getElementById("features"),i=document.getElementById("featuresVideo"),e=document.getElementById("soundToggleButton"),l=document.getElementById("volumeOffIcon"),n=document.getElementById("volumeOnIcon"),r=document.getElementById("buyButton"),d=document.getElementById("moreInfoButton");if(!t){console.warn("Features section not found");return}i&&(i.volume=.5,i.play().catch(u=>{console.log("Автовоспроизведение не удалось:",u)})),r&&r.addEventListener("click",B),d&&d.addEventListener("click",M),e&&e.addEventListener("click",()=>T(i,l,n));const m=()=>{K(t,i,l,n)};return window.addEventListener("scroll",m),function(){r&&r.removeEventListener("click",B),d&&d.removeEventListener("click",M),e&&e.removeEventListener("click",()=>T(i,l,n)),window.removeEventListener("scroll",m),console.log("Features component cleaned up")}}function T(t,i,e){if(t)if(t.muted=!t.muted,t.muted){i.style.display="block",e.style.display="none";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Включить звук")}else{t.volume=.5,i.style.display="none",e.style.display="block";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Выключить звук")}}function K(t,i,e,l){if(!t||!i||i.muted)return;const n=t.getBoundingClientRect();if(!(n.top<window.innerHeight&&n.bottom>0)){i.muted=!0,e.style.display="block",l.style.display="none";const d=document.getElementById("soundToggleButton");d&&d.setAttribute("aria-label","Включить звук")}}function B(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function M(){const t=document.getElementById("features-r36s"),i=document.querySelector(".header");if(t&&i){const e=i.offsetHeight,l=t.getBoundingClientRect().top,n=window.scrollY||window.pageYOffset,r=l+n-e;window.scrollTo({top:r,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function ee(){try{let o=function(){m&&(m.innerHTML=y?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},c=function(){u&&(u.innerHTML=p?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
• A quick press of the power button will put the device into standby mode.`,images:{jpg:e.i9.jpg,webp:e.i9.webp}}},{id:"downloads",title:"Available Downloads",content:{downloads:[{file:"Firmware v1.0.4 2024.04.13",link:"https://drive.google.com/file/d/10z7j7IZ7WX3y10ZJBW_a2-agcIe1Dx9m/edit",date:"2024.04.13",version:"v1.0.4"},{file:"ArkOS_K36_v2.0_03112025.img.xz",link:"https://drive.google.com/file/d/1F93Q1jXYaTCftOlzAt0BaM43rmVexXsn/view",date:"2023.12.22",version:"v1.0.3"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P3.img.xz",link:"https://drive.google.com/file/d/18VL7uLNdyFKDH4_V8YM5zhHSjLiJdkUc/view",date:"2023.11.16",version:"v1.0.2"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P4.img.xz",link:"https://drive.google.com/file/d/1MT1AGGch6Ou4RAfxDvVCxUI4aXX6Qa5v/view",date:"2023.11.05",version:"v1.0.0"}]}}];let n="downloads",r=!1;const d=document.getElementById("products-nav-list"),m=document.getElementById("products-sections"),u=document.getElementById("products-nav");function g(){r=window.innerWidth<=1024,u&&(r?u.classList.add("nav-mobile"):u.classList.remove("nav-mobile"))}function w(a){n=a,document.querySelectorAll(".nav-item").forEach(o=>{o.dataset.sectionId===a?o.classList.add("nav-item-active"):o.classList.remove("nav-item-active")}),document.querySelectorAll(".section").forEach(o=>{o.id===a?o.classList.add("section-active"):o.classList.remove("section-active")}),setTimeout(()=>{const o=document.getElementById(a);if(o){const c=r?80:20,_=o.getBoundingClientRect().top+window.pageYOffset-c;window.scrollTo({top:_,behavior:"smooth"})}},100)}function v(){d.innerHTML="",l.forEach(a=>{const s=document.createElement("button");s.className=`nav-item ${n===a.id?"nav-item-active":""}`,s.dataset.sectionId=a.id,s.innerHTML=`
        ...
        <span>${a.title}</span>
      `,s.addEventListener("click",()=>w(a.id)),d.appendChild(s)})}function b(a){if(a.id==="downloads"){let o='<div class="download-list">';return a.content.downloads.forEach(c=>{o+=`
