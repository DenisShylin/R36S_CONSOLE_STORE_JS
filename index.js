...
Take your gaming anywhere – play more, charge less.`,videoUrl:A,imageAlt:"Battery Life"},{id:4,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
- Dynamic Red
- Pure White
- Radiant Yellow ...`,colorImages:[k,R,O,Z],imageAlt:"R36S Color Variants"},{id:5,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
Never compromise between portability and performance - the R36S delivers both in a perfectly portable package.`,videoUrl:B,imageAlt:"R36S Portability"}];function n(){i.innerHTML=s.map(l=>`
