(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&s(u)}).observe(document,{childList:!0,subtree:!0});function e(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=e(i);fetch(i.href,a)}})();function E(){console.log("Hero section initialized");const n=document.querySelector(".hero"),o=document.querySelector(".hero__console-img"),e=document.querySelector(".hero__content"),s=document.querySelector(".hero__description--desktop"),i=document.querySelector(".hero__description--mobile"),a=document.querySelector(".hero__pricing"),u=document.getElementById("buy-button"),g=document.getElementById("more-details-button");let d=null;function l(){if(!o){console.error("Hero image element not found");return}console.log("Setting up hero image"),o.onerror=()=>{console.error("Failed to load hero image:",o.src);try{const t=o.getAttribute("srcset");if(t){const c=t.split(",");if(c&&c.length>0){const p=c[0].split(" ")[0];console.log("Using fallback image:",p),o.src=p}}}catch(t){console.error("Error setting fallback image:",t)}n&&n.classList.add("hero--loaded")},o.onload=()=>{console.log("Hero image loaded successfully"),n&&n.classList.add("hero--loaded")},o.decoding="async",o.complete&&(console.log("Hero image already loaded (from cache)"),n&&n.classList.add("hero--loaded"))}function r(){const t=window.innerWidth>992;s&&i&&a&&(t?(s.style.display="block",i.style.display="none"):(s.style.display="none",i.style.display="block"))}function h(){if(e){d&&(d.disconnect(),d=null);try{d=new IntersectionObserver(t=>{try{t.forEach(c=>{c.isIntersecting&&c.target&&c.target.isConnected&&(c.target.classList.add("animate-in"),d&&d.unobserve(c.target))})}catch(c){console.warn("Error in IntersectionObserver callback:",c)}},{threshold:.1}),e&&e.isConnected&&d.observe(e)}catch(t){console.warn("Error setting up IntersectionObserver:",t)}}}function b(){u&&(u.removeEventListener("click",v),u.addEventListener("click",v)),g&&(g.removeEventListener("click",m),g.addEventListener("click",m))}function v(){try{window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}catch(t){console.error("Error opening product link:",t)}}function m(t){t.preventDefault();const c=document.getElementById("features"),p=document.querySelector(".header");if(c&&p)try{const y=p.offsetHeight,I=c.getBoundingClientRect().top,S=window.scrollY||window.pageYOffset,x=I+S-y;window.scrollTo({top:x,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}catch(y){console.error("Error scrolling to features:",y),window.location.hash="features"}}function f(){try{d&&(d.disconnect(),d=null),window.removeEventListener("resize",r),u&&u.removeEventListener("click",v),g&&g.removeEventListener("click",m),window.removeEventListener("unload",f),window.removeEventListener("beforeunload",f)}catch(t){console.warn("Error during cleanup:",t)}}return l(),r(),h(),b(),window.removeEventListener("resize",r),window.addEventListener("resize",r),typeof window<"u"&&(window.removeEventListener("beforeunload",f),window.addEventListener("beforeunload",f)),f}function _(n){let o=null,e=null,s=!1,i=0,a=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function g(t){t.key==="Escape"&&s&&m()}function d(){const t=document.createElement("div");return t.className="modal-about-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("tabindex","-1"),t.style.display="none",t.addEventListener("click",m),n.appendChild(t),t}function l(){return e?e.title==="Extensive color selection"&&e.colorImages?`
      <img
        src="${e.colorImages[i]}"
  ...
  `:""}function r(){(e==null?void 0:e.title)==="Extensive color selection"&&e.colorImages&&(a&&clearInterval(a),a=setInterval(()=>{i=i===e.colorImages.length-1?0:i+1;const t=o.querySelector(".modal-about-image");t&&(t.src=e.colorImages[i],t.alt=`R36S Color Variant ${i+1}`)},1e3))}function h(){if(!o||!e)return;const t={"@context":"https://schema.org","@type":"ItemPage",mainEntity:{"@type":"Product",name:"R36S Handheld Game Console",description:e.fullDescription,image:e.imageUrl||(e.colorImages?e.colorImages[0]:""),offers:{"@type":"Offer",price:"35.48",priceCurrency:"USD",url:"https://www.aliexpress.com/item/1005007171465465.html"},category:"Video Game Console",feature:e.title}};e.id===1&&(t.mainEntity.faqPage={"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How many games are included in the R36S console?",acceptedAnswer:{"@type":"Answer",text:"The R36S console includes over 15,000 classic retro games from various platforms."}}]});const c=`
      ...
      `;const p=o.querySelector(".modal-about-close");p&&p.addEventListener("click",m);const y=o.querySelector(".modal-about-content");y&&y.addEventListener("click",I=>I.stopPropagation())}function b(t){e=t,o||(o=d()),h();const c=window.location.href,p=new URL(c);return p.searchParams.set("feature",e.id),window.history.pushState({featureId:e.id},"",p),o.style.display="flex",s=!0,o.focus(),window.addEventListener("keydown",g),document.body.style.overflow="hidden",r(),window.addEventListener("popstate",v),{close:m}}function v(t){s&&(!t.state||!t.state.featureId)&&m()}function m(){if(!s||!o)return;s=!1,o.style.display="none",window.removeEventListener("keydown",g),window.removeEventListener("popstate",v),document.body.style.overflow="visible",a&&(clearInterval(a),a=null);const t=new URL(window.location.href);t.searchParams.delete("feature"),window.history.pushState({},"",t)}function f(){m(),o&&n.contains(o)&&n.removeChild(o),o=null,e=null}return{open:b,close:m,destroy:f}}const L="/R36S_CONSOLE_STORE_JS/video/about/video_1_.gif",C="/R36S_CONSOLE_STORE_JS/video/about/video_2_.gif",k="/R36S_CONSOLE_STORE_JS/img/about/Untitled_1_1x.jpg",R="/R36S_CONSOLE_STORE_JS/img/about/Untitled_2_1x.jpg",O="/R36S_CONSOLE_STORE_JS/img/about/Untitled_3_1x.jpg",M="/R36S_CONSOLE_STORE_JS/img/about/Untitled_4_1x.jpg",A="/R36S_CONSOLE_STORE_JS/video/about/video_3_batrey_.mp4",B="/R36S_CONSOLE_STORE_JS/video/about/video_6_.mp4",j="/R36S_CONSOLE_STORE_JS/video/about/video_4_.mp4";function D(){console.log("Инициализация секции About");const n=document.querySelector(".about__cards");if(!n)return console.error("Контейнер для карточек не найден"),null;let o={x:0,y:0},e=null;const s=[{id:1,icon:`
        <svg
...
- Classic Black
- Vibrant Orange
- Mesmerizing Purple ...`,colorImages:[k,R,O,M],imageAlt:"R36S Color Variants"},{id:5,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
- Low latency connection for seamless gameplay`,videoUrl:j,imageAlt:"R36S Settings"},{id:6,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
• Quick startup for instant gaming access`,videoUrl:B,imageAlt:"R36S Portability"}];function i(){n.innerHTML=s.map(l=>`
    ...
    `).join("")}function a(l){const r=l.currentTarget,h=r.getBoundingClientRect();o={x:l.clientX-h.left,y:l.clientY-h.top},r.style.setProperty("--mouse-x",`${o.x}px`),r.style.setProperty("--mouse-y",`${o.y}px`)}function u(l){const r=parseInt(l.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",r);const h=s.find(b=>b.id===r);if(!h){console.error("Данные для карточки не найдены");return}e||(e=_(document.body)),e.open(h)}function g(){document.querySelectorAll(".about-card").forEach(r=>{r.addEventListener("mouseenter",()=>{parseInt(r.dataset.id),r.classList.add("active")}),r.addEventListener("mouseleave",()=>{r.classList.remove("active")}),r.addEventListener("mousemove",a)}),document.querySelectorAll(".about-card__button").forEach(r=>{r.addEventListener("click",u)})}function d(){document.querySelectorAll(".about-card").forEach(r=>{r.removeEventListener("mouseenter",()=>{}),r.removeEventListener("mouseleave",()=>{}),r.removeEventListener("mousemove",a)}),document.querySelectorAll(".about-card__button").forEach(r=>{r.removeEventListener("click",u)}),e&&(e.destroy(),e=null)}try{console.log("Рендерим карточки..."),i(),console.log("Устанавливаем обработчики событий..."),g(),console.log("Инициализация About завершена успешно")}catch(l){console.error("Ошибка при инициализации About:",l)}return function(){console.log("Очистка секции About"),d()}}console.log("Main.js инициализирован");let w=[];function Z(){const n="IntersectionObserver"in window,o=function(){const s=document.createElement("div");return s.style.display="flex",s.style.display==="flex"}(),e=function(){const s=document.createElement("div");return s.style.display="grid",s.style.display==="grid"}();return console.log("Поддержка браузера:"),console.log("- IntersectionObserver:",n),console.log("- Flexbox:",o),console.log("- CSS Grid:",e),n||document.body.classList.add("no-intersection-observer"),o||document.body.classList.add("no-flexbox"),e||document.body.classList.add("no-grid"),{hasIntersectionObserver:n,hasFlexbox:o,hasGrid:e}}function U(){try{w.forEach(n=>{typeof n=="function"&&n()}),w=[]}catch(n){console.warn("Error during global cleanup:",n)}}document.addEventListener("DOMContentLoaded",()=>{console.log("DOM загружен");try{const n=Z(),o=E();typeof o=="function"&&w.push(o);const e=D();typeof e=="function"&&w.push(e);const s=performance.now();console.log(`Страница загружена за ${s.toFixed(2)}ms`),window.addEventListener("beforeunload",U)}catch(n){console.error("Ошибка при инициализации страницы:",n)}});window.onerror=function(n,o,e,s,i){return console.error("Глобальная ошибка:",{message:n,source:o,lineno:e,colno:s,error:i}),!1};window.addEventListener("unhandledrejection",function(n){console.warn("Непойманное отклонение промиса (unhandled promise rejection):",n.reason)});window.appVersion={version:"1.0.0",buildDate:new Date().toISOString(),environment:"production",basePath:"/R36S_CONSOLE_STORE_JS/"};console.log("Main.js выполнение завершено");
