(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function e(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(n){if(n.ep)return;n.ep=!0;const r=e(n);fetch(n.href,r)}})();function H(){let t=!1,i=window.scrollY,e=null;const l=document.querySelector(".header"),n=document.querySelector(".burger-btn"),r=document.querySelector(".burger-line"),c=document.querySelector(".mobile-menu"),m=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function u(){const a=window.scrollY,s=i<a;e&&clearTimeout(e),a>100?b(!s):b(!0),i=a,v(a>0),e=setTimeout(()=>{},150)}function g(){t=!t,w()}function w(){t?(l.classList.add("menu-open"),n.setAttribute("aria-expanded","true"),r.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"):(l.classList.remove("menu-open"),n.setAttribute("aria-expanded","false"),r.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow="unset")}function v(a){a?l.classList.add("scrolled"):l.classList.remove("scrolled")}function b(a){a?(l.classList.add("visible"),l.classList.remove("hidden")):(l.classList.add("hidden"),l.classList.remove("visible"))}function y(a){a.preventDefault();const s=a.currentTarget.getAttribute("href"),f=s.replace("#",""),o=document.getElementById(f);o&&(b(!0),setTimeout(()=>{l.offsetHeight;const h=o.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:h,behavior:"smooth"}),t&&(t=!1,w()),window.history.replaceState(null,"",`${window.location.pathname}${s}`),setTimeout(()=>{i=window.scrollY},100)},50))}function p(){if(window.location.hash){const a=window.location.hash.replace("#",""),s=document.getElementById(a);s&&setTimeout(()=>{const f=l.offsetHeight,d=s.getBoundingClientRect().top+window.scrollY-f;window.scrollTo({top:d,behavior:"smooth"})},100)}}window.addEventListener("scroll",u),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&t&&(t=!1,w())}),n&&n.addEventListener("click",g),m.forEach(a=>{a.addEventListener("click",y)}),p()}function G(){const t=document.querySelector(".mobile-menu");if(!t){console.error("Мобильное меню не найдено в DOM");return}const i=t.querySelector(".close-button");if(!i){console.error("Кнопка закрытия не найдена в мобильном меню");return}i.addEventListener("click",()=>{e()});function e(){t.classList.remove("open");const c=document.querySelector(".burger-line");c&&c.classList.remove("open"),document.body.style.overflow="unset";const m=document.querySelector(".header");m&&m.classList.remove("menu-open");const u=document.querySelector(".burger-btn");u&&u.setAttribute("aria-expanded","false")}t.querySelectorAll(".mobile-menu__link").forEach(c=>{c.addEventListener("click",()=>{setTimeout(()=>{e()},150)})});const n=t.querySelector(".mobile-menu__background");n&&n.addEventListener("click",()=>{e()});function r(){t.querySelectorAll(".mobile-menu__icon").forEach((m,u)=>{m.style.opacity="0",m.style.transform="translateX(-20px)",new MutationObserver(w=>{w.forEach(v=>{v.attributeName==="class"&&(t.classList.contains("open")?setTimeout(()=>{m.style.transition="all 0.4s ease",m.style.opacity="1",m.style.transform="translateX(0)"},100+u*70):(m.style.opacity="0",m.style.transform="translateX(-20px)"))})}).observe(t,{attributes:!0})})}r(),console.log("Мобильное меню с иконками инициализировано")}function z(){const t=document.querySelector(".hero"),i=document.querySelector(".hero__console-img"),e=document.querySelector(".hero__content"),l=document.querySelector(".hero__description--desktop"),n=document.querySelector(".hero__description--mobile");document.querySelector(".hero__pricing");const r=document.getElementById("buy-button"),c=document.getElementById("more-details-button");let m=null,u;function g(){!i||!t||(i.onload=()=>t.classList.add("hero--loaded"),i.onerror=()=>{console.error("Не удалось загрузить изображение:",i.src),t.classList.add("hero--loaded")},i.complete&&t.classList.add("hero--loaded"))}function w(){if(!l||!n)return;const f=window.innerWidth>992;l.style.display=f?"block":"none",n.style.display=f?"none":"block"}function v(){e&&(m&&(m.disconnect(),m=null),m=new IntersectionObserver(f=>{f.forEach(o=>{var d;o.isIntersecting&&((d=o.target)!=null&&d.isConnected)&&(o.target.classList.add("animate-in"),m==null||m.unobserve(o.target))})},{threshold:.1}),e.isConnected&&m.observe(e))}function b(){r&&r.addEventListener("click",y),c&&c.addEventListener("click",p)}function y(){window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}function p(f){f.preventDefault();const o=document.getElementById("features");if(!o){window.location.hash="features";return}const h=o.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:h,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}function a(){m&&m.disconnect(),clearTimeout(u),window.removeEventListener("resize",s),r&&r.removeEventListener("click",y),c&&c.removeEventListener("click",p)}function s(){clearTimeout(u),u=setTimeout(w,200)}return g(),w(),v(),b(),window.addEventListener("resize",s),a}function W(t){let i=null,e=null,l=!1,n=0,r=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function m(s){s.key==="Escape"&&l&&p()}function u(){const s=document.createElement("div");return s.className="modal-about-overlay",s.setAttribute("role","dialog"),s.setAttribute("aria-modal","true"),s.setAttribute("tabindex","-1"),s.style.display="none",s.addEventListener("click",p),t.appendChild(s),s}function g(){return e?e.title==="Extensive color selection"&&e.colorImages?`
      <img
        src="${e.colorImages[n]}"
  ...
  `:""}function w(){(e==null?void 0:e.title)==="Extensive color selection"&&e.colorImages&&(r&&clearInterval(r),r=setInterval(()=>{n=n===e.colorImages.length-1?0:n+1;const s=i.querySelector(".modal-about-image");s&&(s.src=e.colorImages[n],s.alt=`R36S Color Variant ${n+1}`)},1e3))}function v(){if(!i||!e)return;const s={"@context":"https://schema.org","@type":"ItemPage",mainEntity:{"@type":"Product",name:"R36S Handheld Game Console",description:e.fullDescription,image:e.imageUrl||(e.colorImages?e.colorImages[0]:""),offers:{"@type":"Offer",price:"35.48",priceCurrency:"USD",url:"https://www.aliexpress.com/item/1005007171465465.html"},category:"Video Game Console",feature:e.title}};e.id===1&&(s.mainEntity.faqPage={"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How many games are included in the R36S console?",acceptedAnswer:{"@type":"Answer",text:"The R36S console includes over 15,000 classic retro games from various platforms."}}]});const f=`
      ...
      `;const o=i.querySelector(".modal-about-close");o&&o.addEventListener("click",p);const d=i.querySelector(".modal-about-content");d&&d.addEventListener("click",h=>h.stopPropagation())}function b(s){e=s,i||(i=u()),v();const f=window.location.href,o=new URL(f);return o.searchParams.set("feature",e.id),window.history.pushState({featureId:e.id},"",o),i.style.display="flex",l=!0,i.focus(),window.addEventListener("keydown",m),document.body.style.overflow="hidden",w(),window.addEventListener("popstate",y),{close:p}}function y(s){l&&(!s.state||!s.state.featureId)&&p()}function p(){if(!l||!i)return;l=!1,i.style.display="none",window.removeEventListener("keydown",m),window.removeEventListener("popstate",y),document.body.style.overflow="visible",r&&(clearInterval(r),r=null);const s=new URL(window.location.href);s.searchParams.delete("feature"),window.history.pushState({},"",s)}function a(){p(),i&&t.contains(i)&&t.removeChild(i),i=null,e=null}return{open:b,close:p,destroy:a}}const D="/R36S_CONSOLE_STORE_JS/video/about/video_1_.webp",N="/R36S_CONSOLE_STORE_JS/video/about/video_2_.webp",P="/R36S_CONSOLE_STORE_JS/img/about/Untitled_1_1x.jpg",$="/R36S_CONSOLE_STORE_JS/img/about/Untitled_2_1x.jpg",U="/R36S_CONSOLE_STORE_JS/img/about/Untitled_3_1x.jpg",Z="/R36S_CONSOLE_STORE_JS/img/about/Untitled_4_1x.jpg",F="/R36S_CONSOLE_STORE_JS/video/about/video_3_batrey_.mp4",V="/R36S_CONSOLE_STORE_JS/video/about/video_6_.mp4",Y="/R36S_CONSOLE_STORE_JS/video/about/video_4_.mp4";let A=null;function J(){if(console.log("Начинаем предзагрузку изображений..."),[D,N,P,$].forEach(i=>{const e=new Image;e.src=i}),"HTMLVideoElement"in window){const i=document.createElement("video");i.preload="metadata",i.src=F}console.log("Предзагрузка изображений завершена")}function Q(){console.log("Инициализация секции About"),J();const t=document.querySelector(".about__cards");if(!t)return console.error("Контейнер для карточек не найден"),null;let i={x:0,y:0};A||(console.log("Создаем модальное окно..."),A=W(document.body),console.log("Модальное окно создано"));let e=A;const n=[{id:1,icon:`
        <svg
...
• Scratch-resistant surface`,imageUrl:N,imageAlt:"Display Technologies"},{id:3,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
- Full-screen IPS display`,videoUrl:F,imageAlt:"Battery Life"},{id:4,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
- Classic Black
- Vibrant Orange
- Mesmerizing Purple ...`,colorImages:[P,$,U,Z],imageAlt:"R36S Color Variants"},{id:5,icon:`
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="about-card__icon"
          width="44"
...
• Quick startup for instant gaming access`,videoUrl:V,imageAlt:"R36S Portability"}];function r(){console.log("Начинаем рендеринг карточек..."),t.innerHTML="";const p=n.map(s=>`
    ...
    `).join("");t.innerHTML=p;const a=t.querySelectorAll(".about-card");console.log(`Отрендерено ${a.length} карточек из ${n.length} необходимых`),a.length!==n.length?console.warn(`Ошибка рендеринга: отрендерено ${a.length} карточек вместо ${n.length}`):console.log("Рендеринг карточек успешно завершен")}const c=m(function(p){if(!p||!p.currentTarget)return;const a=p.currentTarget;if(!a||!a.getBoundingClientRect){console.warn("handleMouseMove: элемент карточки не существует или недоступен");return}try{const s=a.getBoundingClientRect();i={x:p.clientX-s.left,y:p.clientY-s.top},a.style.setProperty("--mouse-x",`${i.x}px`),a.style.setProperty("--mouse-y",`${i.y}px`)}catch(s){console.error("Ошибка при обработке движения мыши:",s)}},16);function m(p,a){let s,f;return function(){const o=this,d=arguments;f?(clearTimeout(s),s=setTimeout(function(){Date.now()-f>=a&&(p.apply(o,d),f=Date.now())},a-(Date.now()-f))):(p.apply(o,d),f=Date.now())}}function u(p){if(!p||!p.currentTarget){console.warn("handleButtonClick: событие или цель события не существует");return}p.stopPropagation();try{const a=parseInt(p.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",a);const s=n.find(f=>f.id===a);if(!s){console.error("Данные для карточки не найдены");return}e&&e.open(s)}catch(a){console.error("Ошибка при обработке клика по кнопке:",a)}}function g(p,a){let s;return function(){const f=this,o=arguments;clearTimeout(s),s=setTimeout(()=>{p.apply(f,o)},a)}}function w(){console.log("Очистка обработчиков событий карточек...");try{const p=document.querySelectorAll(".about-card");p&&p.length>0&&p.forEach(s=>{s&&(s.removeEventListener("mouseenter",()=>{}),s.removeEventListener("mouseleave",()=>{}),s.removeEventListener("mousemove",c))});const a=document.querySelectorAll(".about-card__button");a&&a.length>0&&a.forEach(s=>{s&&s.removeEventListener("click",u)}),t&&t.removeEventListener("click",()=>{}),console.log("Очистка обработчиков завершена")}catch(p){console.error("Ошибка при очистке обработчиков событий:",p)}}function v(){console.log("Настройка обработчиков событий для карточек...");const p=()=>{console.log("Проверяем наличие карточек для установки обработчиков...");const a=document.querySelectorAll(".about-card");if(!a||a.length===0){console.warn("Не найдены карточки для установки обработчиков событий"),setTimeout(p,200);return}console.log(`Устанавливаем обработчики событий для ${a.length} карточек`);const s=window.matchMedia("(max-width: 768px)").matches;!s&&t&&t.addEventListener("click",function(o){const d=o.target.closest(".about-card");if(d&&!o.target.closest(".about-card__button")){const h=parseInt(d.dataset.id);console.log("Клик по карточке ID:",h);const _=n.find(S=>S.id===h);if(!_){console.error("Данные для карточки не найдены");return}e&&e.open(_)}}),a.forEach(o=>{o&&(o.addEventListener("mouseenter",function(){o&&(parseInt(o.dataset.id),o.classList.add("active"))}),o.addEventListener("mouseleave",function(){o&&o.classList.remove("active")}),o.addEventListener("mousemove",c))});const f=document.querySelectorAll(".about-card__button");f&&f.length>0?(f.forEach(o=>{o&&o.addEventListener("click",u)}),console.log(`Установлены обработчики для ${f.length} кнопок`)):console.warn("Не найдены кнопки карточек"),window.addEventListener("resize",g(()=>{const o=!s,d=!window.matchMedia("(max-width: 768px)").matches;o!==d&&(w(),v())},250)),console.log("Настройка обработчиков событий успешно завершена")};document.readyState==="complete"||document.readyState==="interactive"?setTimeout(p,10):document.addEventListener("DOMContentLoaded",p)}function b(){console.log("Очистка всех обработчиков событий..."),w(),window.removeEventListener("resize",g),e=null,console.log("Очистка обработчиков событий завершена")}function y(){return function(){console.log("Запуск функции очистки секции About"),b()}}try{return console.log("Начинаем инициализацию секции About..."),console.log("Рендерим карточки..."),r(),console.log("Устанавливаем обработчики событий..."),v(),console.log("Инициализация About завершена успешно"),y()}catch(p){return console.error("Ошибка при инициализации About:",p),null}}function X(){const t=document.getElementById("features"),i=document.getElementById("featuresVideo"),e=document.getElementById("soundToggleButton"),l=document.getElementById("volumeOffIcon"),n=document.getElementById("volumeOnIcon"),r=document.getElementById("buyButton"),c=document.getElementById("moreInfoButton");if(!t){console.warn("Features section not found");return}i&&(i.volume=.5,i.play().catch(u=>{console.log("Автовоспроизведение не удалось:",u)})),r&&r.addEventListener("click",B),c&&c.addEventListener("click",M),e&&e.addEventListener("click",()=>T(i,l,n));const m=()=>{K(t,i,l,n)};return window.addEventListener("scroll",m),function(){r&&r.removeEventListener("click",B),c&&c.removeEventListener("click",M),e&&e.removeEventListener("click",()=>T(i,l,n)),window.removeEventListener("scroll",m),console.log("Features component cleaned up")}}function T(t,i,e){if(t)if(t.muted=!t.muted,t.muted){i.style.display="block",e.style.display="none";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Включить звук")}else{t.volume=.5,i.style.display="none",e.style.display="block";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Выключить звук")}}function K(t,i,e,l){if(!t||!i||i.muted)return;const n=t.getBoundingClientRect();if(!(n.top<window.innerHeight&&n.bottom>0)){i.muted=!0,e.style.display="block",l.style.display="none";const c=document.getElementById("soundToggleButton");c&&c.setAttribute("aria-label","Включить звук")}}function B(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function M(){const t=document.getElementById("features-r36s");if(t){const i=t.getBoundingClientRect().top,e=window.scrollY||window.pageYOffset,l=i+e;window.scrollTo({top:l,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function ee(){try{let o=function(){m&&(m.innerHTML=y?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},d=function(){u&&(u.innerHTML=p?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},h=function(){if(!(!n||s))if(y)n.pause(),y=!1,o();else{const S=n.play();S!==void 0?S.then(()=>{y=!0,o()}).catch(x=>{console.warn("Не удалось воспроизвести видео:",x),y=!1,o()}):(y=!0,o())}},_=function(){w&&(s=!0,n&&(n.style.display="none"),w.innerHTML=`
      ...
      `)};var t=o,i=d,e=h,l=_;console.log("Инициализация секции Categories");const n=document.querySelector(".categories__video"),r=document.getElementById("categories"),c=document.querySelector(".categories__content"),m=document.querySelector(".categories__video-play"),u=document.querySelector(".categories__video-mute"),g=document.querySelector(".categories__video-slider"),w=document.querySelector(".categories__video-container"),v=document.querySelector(".categories__video-time span:first-child"),b=document.querySelector(".categories__video-time span:last-child");if(!r)return console.error("Секция Categories не найдена в DOM"),{};if(c&&c.classList.add("animate-in"),!n)return console.error("Видео элемент не найден в DOM"),_(),{};let y=!1,p=!0,a=!1,s=!1;const f=S=>{if(isNaN(S)||S<0)return"0:00";const x=Math.floor(S/60),E=Math.floor(S%60);return`${x}:${E.toString().padStart(2,"0")}`};return n&&(n.muted=!0,n.loop=!0,n.playsInline=!0,n.style.display="block",n.style.visibility="visible",n.style.opacity="1",n.style.width="100%",n.style.borderRadius="24px",w&&(w.style.minHeight="200px"),n.addEventListener("loadedmetadata",()=>{try{console.log("Метаданные видео загружены"),a=!0,g&&!isNaN(n.duration)&&(g.max=n.duration,b&&(b.textContent=f(n.duration)))}catch(S){console.error("Ошибка при обработке метаданных видео:",S)}}),n.addEventListener("timeupdate",()=>{try{g&&!isNaN(n.currentTime)&&(g.value=n.currentTime,v&&(v.textContent=f(n.currentTime)))}catch(S){console.error("Ошибка при обновлении времени видео:",S)}}),n.addEventListener("error",()=>{console.error("Ошибка при загрузке видео"),_()}),setTimeout(()=>{if(n&&!s){const S=n.play();S!==void 0&&S.then(()=>{console.log("Автовоспроизведение видео успешно"),y=!0,o()}).catch(x=>{console.warn("Не удалось автовоспроизвести видео:",x)})}},1e3)),m&&m.addEventListener("click",S=>{S.stopPropagation(),h()}),u&&u.addEventListener("click",S=>{S.stopPropagation(),n&&(p=!p,n.muted=p,d())}),g&&g.addEventListener("input",S=>{if(n)try{const x=parseFloat(S.target.value);isNaN(x)||(n.currentTime=x)}catch(x){console.error("Ошибка при изменении времени видео:",x)}}),w&&w.addEventListener("click",S=>{S.target.closest(".categories__video-controls")||h()}),o(),d(),r.classList.add("initialized"),{togglePlay:h,cleanup:()=>{n&&(n.pause(),n.removeAttribute("src"),n.load())}}}catch(n){console.error("Критическая ошибка в initCategories:",n);const r=document.getElementById("categories");return r&&(r.style.display="block"),{}}}function C(){const t=document.querySelectorAll(".accordion__item");if(t.length===0){console.warn("FAQ аккордеон: элементы не найдены");return}console.log(`FAQ аккордеон: найдено ${t.length} вопросов`);const i=(l=null)=>{t.forEach(n=>{n!==l&&n.classList.contains("active")&&n.classList.remove("active")})};t.forEach(l=>{const n=l.querySelector(".accordion__header"),r=l.querySelector(".accordion__toggle"),c=l.querySelector(".accordion__content");if(!n||!r||!c){console.warn("FAQ аккордеон: структура элемента неполная",l);return}l===t[0]&&setTimeout(()=>{r.classList.add("pulse"),setTimeout(()=>{r.classList.remove("pulse")},1500)},1e3);const m=v=>{if(v.preventDefault(),v.stopPropagation(),r.classList.add("clicked"),setTimeout(()=>r.classList.remove("clicked"),300),l.classList.contains("active")){l.classList.remove("active");return}i(l),l.classList.add("active");const b=n.getBoundingClientRect();b.top>=10&&b.bottom<=window.innerHeight-10||setTimeout(()=>{window.scrollTo({top:window.scrollY+b.top-100,behavior:"smooth"})},100)};n.addEventListener("click",m),r.addEventListener("click",v=>{v.stopPropagation(),m(v)});const u=`faq-question-${Math.random().toString(36).substring(2,9)}`,g=`faq-answer-${Math.random().toString(36).substring(2,9)}`;n.setAttribute("id",u),n.setAttribute("aria-expanded","false"),n.setAttribute("aria-controls",g),c.setAttribute("id",g),c.setAttribute("aria-labelledby",u),c.setAttribute("role","region"),c.setAttribute("hidden","true"),new MutationObserver(v=>{v.forEach(b=>{if(b.type==="attributes"&&b.attributeName==="class"){const y=l.classList.contains("active");n.setAttribute("aria-expanded",y?"true":"false"),y?c.removeAttribute("hidden"):setTimeout(()=>{l.classList.contains("active")||c.setAttribute("hidden","true")},500)}})}).observe(l,{attributes:!0})});const e=l=>{if(l.key==="Escape"){i();return}const n=document.activeElement.closest(".accordion__item");if(!n)return;const r=Array.from(t),c=r.indexOf(n);if(c===-1)return;let m;switch(l.key){case"ArrowDown":m=(c+1)%r.length;break;case"ArrowUp":m=(c-1+r.length)%r.length;break;case"Home":m=0;break;case"End":m=r.length-1;break;default:return}const u=r[m].querySelector(".accordion__header");u&&(u.focus(),l.preventDefault())};return document.addEventListener("keydown",e),console.log("FAQ аккордеон успешно инициализирован"),{openItem:l=>{l>=0&&l<t.length&&(i(t[l]),t[l].classList.add("active"))},closeAll:()=>i()}}typeof window<"u"&&(document.addEventListener("DOMContentLoaded",()=>{window.faqAccordeon=C()}),window.initFaqAccordion=C);function te(){const t=document.getElementById("articles");if(!t){console.warn("Секция Articles не найдена в DOM, пробуем найти с другим id");const r=document.querySelector(".articles")||document.querySelector('section[id^="articles"]')||document.querySelector("section.articles");if(!r){console.error("Не удалось найти секцию Articles в DOM никаким способом"),console.debug("Структура DOM:",document.body.innerHTML);return}r.id||(r.id="articles"),console.log("Найден альтернативный элемент для секции Articles:",r)}console.log("Инициализация секции Articles с SEO-оптимизацией");const i=[{id:1,title:"R36S Retro Gaming",sections:[{subtitle:"R36S: The Ultimate Handheld Gaming Console for Retro Gaming Enthusiasts",content:"Welcome to the official home of the <strong>R36S handheld gaming console</strong>. The R36S has quickly become the go-to device for retro gaming enthusiasts across the <em>United States</em>, <em>United Kingdom</em>, and <em>Australia</em>. This powerful portable gaming system offers an exceptional combination of performance, versatility, and value that puts other retro consoles to shame. Whether you're reliving childhood classics or discovering retro gems for the first time, the <mark>R36S console</mark> delivers an unmatched gaming experience. Many gamers compare the <span>R36S vs Anbernic</span> models and consistently find that the R36S offers superior features at a more competitive price point. Ready to elevate your portable gaming experience? The R36S is now available for purchase online with special promotional pricing for a limited time."},{subtitle:"Comprehensive R36S Review: Performance That Exceeds Expectations",content:'After extensive testing, our <strong>R36S review</strong> confirms what many gamers have discovered – this console punches well above its weight class. The <mark>R36S emulator performance</mark> is particularly impressive, handling everything from 8-bit classics to more demanding 32-bit titles with remarkable smoothness. Games load quickly and run without the lag or frame drops that plague lesser devices. The <strong>R36S specs</strong> include a powerful processor paired with ample RAM that ensures consistent performance across various emulation platforms. What truly sets the R36S console apart in our review is its ability to handle multiple emulation systems without compromising on quality. Unlike competitors in the same price range, the R36S maintains excellent performance even with graphically intensive games. Players across <em>North America</em> and <em>Europe</em> have shared <mark>R36S reviews</mark> praising its reliable performance during extended gaming sessions. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> to experience this exceptional performance firsthand at our special online price.'},{subtitle:"How to Install Games on R36S: Simple Setup for Maximum Fun",content:`Learning <strong>how to install ROMs on R36S</strong> is refreshingly straightforward. The console's user-friendly interface makes the process accessible even for those new to retro gaming handhelds. First, you'll need to format a microSD card (up to 512GB supported) using your computer. Then, download your preferred game files and organize them in folders corresponding to each console type. After inserting the card into your R36S, the built-in menu system automatically detects and categorizes your games for easy access. The <mark>R36S setup guide</mark> included with every purchase walks you through this process with clear, step-by-step instructions. Additionally, the R36S console supports various file formats, eliminating compatibility headaches common with other devices. Customers in <em>Canada</em>, <em>Australia</em>, and throughout <em>Europe</em> appreciate how the R36S simplifies the game installation process. Need more guidance? The complete <strong>R36S setup guide</strong> is available on our website, along with video tutorials. Don't miss our current sale price on the R36S – <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Now" target="_blank" rel="nofollow">order now</a> while supplies last!`},{subtitle:"R36S Specifications: Hardware That Delivers Premium Gaming Experience",content:"The impressive <strong>R36S specifications</strong> explain why this console has garnered such positive attention. At its heart, the R36S boasts a quad-core processor clocked at 1.5GHz, paired with 1GB of DDR3 RAM for smooth multitasking. The <mark>R36S screen resolution</mark> of 640x480 on its 3.5-inch IPS display delivers crisp visuals with excellent color reproduction and wide viewing angles. This display quality significantly enhances the gaming experience, particularly for pixel-art classics. The <strong>R36S battery life</strong> extends to an impressive 6-8 hours of continuous play on a single charge, with charging time of approximately 2-3 hours via the USB-C port. Storage options are flexible, with support for microSD cards up to 512GB, allowing an extensive game library. The <mark>R36S controller layout</mark> features a responsive D-pad, dual analog sticks, four action buttons, and shoulder triggers that provide precise control across different game genres. Available in multiple colors, the R36S is currently offered at a special promotional price in the <em>UK</em>, <em>USA</em>, and throughout <em>Asia</em>. Check our website for the current <strong>R36S price</strong> and available discount offers."},{subtitle:"Best Games for R36S: Thousands of Classics at Your Fingertips",content:`The <strong>R36S console</strong> truly shines when loaded with the best games that showcase its capabilities. The system excels at running 8-bit and 16-bit classics from Nintendo, Sega, and other iconic platforms with perfect emulation. More impressively, the R36S handles PlayStation 1 titles with remarkable fidelity, maintaining smooth framerates even in 3D games. Fighting game enthusiasts praise the <mark>R36S controller layout</mark> and responsive buttons, which make titles like Street Fighter and King of Fighters a joy to play. RPG fans can enjoy lengthy adventures like Final Fantasy and Chrono Trigger with the benefit of the extended <strong>R36S battery life</strong>. The console's excellent <mark>R36S sound quality</mark> and speakers deliver immersive audio, though many users opt for headphones for the full experience. The R36S firmware supports save states across all emulators, allowing you to pause and resume your progress at any time. Gamers in <em>Mexico</em>, <em>Brazil</em>, and across <em>South America</em> have particularly embraced the R36S for its extensive game compatibility. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> from our official online store to receive exclusive bonus content and take advantage of our current sale price.`},{subtitle:"A Unique Gaming Experience with R36S",content:`The <strong>R36S</strong> has garnered attention for its impressive gaming library, housing over 15,000 titles in the 64GB model and expanding to approximately 20,000 games in the 128GB version. This comprehensive collection spans across several iconic gaming platforms, including: <ul><li><strong>Nintendo Entertainment System (NES)</strong></li><li><strong>Super Nintendo Entertainment System (SNES)</strong></li><li><strong>Sega Genesis</strong></li><li><strong>PlayStation 1</strong></li><li><strong>Nintendo 64</strong></li><li><strong>Game Boy Advance</strong></li><li><strong>Nintendo DS</strong></li><li><strong>PlayStation Portable (PSP)</strong></li></ul><p>This extraordinary compilation allows enthusiasts to journey through the golden era of gaming across multiple legendary platforms, all within a single portable device.</p><p class="article__highlight"><strong>R36S Standout Gaming Experiences</strong><br>While the device offers thousands of nostalgic adventures, certain masterpieces particularly shine through:<ul><li><strong>Super Mario Bros.</strong> (NES): The revolutionary platformer that defined an entire genre and laid the groundwork for countless games to follow.</li><li><strong>The Legend of Zelda: A Link to the Past</strong> (SNES): A timeless adventure that masterfully combines puzzle-solving, exploration, and combat into an unforgettable experience.</li><li><strong>Sonic the Hedgehog</strong> (Sega Genesis): Sega's signature blue speedster that challenged Nintendo's dominance with its distinctive fast-paced gameplay.</li><li><strong>Final Fantasy VII</strong> (PlayStation 1): The groundbreaking RPG that transformed video game storytelling with its complex characters and emotional narrative.</li><li><strong>Super Mario 64</strong> (Nintendo 64): The trailblazing 3D platformer that revolutionized how players interact with virtual worlds.</li><li><strong>Pokémon FireRed</strong> (Game Boy Advance): The beloved reimagining of the original Pokémon Red, enhanced with additional features and improved graphics.</li><li><strong>Mario Kart DS</strong> (Nintendo DS): An exhilarating racing experience offering endless entertainment through its inventive tracks and competitive multiplayer.</li><li><strong>God of War: Chains of Olympus</strong> (PSP): An action-packed epic showcasing the impressive capabilities of Sony's handheld console.</li></ul>These highlighted gems represent merely a glimpse into the vast array of quality titles available on the <mark>R36S</mark>, catering to diverse gaming preferences from casual play to hardcore challenges.</p>`},{subtitle:"R36S Firmware Update Guide: Keeping Your Console at Peak Performance",content:`Maintaining the latest <strong>R36S firmware</strong> ensures you'll enjoy optimal performance and access to the newest features. The <mark>R36S firmware update</mark> process is straightforward and user-friendly. Begin by downloading the latest firmware package from our official website. Then, place the file in the root directory of your microSD card. After inserting the card into your powered-off R36S, hold the select button while powering on the device to enter update mode. The console will automatically detect and install the new firmware, typically completing in 2-3 minutes. Each <strong>R36S firmware update</strong> brings performance optimizations, new emulators, and interface improvements. Following the update, the <mark>R36S user manual</mark> recommends recalibrating your controls for the best gaming experience. Our technical support team, available to customers worldwide including <em>Japan</em>, <em>South Korea</em>, and across <em>Europe</em>, can assist with any firmware update questions. Subscribe to our newsletter for notifications about new R36S firmware releases and special offers on accessories. Don't miss our <a href="https://www.aliexpress.com/item/1005007171465465.html" title="R36S Limited Time Promotion" target="_blank" rel="nofollow">limited-time promotion</a> with discounted pricing on the R36S console and accessory bundles.`}]},{id:2,title:"R36S Official Website",sections:[{subtitle:"R36S Official Website - The Ultimate Gaming Experience at Your Fingertips",content:"Welcome to the <strong>R36S Official Website</strong>, your premier destination for cutting-edge handheld gaming technology. Our revolutionary gaming console has transformed the portable gaming landscape, offering unprecedented performance in a sleek, ergonomic design. The <mark>R36S</mark> combines powerful hardware with intuitive controls to deliver an immersive gaming experience wherever you go. Whether you're a casual gamer or a dedicated enthusiast, the <strong>R36S game console</strong> provides the perfect balance of power, portability, and playability. Discover why gamers across <em>North America</em>, <em>Europe</em>, and <em>Asia</em> are choosing the R36S as their preferred handheld gaming device. Continue reading to learn about our exclusive features, technical specifications, and why the R36S stands apart from other gaming consoles on the market today."},{subtitle:"Discover the Revolutionary R36S Handheld Gaming Experience",content:'The <strong>R36S handheld</strong> represents the next generation of portable gaming technology. Unlike conventional gaming devices, the R36S handheld features an advanced cooling system that prevents overheating during extended gaming sessions. Additionally, the vibrant high-resolution display ensures crystal-clear visuals even in bright outdoor conditions. Moreover, the <mark>R36S game console</mark> includes customizable controls that adapt to your unique gaming style. Furthermore, the lightweight yet durable construction makes the R36S perfect for gaming on the go. Meanwhile, the extended battery life keeps you playing for hours without interruption. Subsequently, the intuitive user interface makes navigating between games and settings effortless. In contrast to other portable systems, the <strong>R36S handheld</strong> offers exceptional value without compromising on quality. Consequently, gamers in the <em>United Kingdom</em>, <em>Australia</em>, and <em>Canada</em> can <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Online" target="_blank" rel="nofollow">order online</a> and experience the difference today. However, limited-time promotional pricing makes this the ideal time to purchase your R36S game console.'},{subtitle:"Unmatched Performance in the R36S Game Console",content:"The heart of the <strong>R36S game console</strong> lies in its powerful processing capabilities. Specifically, the custom-designed CPU and GPU combination delivers desktop-quality graphics in a handheld format. In particular, the advanced thermal management system prevents throttling during intensive gaming sessions. Similarly, the high-speed RAM ensures smooth multitasking between games and applications. Likewise, the expandable storage options allow you to carry your entire game library wherever you go. Certainly, the <mark>R36S handheld's</mark> performance metrics exceed industry standards in its price range. Nevertheless, the energy-efficient design maintains battery life without sacrificing processing power. Above all, the <strong>R36S game console's</strong> architecture supports both retro classics and modern gaming experiences. Therefore, gamers looking for performance and versatility consistently choose the R36S. Indeed, retailers across <em>Germany</em>, <em>France</em>, and <em>Japan</em> report steadily increasing demand for this innovative gaming device. Finally, manufacturer specifications confirm that the R36S outperforms competing handhelds costing significantly more."},{subtitle:"Enhanced Gaming Experience with the R36S Handheld's Exclusive Features",content:"The <strong>R36S handheld</strong> comes equipped with numerous exclusive features designed to enhance your gaming experience. First, the haptic feedback system provides immersive tactile responses that correspond with in-game actions. Second, the adjustable performance modes allow you to prioritize either graphical fidelity or battery conservation. Third, the integrated voice chat functionality eliminates the need for external communication devices. Fourth, the customizable RGB lighting adds a personal touch to your gaming setup. Fifth, the quick-resume feature lets you instantly return to your game after a break. Sixth, the dedicated streaming mode optimizes performance for content creators. Meanwhile, the brand's commitment to quality ensures each <mark>R36S game console</mark> meets rigorous standards before shipping. As a result, customers in <em>Spain</em>, <em>Italy</em>, and <em>South Korea</em> can shop confidently knowing they're receiving a premium product. Consequently, the history of the brand demonstrates consistent innovation in the gaming sector. Therefore, the manufacturer continues to support the R36S with regular firmware updates and expanded compatibility."},{subtitle:"Why Gamers Worldwide Choose the R36S Official Website for Their Gaming Needs",content:"The <strong>R36S Official Website</strong> offers distinct advantages for discerning gamers seeking the ultimate handheld experience. Primarily, exclusive online-only configurations provide enhanced specifications unavailable through retail channels. Additionally, direct purchases from the <mark>R36S Official Website</mark> include extended warranty coverage at no additional cost. Furthermore, members of the official online community gain early access to firmware updates and beta features. Moreover, the official online store frequently offers promotional pricing unavailable elsewhere. Consequently, the <strong>R36S game console</strong> purchased directly from the manufacturer includes premium accessories in standard packages. Subsequently, customers in <em>Brazil</em>, <em>Mexico</em>, and <em>India</em> benefit from regionalized payment options and shipping methods. Meanwhile, the brand's commitment to customer satisfaction has established a loyal following in competitive gaming circles. In essence, the <mark>R36S handheld</mark> represents not just a product but an entire ecosystem of gaming innovation. Therefore, visiting the <span>R36S Official Website</span> remains the optimal way to experience everything this revolutionary console offers. Indeed, the manufacturer's direct sales model ensures authenticity and full support for every purchased device."},{subtitle:"The Future of Gaming with the R36S Official Website and Upcoming Innovations",content:"The <strong>R36S Official Website</strong> stands as the definitive source for information about upcoming innovations in the R36S ecosystem. Primarily, the <mark>R36S game console's</mark> modular design allows for future hardware expansions without requiring a completely new device. Additionally, the development team is actively working on cloud gaming integration to further expand the available game library. Furthermore, the <strong>R36S handheld</strong> will soon support cross-platform multiplayer with major gaming systems. Moreover, announced accessories will enhance the versatility of the base R36S game console for specialized gaming genres. Consequently, early adopters of the R36S platform will benefit from a continuously evolving gaming experience. Subsequently, the price point remains competitive despite these substantial additions to functionality. Meanwhile, the brand continues to expand its presence in emerging markets including <em>Southeast Asia</em> and <em>Eastern Europe</em>. Therefore, the <mark>R36S handheld</mark> represents not just current gaming technology but a future-proof investment. In conclusion, whether you're looking to purchase your first R36S or upgrade from a previous model, the <span>R36S Official Website</span> offers the most comprehensive information and purchase options. Indeed, as the gaming landscape evolves, the <strong>R36S game console</strong> evolves with it, maintaining its position at the forefront of handheld gaming innovation."},{subtitle:"Why Choose the R36S: Value, Performance, and Community Support",content:`The <strong>R36S</strong> has established itself as the preferred choice for discerning retro gamers for several compelling reasons. When conducting an <span>R36S vs Anbernic comparison</span>, the R36S consistently offers better specifications at a more competitive price point. The <mark>R36S price</mark> and value for money is unmatched in the portable retro gaming market, delivering premium features without the premium cost. The <strong>R36S portable gaming console</strong> features extend beyond mere hardware specifications – the active community of users continues to develop custom firmware, game ports, and utilities that expand the system's capabilities. The <mark>R36S emulator performance</mark> receives regular optimizations through community contributions, ensuring that even the most demanding games run smoothly. The <strong>R36S handheld gaming console review</strong> scores consistently highlight the device's exceptional build quality, with a solid feel that withstands the rigors of portable gaming. Customers across <em>North America</em>, <em>Europe</em>, <em>Australia</em>, and <em>Asia</em> have made the R36S their go-to retro gaming solution. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Official" target="_blank" rel="nofollow">Order your R36S today</a> from our official website to join this passionate community and take advantage of our current promotional pricing, exclusive bundles, and free worldwide shipping on orders over $100.`},{subtitle:"Welcome to the R36S Official Store",content:`Discover premium products at the <strong>R36S official store</strong>, your ultimate destination for authentic R36S merchandise. Our official store offers an extensive selection of cutting-edge devices designed to enhance your daily experience. Looking to buy <strong>R36S products</strong> at the best price? The <strong>R36S official store</strong> delivers exceptional value with regular promotions and sales events. <mark>Order online today</mark> and experience the convenience of worldwide shipping from the R36S official store. Our team is dedicated to providing superior customer service, ensuring your shopping experience exceeds expectations. Whether you're searching for the latest releases or popular bestsellers, the <strong>R36S official store</strong> has everything you need. Check out our current <span>special offers</span> and take advantage of exclusive deals available only at the R36S official store. With secure payment options and fast delivery, shopping at the <strong>R36S official store</strong> is both safe and convenient. Join thousands of satisfied customers who trust the R36S official store for authentic products and unmatched quality. Visit our website now or contact our support team to learn more about where to buy R36S products. The <strong>R36S official store</strong> ships to major regions including <em>North America</em>, <em>Europe</em>, <em>Asia</em>, and <em>Australia</em>, making our premium products accessible to customers worldwide. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Visit R36S Official Store" target="_blank" rel="nofollow">Shop at the R36S official store today</a> and experience the difference that quality products and exceptional service can make.`}]}],e=t.querySelector(".articles__grid");if(!e){console.error("Элемент .articles__grid не найден в секции Articles");return}(()=>{if(!document.querySelector('meta[name="description"]')){const r=document.createElement("meta");r.name="description",r.content="R36S - The Ultimate Handheld Gaming Console for Retro Gaming. Official website with specifications, reviews, and purchase options.",document.head.appendChild(r)}if(!document.querySelector('meta[name="keywords"]')){const r=document.createElement("meta");r.name="keywords",r.content="R36S, retro gaming, handheld console, portable gaming, R36S specs, R36S review, retro games, emulator, gaming device",document.head.appendChild(r)}})(),i.forEach(r=>{const c=document.createElement("article");c.className="article",c.id=`article-${r.id}`,c.dataset.articleId=r.id,c.setAttribute("itemscope",""),c.setAttribute("itemtype","http://schema.org/Article");const m=document.createElement("h2");m.className="article__title",m.setAttribute("itemprop","headline"),m.innerHTML=r.title,c.appendChild(m);const u=document.createElement("div");u.className="article__content-wrapper",u.setAttribute("itemprop","articleBody"),r.sections.forEach((y,p)=>{const a=document.createElement("section");if(a.className="article__section",a.id=`section-${r.id}-${p}`,p!==0||y.subtitle!==r.title){const f=document.createElement("h3");f.className="article__subtitle",f.innerHTML=y.subtitle,a.appendChild(f)}const s=document.createElement("div");s.className="article__content",s.innerHTML=y.content,a.appendChild(s),u.appendChild(a)}),c.appendChild(u);const g=document.createElement("script");g.type="application/ld+json";const w={"@context":"https://schema.org","@type":"Article",headline:r.title,description:r.sections[0].content.substring(0,150)+"...",keywords:"R36S, retro gaming, handheld console, portable gaming",author:{"@type":"Organization",name:"R36S Official"},publisher:{"@type":"Organization",name:"R36S",logo:{"@type":"ImageObject",url:"/assets/images/r36s-logo.png"}},datePublished:new Date().toISOString(),dateModified:new Date().toISOString()};g.textContent=JSON.stringify(w),c.appendChild(g);const v=document.createElement("footer");v.className="article__footer";const b=document.createElement("a");b.href="https://www.aliexpress.com/item/1005007171465465.html",b.className="article__cta",b.textContent="Order R36S Now",b.setAttribute("itemprop","url"),b.setAttribute("title","Order R36S Gaming Console"),b.setAttribute("rel","nofollow"),b.setAttribute("target","_blank"),v.appendChild(b),c.appendChild(v),e.appendChild(c)}),(()=>{const r=document.createElement("h1");r.className="articles__heading",r.textContent="R36S Gaming Console - Official Information",t.querySelector(".articles__container").insertBefore(r,t.querySelector(".articles__grid"))})(),setTimeout(()=>{C()},500),setTimeout(()=>{console.log("Проверка наличия элементов аккордеона перед инициализацией:");const r=document.querySelectorAll(".accordion__item");console.log(`Найдено ${r.length} элементов аккордеона`),console.log("Первый элемент аккордеона:",r[0]),r.length>0&&(console.log("Структура первого элемента:"),console.log("- Заголовок:",r[0].querySelector(".accordion__header")),console.log("- Кнопка:",r[0].querySelector(".accordion__toggle")),console.log("- Контент:",r[0].querySelector(".accordion__content"))),console.log("Вызываем initFaqAccordion...");const c=C();console.log("Результат инициализации:",c?"успешно":"ошибка")},1e3),console.log("Инициализация секции Articles завершена успешно")}function oe(){if(console.log("Инициализация переключателей яркости текста в блоках - НАЧАЛО"),window._themeToggleInitialized)return console.warn("Обнаружена повторная инициализация переключателей яркости. Пропускаем..."),window._themeToggleCleanup;window._themeToggleInitialized=!0;const t=document.getElementById("articles")||document.querySelector(".articles"),i=document.getElementById("official-website")||document.querySelector(".official-website"),e=document.getElementById("retro-gaming")||document.querySelector(".retro-gaming");if(!t&&!i&&!e){console.error("Секции для добавления переключателей яркости текста не найдены");return}const l=[];function n(u,g){if(!u)return;console.log(`Добавление переключателей в секцию ${u.id||u.className}`);const w=u.querySelectorAll(".article");console.log(`Найдено ${w.length} блоков для добавления переключателей в секции ${u.id||u.className}`),w.forEach((v,b)=>{const y=g!==void 0?g:b%3;if(v.querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label")){console.warn(`Блок #${b} уже содержит кнопку переключения. Пропускаем создание.`);return}const a=document.createElement("button");switch(a.setAttribute("type","button"),y){case 0:a.className="brightness-toggle",a.innerHTML=`
          ...
          `;const s=v.querySelector(".article__title");if(s){const d=document.createElement("div");d.className="article__title-container";const h=s.cloneNode(!0);d.appendChild(h),d.appendChild(a),s.parentNode.replaceChild(d,s)}else v.insertBefore(a,v.firstChild);break;case 1:a.className="brightness-toggle",a.innerHTML=`
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="#3B82F6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `;const f=v.querySelector(".article__title");if(f){const d=document.createElement("div");d.className="article__title-container";const h=f.cloneNode(!0);d.appendChild(h),d.appendChild(a),f.parentNode.replaceChild(d,f)}else v.insertBefore(a,v.firstChild);break;case 2:a.className="brightness-toggle-with-label",a.innerHTML=`
            <span class="brightness-toggle-label">Ярче</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="#3B82F6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `;const o=v.querySelector(".article__title");if(o){const d=document.createElement("div");d.className="article__title-container";const h=o.cloneNode(!0);d.appendChild(h),d.appendChild(a),o.parentNode.replaceChild(d,o)}else v.insertBefore(a,v.firstChild);break}l.push(a)})}t&&n(t);let r;if(e){const u=e.querySelectorAll(".article");if(u.length>0){const g=u[0].querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label");g&&(g.classList.contains("brightness-toggle-corner")?r=1:g.classList.contains("brightness-toggle-with-label")?r=2:r=0,console.log(`Обнаружен стиль кнопки в секции R36S Retro Gaming: ${r}`))}}i&&n(i,r!==void 0?r:1),console.log(`Создано ${l.length} кнопок переключения`),l.forEach(u=>{const g=u.cloneNode(!0);u.parentNode&&u.parentNode.replaceChild(g,u);const w=l.indexOf(u);w!==-1&&(l[w]=g)}),l.forEach(u=>{const g=u.closest(".article");if(!g){console.error("Не найден родительский блок .article для кнопки переключения");return}u.addEventListener("click",function(y){if(y.preventDefault(),y.stopPropagation(),console.log("Клик по кнопке переключения яркости"),console.log("Состояние до переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),g.classList.toggle("bright-text"),u.classList.toggle("active"),console.log("Состояние после переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),u.classList.contains("brightness-toggle-with-label")){const f=u.querySelector(".brightness-toggle-label");f&&(f.textContent=g.classList.contains("bright-text")?"Тусклее":"Ярче",console.log("Изменен текст лейбла на:",f.textContent))}const p=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),a=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown",s=g.classList.contains("bright-text")?"bright":"normal";localStorage.setItem(`r36s-${a}-article-brightness-${p}`,s),console.log(`Яркость текста в блоке ${p} секции ${a} изменена на: ${s}`)});const w=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),v=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown";if(localStorage.getItem(`r36s-${v}-article-brightness-${w}`)==="bright"){if(g.classList.add("bright-text"),u.classList.add("active"),u.classList.contains("brightness-toggle-with-label")){const y=u.querySelector(".brightness-toggle-label");y&&(y.textContent="Тусклее")}console.log(`Восстановлено состояние для блока ${w} в секции ${v}: яркий`)}else console.log(`Блок ${w} в секции ${v} в обычном режиме`)});const c=document.createElement("style");c.textContent=`
  ...
  `,document.head.appendChild(c);const m=function(){l.forEach(u=>{if(u&&u.parentNode){const g=u.closest(".article__title-container");if(g){const w=g.querySelector(".article__title");w&&g.parentNode&&g.parentNode.replaceChild(w,g)}else u.parentNode.removeChild(u)}}),c&&c.parentNode&&c.parentNode.removeChild(c),window._themeToggleInitialized=!1,console.log("Очистка переключателей яркости выполнена")};return window._themeToggleCleanup=m,console.log("Инициализация переключателей яркости текста в блоках - ЗАВЕРШЕНА"),m}const O={"phone-call":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone-call"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path><path d="M14.05 2a9 9 0 0 1 8 7.94"></path><path d="M14.05 6A5 5 0 0 1 18 10"></path></svg>',mail:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>',"map-pin":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>',"message-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle"><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"></path></svg>',send:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send"><path d="m22 2-7 20-4-9-9-4Z"></path><path d="M22 2 11 13"></path></svg>',"alert-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" x2="12" y1="8" y2="12"></line><line x1="12" x2="12.01" y1="16" y2="16"></line></svg>',loader:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-loader animate-spin"><line x1="12" x2="12" y1="2" y2="6"></line><line x1="12" x2="12" y1="18" y2="22"></line><line x1="4.93" x2="7.76" y1="4.93" y2="7.76"></line><line x1="16.24" x2="19.07" y1="16.24" y2="19.07"></line><line x1="2" x2="6" y1="12" y2="12"></line><line x1="18" x2="22" y1="12" y2="12"></line><line x1="4.93" x2="7.76" y1="19.07" y2="16.24"></line><line x1="16.24" x2="19.07" y1="7.76" y2="4.93"></line></svg>'};function I(t,i=24){return O[t]?O[t].replace(/width="24"/,`width="${i}"`).replace(/height="24"/,`height="${i}"`):(console.error(`Icon "${t}" not found`),"")}function ne(){document.querySelectorAll("[data-icon]").forEach(i=>{const e=i.getAttribute("data-icon"),l=parseInt(i.getAttribute("data-size")||"24",10);e&&(i.innerHTML=I(e,l))})}function ie(){console.log("Инициализация секции Contact");const t=document.querySelector(".contact__form"),i=document.getElementById("name"),e=document.getElementById("email"),l=document.getElementById("phone"),n=document.getElementById("message"),r=document.querySelector(".form__button"),c=document.createElement("div");c.className="form__error",c.style.display="none",c.innerHTML=`
    <div class="form__error-icon">${I("alert-circle",16)}</div>
    <span></span>
  `,t.insertBefore(c,t.firstChild);const m={name:"",email:"",phone:"",message:""};function u(y){c.querySelector("span").textContent=y,c.style.display="flex"}function g(){c.style.display="none"}function w(y){const{name:p,value:a}=y.target;m[p]=a,g()}i.addEventListener("input",w),e.addEventListener("input",w),l.addEventListener("input",w),n.addEventListener("input",w);async function v(y){y.preventDefault(),b(!0);try{if(!m.name||!m.email||!m.phone||!m.message)throw new Error("Please fill in all fields");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(m.email))throw new Error("Please enter a valid email");if(!/^\+?[0-9]{10,14}$/.test(m.phone.replace(/\D/g,"")))throw new Error("Please enter a valid phone number.");await new Promise(f=>setTimeout(f,1e3)),i.value="",e.value="",l.value="",n.value="",Object.keys(m).forEach(f=>{m[f]=""}),alert("Message sent successfully! We will contact you shortly.")}catch(a){u(a.message||"There was an error sending your message. Please try again later."),console.error("Form submission error:",a)}finally{b(!1)}}function b(y){[i,e,l,n].forEach(a=>{a.disabled=y}),r.disabled=y,r.innerHTML=y?`<span class="button__icon">${I("loader",20)}</span> Sending...`:`<span class="button__icon">${I("send",20)}</span> Send message`}return t.addEventListener("submit",v),function(){i.removeEventListener("input",w),e.removeEventListener("input",w),l.removeEventListener("input",w),n.removeEventListener("input",w),t.removeEventListener("submit",v)}}function re(){const t="/R36S_STORE_JS/",e={review1:{webp:`${t}img/reviews/imm_1_1x.webp`,jpg:`${t}img/reviews/imm_1_1x.jpg`},review2:{webp:`${t}img/reviews/imm_2_1x.webp`,jpg:`${t}img/reviews/imm_2_1x.jpg`},review3:{webp:`${t}img/reviews/imm_3_1x.webp`,jpg:`${t}img/reviews/imm_3_1x.jpg`},review4:{webp:`${t}img/reviews/imm_4_1x.webp`,jpg:`${t}img/reviews/imm_4_1x.jpg`}},l=[{id:1,rating:5,color:"Purple 64GB",author:"AliExpress Shopper",date:"21 Aug 2024",text:"I just got my hands on the R36S retro console and it's seriously amazing for old-school gaming. The screen is super clear, it runs games smoothly, and battery life is solid. I love how I can load up my favorite classics and play...",images:{webp:e.review1.webp,jpeg:e.review1.jpg},helpful:12,verified:!0},{id:2,rating:5,color:"Yellow 128G",author:"V***h",date:"26 Aug 2024",text:"After playing with the R36S for a week, I'm really impressed and absolutely delighted. The build quality feels great, and switching between different retro games is super easy. The controls are comfortable for long gaming sessions.",images:{webp:e.review4.webp,jpeg:e.review4.jpg},helpful:8,verified:!0},{id:3,rating:5,color:"White 64GB",author:"M***z",date:"22 Aug 2024",text:"The R36S has become my go-to gaming device. I wasn't sure about buying another retro console, but this one surprised me. The screen is bright and sharp, games run without issues, and it's small enough to fit in my pocket.",images:{webp:e.review3.webp,jpeg:e.review3.jpg},helpful:15,verified:!0},{id:4,rating:5,color:"Black 128GB",author:"K***r",date:"28 Aug 2024",text:"I've been using the R36S for a few weeks now, and I'm genuinely impressed. The 3.5-inch IPS screen delivers crisp visuals, and the build quality feels solid. The dual analog sticks are responsive, making retro gaming a joy.",images:{webp:e.review2.webp,jpeg:e.review2.jpg},helpful:10,verified:!0,mobileOnly:!0}],n=new Set;let r=null,c=window.innerWidth<=1200;function m(o=!1){const d=document.createElementNS("http://www.w3.org/2000/svg","svg");d.classList.add("review-card__star"),d.setAttribute("viewBox","0 0 24 24"),d.setAttribute("fill",o?"currentColor":"none"),d.setAttribute("stroke","currentColor"),d.setAttribute("stroke-width","2");const h=document.createElementNS("http://www.w3.org/2000/svg","polygon");return h.setAttribute("points","12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"),d.appendChild(h),d}function u(){const o=document.createElementNS("http://www.w3.org/2000/svg","svg");o.classList.add("review-card__verified"),o.setAttribute("width","16"),o.setAttribute("height","16"),o.setAttribute("viewBox","0 0 24 24"),o.setAttribute("fill","none"),o.setAttribute("stroke","currentColor"),o.setAttribute("stroke-width","2");const d=document.createElementNS("http://www.w3.org/2000/svg","path");return d.setAttribute("d","M20 6L9 17l-5-5"),o.appendChild(d),o}function g(o){const d=document.getElementById("reviewCardTemplate");if(!d)return console.error("Шаблон карточки отзыва не найден"),null;const h=d.content.cloneNode(!0).querySelector(".review-card");h.dataset.id=o.id,o.mobileOnly&&(h.classList.add("mobile-only"),c||(h.style.display="none"));const _=h.querySelector(".review-card__rating");for(let L=0;L<5;L++)_.appendChild(m(L<o.rating));h.querySelector(".review-card__variant").textContent=o.color,h.querySelector(".review-card__text").textContent=o.text;const S=h.querySelector("picture");S.querySelector("source").setAttribute("srcset",o.images.webp);const x=S.querySelector("img");x.setAttribute("src",o.images.jpeg),x.setAttribute("alt",`Review ${o.id}`);const E=h.querySelector(".review-card__name");o.verified&&E.prepend(u()),E.appendChild(document.createTextNode(o.author)),h.querySelector(".review-card__date").textContent=o.date,h.querySelector(".review-card__helpful-count").textContent=`Helpful (${o.helpful})`,h.addEventListener("click",w),h.addEventListener("mouseenter",()=>v(o.id)),h.addEventListener("mouseleave",b);const R=h.querySelector(".review-card__helpful");return R.addEventListener("mouseenter",()=>{R.querySelector("svg").setAttribute("fill","currentColor"),R.querySelector("svg").classList.add("scale-125"),R.querySelector("svg").classList.remove("scale-100")}),R.addEventListener("mouseleave",()=>{R.querySelector("svg").setAttribute("fill","none"),R.querySelector("svg").classList.remove("scale-125"),R.querySelector("svg").classList.add("scale-100")}),h}function w(){window.open("https://www.aliexpress.com/item/1005007226123844.html#feedback","_blank","noopener,noreferrer")}function v(o){r=o;const d=document.querySelector(`.review-card[data-id="${o}"]`);if(d){const h=d.querySelector(".review-card__arrow-wrapper");h&&(h.style.display="flex")}}function b(){const o=document.querySelector(`.review-card[data-id="${r}"]`);if(o){const d=o.querySelector(".review-card__arrow-wrapper");d&&(d.style.display="none")}r=null}function y(){const o=document.getElementById("reviewsGrid");if(!o){console.error("Контейнер для отзывов не найден");return}const d=document.getElementById("reviewCardTemplate"),h={};o.querySelectorAll(".review-card").forEach(x=>{x.dataset.id&&(h[x.dataset.id]=x)});const _=l.filter(x=>!x.mobileOnly||x.mobileOnly&&c),S=[];_.forEach(x=>{if(h[x.id]){const E=h[x.id];E.style.display="block",S.push(E),delete h[x.id]}else{const E=g(x);E&&S.push(E)}}),Object.values(h).forEach(x=>{x!==d&&(x.style.display="none")}),o.innerHTML="",o.appendChild(d),S.forEach(x=>{o.appendChild(x)}),p()}function p(){if(!("IntersectionObserver"in window)){console.warn("IntersectionObserver не поддерживается в этом браузере"),document.querySelectorAll(".review-card").forEach(d=>{d.classList.add("animate-in")});return}const o=new IntersectionObserver(d=>{d.forEach(h=>{if(h.isIntersecting){const _=h.target.dataset.id;n.has(_)||(h.target.classList.add("animate-in"),n.add(_))}})},{threshold:.1});document.querySelectorAll(".review-card").forEach(d=>{o.observe(d)})}function a(){c=window.innerWidth<=1200,y(),document.querySelectorAll(".review-card").forEach(d=>{d.classList.contains("mobile-only")&&(d.style.display=c?"block":"none")})}function s(){y();let o;const d=()=>{clearTimeout(o),o=setTimeout(a,250)};window.addEventListener("resize",d);const h=document.createElement("style");h.textContent=`
      .review-card {
        opacity: 0;
    ...
    `,document.head.appendChild(h),setTimeout(a,100);const _=document.getElementById("reviews");if(_&&!_.hasAttribute("itemscope")){_.setAttribute("itemscope",""),_.setAttribute("itemtype","http://schema.org/Product");const S=document.createElement("meta");S.setAttribute("itemprop","name"),S.setAttribute("content","R36S Handheld Game Console"),_.prepend(S);const x=document.createElement("meta");x.setAttribute("itemprop","description"),x.setAttribute("content","R36S Handheld Game Console with 3.5-inch IPS screen and retro games"),_.prepend(x)}}s();function f(){if(window.removeEventListener("resize",a),window.removeEventListener("resize",()=>{}),"IntersectionObserver"in window){const o=[];new IntersectionObserver(()=>{}).disconnect(),o.forEach(h=>h.disconnect())}document.querySelectorAll(".review-card").forEach(o=>{o.removeEventListener("click",w),o.removeEventListener("mouseenter",()=>{}),o.removeEventListener("mouseleave",b),Object.keys(l).forEach(h=>{o.removeEventListener("mouseenter",()=>v(h))});const d=o.querySelector(".review-card__helpful");d&&(d.removeEventListener("mouseenter",()=>{}),d.removeEventListener("mouseleave",()=>{}))}),console.log("Reviews section cleanup completed")}return{cleanup:f,renderReviewCards:y}}const se={};function ae(){console.log("Products секция инициализирована");const i=!se?"/":"/R36S_STORE_JS/",e={i0_0:{jpg:`${i}img/products/i_0_0x.jpg`,webp:`${i}img/products/i_0_0x.webp`},i1:{jpg:`${i}img/products/i_1_1x.jpg`,webp:`${i}img/products/i_1_1x.webp`},i2:{jpg:`${i}img/products/i_2_1x.jpg`,webp:`${i}img/products/i_2_1x.webp`},i3:{jpg:`${i}img/products/i_3_1x.jpg`,webp:`${i}img/products/i_3_1x.webp`},i4:{jpg:`${i}img/products/i_4_1x.jpg`,webp:`${i}img/products/i_4_1x.webp`},i5:{jpg:`${i}img/products/i_5_1x.jpg`,webp:`${i}img/products/i_5_1x.webp`},i6:{jpg:`${i}img/products/i_6_1x.jpg`,webp:`${i}img/products/i_6_1x.webp`},i7:{jpg:`${i}img/products/i_7_1x.jpg`,webp:`${i}img/products/i_7_1x.webp`},i8:{jpg:`${i}img/products/i_8_1x.jpg`,webp:`${i}img/products/i_8_1x.webp`},i9:{jpg:`${i}img/products/i_9_1x.jpg`,webp:`${i}img/products/i_9_1x.webp`}},l=[{id:"getting-started",title:"Start Guide",content:{text:`Please be aware that this tutorial does not apply to K36 devices or clones marketed as R36S. For additional information about your hardware, please refer to the comprehensive R36S Wiki Page.
...
• A quick press of the power button will put the device into standby mode.`,images:{jpg:e.i9.jpg,webp:e.i9.webp}}},{id:"downloads",title:"Available Downloads",content:{downloads:[{file:"Firmware v1.0.4 2024.04.13",link:"https://drive.google.com/file/d/10z7j7IZ7WX3y10ZJBW_a2-agcIe1Dx9m/edit",date:"2024.04.13",version:"v1.0.4"},{file:"ArkOS_K36_v2.0_03112025.img.xz",link:"https://drive.google.com/file/d/1F93Q1jXYaTCftOlzAt0BaM43rmVexXsn/view",date:"2023.12.22",version:"v1.0.3"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P3.img.xz",link:"https://drive.google.com/file/d/18VL7uLNdyFKDH4_V8YM5zhHSjLiJdkUc/view",date:"2023.11.16",version:"v1.0.2"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P4.img.xz",link:"https://drive.google.com/file/d/1MT1AGGch6Ou4RAfxDvVCxUI4aXX6Qa5v/view",date:"2023.11.05",version:"v1.0.0"}]}}];let n="downloads",r=!1;const c=document.getElementById("products-nav-list"),m=document.getElementById("products-sections"),u=document.getElementById("products-nav");function g(){r=window.innerWidth<=1024,u&&(r?u.classList.add("nav-mobile"):u.classList.remove("nav-mobile"))}function w(a){n=a,document.querySelectorAll(".nav-item").forEach(o=>{o.dataset.sectionId===a?o.classList.add("nav-item-active"):o.classList.remove("nav-item-active")}),document.querySelectorAll(".section").forEach(o=>{o.id===a?o.classList.add("section-active"):o.classList.remove("section-active")}),setTimeout(()=>{const o=document.getElementById(a);if(o){const d=r?80:20,_=o.getBoundingClientRect().top+window.pageYOffset-d;window.scrollTo({top:_,behavior:"smooth"})}},100)}function v(){c.innerHTML="",l.forEach(a=>{const s=document.createElement("button");s.className=`nav-item ${n===a.id?"nav-item-active":""}`,s.dataset.sectionId=a.id,s.innerHTML=`
        ...
        <span>${a.title}</span>
      `,s.addEventListener("click",()=>w(a.id)),c.appendChild(s)})}function b(a){if(a.id==="downloads"){let o='<div class="download-list">';return a.content.downloads.forEach(d=>{o+=`
        ...
        `}),o+="</div>",o}let s='<div class="section-content"><div class="text-content">';return a.content.text.split(`
`).forEach(o=>{s+=`<p>${o.trim()}</p>`}),s+="</div>",a.content.images&&(s+=`
      ...
      `),a.content.subsections&&(s+='<div class="subsections">',a.content.subsections.forEach(o=>{s+=`
          <div class="subsection">
            <h3 class="subsection-title">${o.title}</h3>
            <div class="subsection-content">
              <div class="text-content">
        `,o.content.text.split(`
`).forEach(h=>{s+=`<p>${h.trim()}</p>`}),s+="</div>",o.content.images&&(s+=`
            <div class="image-container">
              <picture>
          ...
          `),s+="</div></div>"}),s+="</div>"),s+="</div>",s}function y(){m.innerHTML="",l.forEach(a=>{const s=document.createElement("section");s.id=a.id,s.className=`section ${n===a.id?"section-active":""}`,s.innerHTML=`
        <h2 class="section-title">${a.title}</h2>
        ${b(a)}
      `,m.appendChild(s)})}function p(){g(),v(),y(),window.addEventListener("resize",g),console.log("Products: Инициализация завершена. Используются пути к изображениям без /public/")}return c&&m&&u?p():console.error("Не найдены необходимые DOM элементы для секции Products"),{handleSectionClick:w,checkMobile:g}}function le(){console.log("Инициализация Footer");const t=document.querySelector(".footer");if(!t){console.error("Элемент footer не найден");return}const i=t.querySelector(".partnership-button");i&&i.addEventListener("click",()=>{const e=document.querySelector(".partnership-modal-overlay");if(e){e.classList.add("active");const l=e.querySelector(".partnership-modal-content");l&&l.classList.add("active"),document.body.style.overflow="hidden"}}),ce()}function ce(){const t=document.querySelector(".partnership-modal-overlay");if(!t){console.warn("Модальное окно не найдено");return}const i=t.querySelector(".partnership-modal-close");i&&i.addEventListener("click",e),t.addEventListener("click",l=>{l.target===t&&e()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&t.classList.contains("active")&&e()});function e(){const l=t.querySelector(".partnership-modal-content");t.classList.remove("active"),l&&l.classList.remove("active"),document.body.style.overflow=""}}function de(){console.log("Инициализация кнопки прокрутки вверх");const t=document.createElement("button");t.className="scroll-to-top",t.setAttribute("aria-label","Прокрутить вверх страницы"),t.innerHTML=`
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <polyline points="18 15 12 9 6 15"></polyline>
    </svg>
  `,document.body.appendChild(t);let i=!1;function e(r,c){let m;return function(){const u=arguments,g=this;m||(r.apply(g,u),m=!0,setTimeout(()=>m=!1,c))}}const l=e(function(){const c=(window.pageYOffset||document.documentElement.scrollTop)>300;c!==i&&(c?(t.style.visibility="visible",setTimeout(()=>{t.classList.add("visible")},10)):(t.classList.remove("visible"),setTimeout(()=>{i||(t.style.visibility="hidden")},300)),i=c)},100);function n(r){r.preventDefault(),t.classList.add("active"),setTimeout(()=>{t.classList.remove("active")},200),window.scrollTo({top:0,behavior:"smooth"})}return window.addEventListener("scroll",l,{passive:!0}),t.addEventListener("click",n),l(),function(){console.log("Очистка кнопки прокрутки вверх"),window.removeEventListener("scroll",l),t.removeEventListener("click",n),t&&t.parentNode&&t.parentNode.removeChild(t)}}console.log("Main.js инициализирован");let k=[];const q=H();typeof q=="function"&&k.push(q);const j=G();typeof j=="function"&&k.push(j);function ue(){const t="IntersectionObserver"in window,i=function(){const l=document.createElement("div");return l.style.display="flex",l.style.display==="flex"}(),e=function(){const l=document.createElement("div");return l.style.display="grid",l.style.display==="grid"}();return console.log("Поддержка браузера:"),console.log("- IntersectionObserver:",t),console.log("- Flexbox:",i),console.log("- CSS Grid:",e),t||document.body.classList.add("no-intersection-observer"),i||document.body.classList.add("no-flexbox"),e||document.body.classList.add("no-grid"),{hasIntersectionObserver:t,hasFlexbox:i,hasGrid:e}}function me(){try{k.forEach(t=>{typeof t=="function"&&t()}),k=[]}catch(t){console.warn("Error during global cleanup:",t)}}document.addEventListener("DOMContentLoaded",()=>{console.log("DOM загружен");try{ne();const t=ue(),i=z();typeof i=="function"&&k.push(i);const e=Q();typeof e=="function"&&k.push(e);const l=X();typeof l=="function"&&k.push(l);const n=ee();typeof n=="function"&&k.push(n);const r=te();typeof r=="function"&&k.push(r);const c=oe();typeof c=="function"&&k.push(c);const m=ie();typeof m=="function"&&k.push(m);const u=re();typeof u=="function"&&k.push(u);const g=ae();typeof g=="function"&&k.push(g);const w=le();typeof w=="function"&&k.push(w);const v=de();typeof v=="function"&&k.push(v);const b=performance.now();console.log(`Страница загружена за ${b.toFixed(2)}ms`),window.addEventListener("beforeunload",me)}catch(t){console.error("Ошибка при инициализации страницы:",t)}});window.onerror=function(t,i,e,l,n){return console.error("Глобальная ошибка:",{message:t,source:i,lineno:e,colno:l,error:n}),!1};window.addEventListener("unhandledrejection",function(t){console.warn("Непойманное отклонение промиса (unhandled promise rejection):",t.reason)});window.appVersion={version:"1.0.0",buildDate:new Date().toISOString(),environment:"production",basePath:"/R36S_CONSOLE_STORE_JS/"};console.log("Main.js выполнение завершено");
