(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function e(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(o){if(o.ep)return;o.ep=!0;const s=e(o);fetch(o.href,s)}})();function H(){let i=!1,n=window.scrollY,e=null;const l=document.querySelector(".header"),o=document.querySelector(".burger-btn"),s=document.querySelector(".burger-line"),c=document.querySelector(".mobile-menu"),m=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function d(){const a=window.scrollY,r=n<a;e&&clearTimeout(e),a>100?b(!r):b(!0),n=a,y(a>0),e=setTimeout(()=>{},150)}function g(){i=!i,w()}function w(){i?(l.classList.add("menu-open"),o.setAttribute("aria-expanded","true"),s.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"):(l.classList.remove("menu-open"),o.setAttribute("aria-expanded","false"),s.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow="unset")}function y(a){a?l.classList.add("scrolled"):l.classList.remove("scrolled")}function b(a){a?(l.classList.add("visible"),l.classList.remove("hidden")):(l.classList.add("hidden"),l.classList.remove("visible"))}function v(a){a.preventDefault();const r=a.currentTarget.getAttribute("href"),h=r.replace("#",""),t=document.getElementById(h);t&&(b(!0),setTimeout(()=>{l.offsetHeight;const f=t.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:f,behavior:"smooth"}),i&&(i=!1,w()),window.history.replaceState(null,"",`${window.location.pathname}${r}`),setTimeout(()=>{n=window.scrollY},100)},50))}function p(){if(window.location.hash){const a=window.location.hash.replace("#",""),r=document.getElementById(a);r&&setTimeout(()=>{const h=l.offsetHeight,u=r.getBoundingClientRect().top+window.scrollY-h;window.scrollTo({top:u,behavior:"smooth"})},100)}}window.addEventListener("scroll",d),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&i&&(i=!1,w())}),o&&o.addEventListener("click",g),m.forEach(a=>{a.addEventListener("click",v)}),p()}function z(){const i=document.querySelector(".mobile-menu");if(!i){console.error("Мобильное меню не найдено в DOM");return}const n=i.querySelector(".close-button");if(!n){console.error("Кнопка закрытия не найдена в мобильном меню");return}n.addEventListener("click",()=>{e()});function e(){i.classList.remove("open");const c=document.querySelector(".burger-line");c&&c.classList.remove("open"),document.body.style.overflow="unset";const m=document.querySelector(".header");m&&m.classList.remove("menu-open");const d=document.querySelector(".burger-btn");d&&d.setAttribute("aria-expanded","false")}i.querySelectorAll(".mobile-menu__link").forEach(c=>{c.addEventListener("click",()=>{setTimeout(()=>{e()},150)})});const o=i.querySelector(".mobile-menu__background");o&&o.addEventListener("click",()=>{e()});function s(){i.querySelectorAll(".mobile-menu__icon").forEach((m,d)=>{m.style.opacity="0",m.style.transform="translateX(-20px)",new MutationObserver(w=>{w.forEach(y=>{y.attributeName==="class"&&(i.classList.contains("open")?setTimeout(()=>{m.style.transition="all 0.4s ease",m.style.opacity="1",m.style.transform="translateX(0)"},100+d*70):(m.style.opacity="0",m.style.transform="translateX(-20px)"))})}).observe(i,{attributes:!0})})}s(),console.log("Мобильное меню с иконками инициализировано")}function G(){const i=document.querySelector(".hero"),n=document.querySelector(".hero__console-img"),e=document.querySelector(".hero__content"),l=document.querySelector(".hero__description--desktop"),o=document.querySelector(".hero__description--mobile");document.querySelector(".hero__pricing");const s=document.getElementById("buy-button"),c=document.getElementById("more-details-button");let m=null,d;function g(){!n||!i||(n.onload=()=>i.classList.add("hero--loaded"),n.onerror=()=>{console.error("Не удалось загрузить изображение:",n.src),i.classList.add("hero--loaded")},n.complete&&i.classList.add("hero--loaded"))}function w(){if(!l||!o)return;const h=window.innerWidth>992;l.style.display=h?"block":"none",o.style.display=h?"none":"block"}function y(){e&&(m&&(m.disconnect(),m=null),m=new IntersectionObserver(h=>{h.forEach(t=>{var u;t.isIntersecting&&((u=t.target)!=null&&u.isConnected)&&(t.target.classList.add("animate-in"),m==null||m.unobserve(t.target))})},{threshold:.1}),e.isConnected&&m.observe(e))}function b(){s&&s.addEventListener("click",v),c&&c.addEventListener("click",p)}function v(){window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}function p(h){h.preventDefault();const t=document.getElementById("features"),u=document.querySelector(".header");if(!t||!u){window.location.hash="features";return}const f=u.offsetHeight,S=t.getBoundingClientRect().top+window.scrollY-f;window.scrollTo({top:S,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}function a(){m&&m.disconnect(),clearTimeout(d),window.removeEventListener("resize",r),s&&s.removeEventListener("click",v),c&&c.removeEventListener("click",p)}function r(){clearTimeout(d),d=setTimeout(w,200)}return g(),w(),y(),b(),window.addEventListener("resize",r),a}function W(i){let n=null,e=null,l=!1,o=0,s=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function m(r){r.key==="Escape"&&l&&p()}function d(){const r=document.createElement("div");return r.className="modal-about-overlay",r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("tabindex","-1"),r.style.display="none",r.addEventListener("click",p),i.appendChild(r),r}function g(){return e?e.title==="Extensive color selection"&&e.colorImages?`
      <img
        src="${e.colorImages[o]}"
  ...
  `:""}function w(){(e==null?void 0:e.title)==="Extensive color selection"&&e.colorImages&&(s&&clearInterval(s),s=setInterval(()=>{o=o===e.colorImages.length-1?0:o+1;const r=n.querySelector(".modal-about-image");r&&(r.src=e.colorImages[o],r.alt=`R36S Color Variant ${o+1}`)},1e3))}function y(){if(!n||!e)return;const r={"@context":"https://schema.org","@type":"ItemPage",mainEntity:{"@type":"Product",name:"R36S Handheld Game Console",description:e.fullDescription,image:e.imageUrl||(e.colorImages?e.colorImages[0]:""),offers:{"@type":"Offer",price:"35.48",priceCurrency:"USD",url:"https://www.aliexpress.com/item/1005007171465465.html"},category:"Video Game Console",feature:e.title}};e.id===1&&(r.mainEntity.faqPage={"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How many games are included in the R36S console?",acceptedAnswer:{"@type":"Answer",text:"The R36S console includes over 15,000 classic retro games from various platforms."}}]});const h=`
...
• Quick startup for instant gaming access`,videoUrl:V,imageAlt:"R36S Portability"}];function s(){console.log("Начинаем рендеринг карточек..."),i.innerHTML="";const p=o.map(r=>`
    ...
    `).join("");i.innerHTML=p;const a=i.querySelectorAll(".about-card");console.log(`Отрендерено ${a.length} карточек из ${o.length} необходимых`),a.length!==o.length?console.warn(`Ошибка рендеринга: отрендерено ${a.length} карточек вместо ${o.length}`):console.log("Рендеринг карточек успешно завершен")}const c=m(function(p){if(!p||!p.currentTarget)return;const a=p.currentTarget;if(!a||!a.getBoundingClientRect){console.warn("handleMouseMove: элемент карточки не существует или недоступен");return}try{const r=a.getBoundingClientRect();n={x:p.clientX-r.left,y:p.clientY-r.top},a.style.setProperty("--mouse-x",`${n.x}px`),a.style.setProperty("--mouse-y",`${n.y}px`)}catch(r){console.error("Ошибка при обработке движения мыши:",r)}},16);function m(p,a){let r,h;return function(){const t=this,u=arguments;h?(clearTimeout(r),r=setTimeout(function(){Date.now()-h>=a&&(p.apply(t,u),h=Date.now())},a-(Date.now()-h))):(p.apply(t,u),h=Date.now())}}function d(p){if(!p||!p.currentTarget){console.warn("handleButtonClick: событие или цель события не существует");return}p.stopPropagation();try{const a=parseInt(p.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",a);const r=o.find(h=>h.id===a);if(!r){console.error("Данные для карточки не найдены");return}e&&e.open(r)}catch(a){console.error("Ошибка при обработке клика по кнопке:",a)}}function g(p,a){let r;return function(){const h=this,t=arguments;clearTimeout(r),r=setTimeout(()=>{p.apply(h,t)},a)}}function w(){console.log("Очистка обработчиков событий карточек...");try{const p=document.querySelectorAll(".about-card");p&&p.length>0&&p.forEach(r=>{r&&(r.removeEventListener("mouseenter",()=>{}),r.removeEventListener("mouseleave",()=>{}),r.removeEventListener("mousemove",c))});const a=document.querySelectorAll(".about-card__button");a&&a.length>0&&a.forEach(r=>{r&&r.removeEventListener("click",d)}),i&&i.removeEventListener("click",()=>{}),console.log("Очистка обработчиков завершена")}catch(p){console.error("Ошибка при очистке обработчиков событий:",p)}}function y(){console.log("Настройка обработчиков событий для карточек...");const p=()=>{console.log("Проверяем наличие карточек для установки обработчиков...");const a=document.querySelectorAll(".about-card");if(!a||a.length===0){console.warn("Не найдены карточки для установки обработчиков событий"),setTimeout(p,200);return}console.log(`Устанавливаем обработчики событий для ${a.length} карточек`);const r=window.matchMedia("(max-width: 768px)").matches;!r&&i&&i.addEventListener("click",function(t){const u=t.target.closest(".about-card");if(u&&!t.target.closest(".about-card__button")){const f=parseInt(u.dataset.id);console.log("Клик по карточке ID:",f);const _=o.find(S=>S.id===f);if(!_){console.error("Данные для карточки не найдены");return}e&&e.open(_)}}),a.forEach(t=>{t&&(t.addEventListener("mouseenter",function(){t&&(parseInt(t.dataset.id),t.classList.add("active"))}),t.addEventListener("mouseleave",function(){t&&t.classList.remove("active")}),t.addEventListener("mousemove",c))});const h=document.querySelectorAll(".about-card__button");h&&h.length>0?(h.forEach(t=>{t&&t.addEventListener("click",d)}),console.log(`Установлены обработчики для ${h.length} кнопок`)):console.warn("Не найдены кнопки карточек"),window.addEventListener("resize",g(()=>{const t=!r,u=!window.matchMedia("(max-width: 768px)").matches;t!==u&&(w(),y())},250)),console.log("Настройка обработчиков событий успешно завершена")};document.readyState==="complete"||document.readyState==="interactive"?setTimeout(p,10):document.addEventListener("DOMContentLoaded",p)}function b(){console.log("Очистка всех обработчиков событий..."),w(),window.removeEventListener("resize",g),e=null,console.log("Очистка обработчиков событий завершена")}function v(){return function(){console.log("Запуск функции очистки секции About"),b()}}try{return console.log("Начинаем инициализацию секции About..."),console.log("Рендерим карточки..."),s(),console.log("Устанавливаем обработчики событий..."),y(),console.log("Инициализация About завершена успешно"),v()}catch(p){return console.error("Ошибка при инициализации About:",p),null}}function X(){const i=document.getElementById("features"),n=document.getElementById("featuresVideo"),e=document.getElementById("soundToggleButton"),l=document.getElementById("volumeOffIcon"),o=document.getElementById("volumeOnIcon"),s=document.getElementById("buyButton"),c=document.getElementById("moreInfoButton");if(!i){console.warn("Features section not found");return}n&&(n.volume=.5,n.play().catch(d=>{console.log("Автовоспроизведение не удалось:",d)})),s&&s.addEventListener("click",B),c&&c.addEventListener("click",M),e&&e.addEventListener("click",()=>T(n,l,o));const m=()=>{K(i,n,l,o)};return window.addEventListener("scroll",m),function(){s&&s.removeEventListener("click",B),c&&c.removeEventListener("click",M),e&&e.removeEventListener("click",()=>T(n,l,o)),window.removeEventListener("scroll",m),console.log("Features component cleaned up")}}function T(i,n,e){if(i)if(i.muted=!i.muted,i.muted){n.style.display="block",e.style.display="none";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Включить звук")}else{i.volume=.5,n.style.display="none",e.style.display="block";const l=document.getElementById("soundToggleButton");l&&l.setAttribute("aria-label","Выключить звук")}}function K(i,n,e,l){if(!i||!n||n.muted)return;const o=i.getBoundingClientRect();if(!(o.top<window.innerHeight&&o.bottom>0)){n.muted=!0,e.style.display="block",l.style.display="none";const c=document.getElementById("soundToggleButton");c&&c.setAttribute("aria-label","Включить звук")}}function B(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function M(){const i=document.getElementById("features-r36s"),n=document.querySelector(".header");if(i&&n){const e=n.offsetHeight,l=i.getBoundingClientRect().top,o=window.scrollY||window.pageYOffset,s=l+o-e;window.scrollTo({top:s,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function ee(){try{let t=function(){m&&(m.innerHTML=v?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},u=function(){d&&(d.innerHTML=p?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},f=function(){if(!(!o||r))if(v)o.pause(),v=!1,t();else{const S=o.play();S!==void 0?S.then(()=>{v=!0,t()}).catch(x=>{console.warn("Не удалось воспроизвести видео:",x),v=!1,t()}):(v=!0,t())}},_=function(){w&&(r=!0,o&&(o.style.display="none"),w.innerHTML=`
      ...
      `)};var i=t,n=u,e=f,l=_;console.log("Инициализация секции Categories");const o=document.querySelector(".categories__video"),s=document.getElementById("categories"),c=document.querySelector(".categories__content"),m=document.querySelector(".categories__video-play"),d=document.querySelector(".categories__video-mute"),g=document.querySelector(".categories__video-slider"),w=document.querySelector(".categories__video-container"),y=document.querySelector(".categories__video-time span:first-child"),b=document.querySelector(".categories__video-time span:last-child");if(!s)return console.error("Секция Categories не найдена в DOM"),{};if(c&&c.classList.add("animate-in"),!o)return console.error("Видео элемент не найден в DOM"),_(),{};let v=!1,p=!0,a=!1,r=!1;const h=S=>{if(isNaN(S)||S<0)return"0:00";const x=Math.floor(S/60),E=Math.floor(S%60);return`${x}:${E.toString().padStart(2,"0")}`};return o&&(o.muted=!0,o.loop=!0,o.playsInline=!0,o.style.display="block",o.style.visibility="visible",o.style.opacity="1",o.style.width="100%",o.style.borderRadius="24px",w&&(w.style.minHeight="200px"),o.addEventListener("loadedmetadata",()=>{try{console.log("Метаданные видео загружены"),a=!0,g&&!isNaN(o.duration)&&(g.max=o.duration,b&&(b.textContent=h(o.duration)))}catch(S){console.error("Ошибка при обработке метаданных видео:",S)}}),o.addEventListener("timeupdate",()=>{try{g&&!isNaN(o.currentTime)&&(g.value=o.currentTime,y&&(y.textContent=h(o.currentTime)))}catch(S){console.error("Ошибка при обновлении времени видео:",S)}}),o.addEventListener("error",()=>{console.error("Ошибка при загрузке видео"),_()}),setTimeout(()=>{if(o&&!r){const S=o.play();S!==void 0&&S.then(()=>{console.log("Автовоспроизведение видео успешно"),v=!0,t()}).catch(x=>{console.warn("Не удалось автовоспроизвести видео:",x)})}},1e3)),m&&m.addEventListener("click",S=>{S.stopPropagation(),f()}),d&&d.addEventListener("click",S=>{S.stopPropagation(),o&&(p=!p,o.muted=p,u())}),g&&g.addEventListener("input",S=>{if(o)try{const x=parseFloat(S.target.value);isNaN(x)||(o.currentTime=x)}catch(x){console.error("Ошибка при изменении времени видео:",x)}}),w&&w.addEventListener("click",S=>{S.target.closest(".categories__video-controls")||f()}),t(),u(),s.classList.add("initialized"),{togglePlay:f,cleanup:()=>{o&&(o.pause(),o.removeAttribute("src"),o.load())}}}catch(o){console.error("Критическая ошибка в initCategories:",o);const s=document.getElementById("categories");return s&&(s.style.display="block"),{}}}function C(){const i=document.querySelectorAll(".accordion__item");if(i.length===0){console.warn("FAQ аккордеон: элементы не найдены");return}console.log(`FAQ аккордеон: найдено ${i.length} вопросов`);const n=(l=null)=>{i.forEach(o=>{o!==l&&o.classList.contains("active")&&o.classList.remove("active")})};i.forEach(l=>{const o=l.querySelector(".accordion__header"),s=l.querySelector(".accordion__toggle"),c=l.querySelector(".accordion__content");if(!o||!s||!c){console.warn("FAQ аккордеон: структура элемента неполная",l);return}l===i[0]&&setTimeout(()=>{s.classList.add("pulse"),setTimeout(()=>{s.classList.remove("pulse")},1500)},1e3);const m=y=>{if(y.preventDefault(),y.stopPropagation(),s.classList.add("clicked"),setTimeout(()=>s.classList.remove("clicked"),300),l.classList.contains("active")){l.classList.remove("active");return}n(l),l.classList.add("active");const b=o.getBoundingClientRect();b.top>=10&&b.bottom<=window.innerHeight-10||setTimeout(()=>{window.scrollTo({top:window.scrollY+b.top-100,behavior:"smooth"})},100)};o.addEventListener("click",m),s.addEventListener("click",y=>{y.stopPropagation(),m(y)});const d=`faq-question-${Math.random().toString(36).substring(2,9)}`,g=`faq-answer-${Math.random().toString(36).substring(2,9)}`;o.setAttribute("id",d),o.setAttribute("aria-expanded","false"),o.setAttribute("aria-controls",g),c.setAttribute("id",g),c.setAttribute("aria-labelledby",d),c.setAttribute("role","region"),c.setAttribute("hidden","true"),new MutationObserver(y=>{y.forEach(b=>{if(b.type==="attributes"&&b.attributeName==="class"){const v=l.classList.contains("active");o.setAttribute("aria-expanded",v?"true":"false"),v?c.removeAttribute("hidden"):setTimeout(()=>{l.classList.contains("active")||c.setAttribute("hidden","true")},500)}})}).observe(l,{attributes:!0})});const e=l=>{if(l.key==="Escape"){n();return}const o=document.activeElement.closest(".accordion__item");if(!o)return;const s=Array.from(i),c=s.indexOf(o);if(c===-1)return;let m;switch(l.key){case"ArrowDown":m=(c+1)%s.length;break;case"ArrowUp":m=(c-1+s.length)%s.length;break;case"Home":m=0;break;case"End":m=s.length-1;break;default:return}const d=s[m].querySelector(".accordion__header");d&&(d.focus(),l.preventDefault())};return document.addEventListener("keydown",e),console.log("FAQ аккордеон успешно инициализирован"),{openItem:l=>{l>=0&&l<i.length&&(n(i[l]),i[l].classList.add("active"))},closeAll:()=>n()}}typeof window<"u"&&(document.addEventListener("DOMContentLoaded",()=>{window.faqAccordeon=C()}),window.initFaqAccordion=C);function te(){const i=document.getElementById("articles");if(!i){console.warn("Секция Articles не найдена в DOM, пробуем найти с другим id");const s=document.querySelector(".articles")||document.querySelector('section[id^="articles"]')||document.querySelector("section.articles");if(!s){console.error("Не удалось найти секцию Articles в DOM никаким способом"),console.debug("Структура DOM:",document.body.innerHTML);return}s.id||(s.id="articles"),console.log("Найден альтернативный элемент для секции Articles:",s)}console.log("Инициализация секции Articles с SEO-оптимизацией");const n=[{id:1,title:"R36S Retro Gaming",sections:[{subtitle:"R36S: The Ultimate Handheld Gaming Console for Retro Gaming Enthusiasts",content:"Welcome to the official home of the <strong>R36S handheld gaming console</strong>. The R36S has quickly become the go-to device for retro gaming enthusiasts across the <em>United States</em>, <em>United Kingdom</em>, and <em>Australia</em>. This powerful portable gaming system offers an exceptional combination of performance, versatility, and value that puts other retro consoles to shame. Whether you're reliving childhood classics or discovering retro gems for the first time, the <mark>R36S console</mark> delivers an unmatched gaming experience. Many gamers compare the <span>R36S vs Anbernic</span> models and consistently find that the R36S offers superior features at a more competitive price point. Ready to elevate your portable gaming experience? The R36S is now available for purchase online with special promotional pricing for a limited time."},{subtitle:"Comprehensive R36S Review: Performance That Exceeds Expectations",content:'After extensive testing, our <strong>R36S review</strong> confirms what many gamers have discovered – this console punches well above its weight class. The <mark>R36S emulator performance</mark> is particularly impressive, handling everything from 8-bit classics to more demanding 32-bit titles with remarkable smoothness. Games load quickly and run without the lag or frame drops that plague lesser devices. The <strong>R36S specs</strong> include a powerful processor paired with ample RAM that ensures consistent performance across various emulation platforms. What truly sets the R36S console apart in our review is its ability to handle multiple emulation systems without compromising on quality. Unlike competitors in the same price range, the R36S maintains excellent performance even with graphically intensive games. Players across <em>North America</em> and <em>Europe</em> have shared <mark>R36S reviews</mark> praising its reliable performance during extended gaming sessions. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> to experience this exceptional performance firsthand at our special online price.'},{subtitle:"How to Install Games on R36S: Simple Setup for Maximum Fun",content:`Learning <strong>how to install ROMs on R36S</strong> is refreshingly straightforward. The console's user-friendly interface makes the process accessible even for those new to retro gaming handhelds. First, you'll need to format a microSD card (up to 512GB supported) using your computer. Then, download your preferred game files and organize them in folders corresponding to each console type. After inserting the card into your R36S, the built-in menu system automatically detects and categorizes your games for easy access. The <mark>R36S setup guide</mark> included with every purchase walks you through this process with clear, step-by-step instructions. Additionally, the R36S console supports various file formats, eliminating compatibility headaches common with other devices. Customers in <em>Canada</em>, <em>Australia</em>, and throughout <em>Europe</em> appreciate how the R36S simplifies the game installation process. Need more guidance? The complete <strong>R36S setup guide</strong> is available on our website, along with video tutorials. Don't miss our current sale price on the R36S – <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Now" target="_blank" rel="nofollow">order now</a> while supplies last!`},{subtitle:"R36S Specifications: Hardware That Delivers Premium Gaming Experience",content:"The impressive <strong>R36S specifications</strong> explain why this console has garnered such positive attention. At its heart, the R36S boasts a quad-core processor clocked at 1.5GHz, paired with 1GB of DDR3 RAM for smooth multitasking. The <mark>R36S screen resolution</mark> of 640x480 on its 3.5-inch IPS display delivers crisp visuals with excellent color reproduction and wide viewing angles. This display quality significantly enhances the gaming experience, particularly for pixel-art classics. The <strong>R36S battery life</strong> extends to an impressive 6-8 hours of continuous play on a single charge, with charging time of approximately 2-3 hours via the USB-C port. Storage options are flexible, with support for microSD cards up to 512GB, allowing an extensive game library. The <mark>R36S controller layout</mark> features a responsive D-pad, dual analog sticks, four action buttons, and shoulder triggers that provide precise control across different game genres. Available in multiple colors, the R36S is currently offered at a special promotional price in the <em>UK</em>, <em>USA</em>, and throughout <em>Asia</em>. Check our website for the current <strong>R36S price</strong> and available discount offers."},{subtitle:"Best Games for R36S: Thousands of Classics at Your Fingertips",content:`The <strong>R36S console</strong> truly shines when loaded with the best games that showcase its capabilities. The system excels at running 8-bit and 16-bit classics from Nintendo, Sega, and other iconic platforms with perfect emulation. More impressively, the R36S handles PlayStation 1 titles with remarkable fidelity, maintaining smooth framerates even in 3D games. Fighting game enthusiasts praise the <mark>R36S controller layout</mark> and responsive buttons, which make titles like Street Fighter and King of Fighters a joy to play. RPG fans can enjoy lengthy adventures like Final Fantasy and Chrono Trigger with the benefit of the extended <strong>R36S battery life</strong>. The console's excellent <mark>R36S sound quality</mark> and speakers deliver immersive audio, though many users opt for headphones for the full experience. The R36S firmware supports save states across all emulators, allowing you to pause and resume your progress at any time. Gamers in <em>Mexico</em>, <em>Brazil</em>, and across <em>South America</em> have particularly embraced the R36S for its extensive game compatibility. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> from our official online store to receive exclusive bonus content and take advantage of our current sale price.`},{subtitle:"A Unique Gaming Experience with R36S",content:`The <strong>R36S</strong> has garnered attention for its impressive gaming library, housing over 15,000 titles in the 64GB model and expanding to approximately 20,000 games in the 128GB version. This comprehensive collection spans across several iconic gaming platforms, including: <ul><li><strong>Nintendo Entertainment System (NES)</strong></li><li><strong>Super Nintendo Entertainment System (SNES)</strong></li><li><strong>Sega Genesis</strong></li><li><strong>PlayStation 1</strong></li><li><strong>Nintendo 64</strong></li><li><strong>Game Boy Advance</strong></li><li><strong>Nintendo DS</strong></li><li><strong>PlayStation Portable (PSP)</strong></li></ul><p>This extraordinary compilation allows enthusiasts to journey through the golden era of gaming across multiple legendary platforms, all within a single portable device.</p><p class="article__highlight"><strong>R36S Standout Gaming Experiences</strong><br>While the device offers thousands of nostalgic adventures, certain masterpieces particularly shine through:<ul><li><strong>Super Mario Bros.</strong> (NES): The revolutionary platformer that defined an entire genre and laid the groundwork for countless games to follow.</li><li><strong>The Legend of Zelda: A Link to the Past</strong> (SNES): A timeless adventure that masterfully combines puzzle-solving, exploration, and combat into an unforgettable experience.</li><li><strong>Sonic the Hedgehog</strong> (Sega Genesis): Sega's signature blue speedster that challenged Nintendo's dominance with its distinctive fast-paced gameplay.</li><li><strong>Final Fantasy VII</strong> (PlayStation 1): The groundbreaking RPG that transformed video game storytelling with its complex characters and emotional narrative.</li><li><strong>Super Mario 64</strong> (Nintendo 64): The trailblazing 3D platformer that revolutionized how players interact with virtual worlds.</li><li><strong>Pokémon FireRed</strong> (Game Boy Advance): The beloved reimagining of the original Pokémon Red, enhanced with additional features and improved graphics.</li><li><strong>Mario Kart DS</strong> (Nintendo DS): An exhilarating racing experience offering endless entertainment through its inventive tracks and competitive multiplayer.</li><li><strong>God of War: Chains of Olympus</strong> (PSP): An action-packed epic showcasing the impressive capabilities of Sony's handheld console.</li></ul>These highlighted gems represent merely a glimpse into the vast array of quality titles available on the <mark>R36S</mark>, catering to diverse gaming preferences from casual play to hardcore challenges.</p>`},{subtitle:"R36S Firmware Update Guide: Keeping Your Console at Peak Performance",content:`Maintaining the latest <strong>R36S firmware</strong> ensures you'll enjoy optimal performance and access to the newest features. The <mark>R36S firmware update</mark> process is straightforward and user-friendly. Begin by downloading the latest firmware package from our official website. Then, place the file in the root directory of your microSD card. After inserting the card into your powered-off R36S, hold the select button while powering on the device to enter update mode. The console will automatically detect and install the new firmware, typically completing in 2-3 minutes. Each <strong>R36S firmware update</strong> brings performance optimizations, new emulators, and interface improvements. Following the update, the <mark>R36S user manual</mark> recommends recalibrating your controls for the best gaming experience. Our technical support team, available to customers worldwide including <em>Japan</em>, <em>South Korea</em>, and across <em>Europe</em>, can assist with any firmware update questions. Subscribe to our newsletter for notifications about new R36S firmware releases and special offers on accessories. Don't miss our <a href="https://www.aliexpress.com/item/1005007171465465.html" title="R36S Limited Time Promotion" target="_blank" rel="nofollow">limited-time promotion</a> with discounted pricing on the R36S console and accessory bundles.`}]},{id:2,title:"R36S Official Website",sections:[{subtitle:"R36S Official Website - The Ultimate Gaming Experience at Your Fingertips",content:"Welcome to the <strong>R36S Official Website</strong>, your premier destination for cutting-edge handheld gaming technology. Our revolutionary gaming console has transformed the portable gaming landscape, offering unprecedented performance in a sleek, ergonomic design. The <mark>R36S</mark> combines powerful hardware with intuitive controls to deliver an immersive gaming experience wherever you go. Whether you're a casual gamer or a dedicated enthusiast, the <strong>R36S game console</strong> provides the perfect balance of power, portability, and playability. Discover why gamers across <em>North America</em>, <em>Europe</em>, and <em>Asia</em> are choosing the R36S as their preferred handheld gaming device. Continue reading to learn about our exclusive features, technical specifications, and why the R36S stands apart from other gaming consoles on the market today."},{subtitle:"Discover the Revolutionary R36S Handheld Gaming Experience",content:'The <strong>R36S handheld</strong> represents the next generation of portable gaming technology. Unlike conventional gaming devices, the R36S handheld features an advanced cooling system that prevents overheating during extended gaming sessions. Additionally, the vibrant high-resolution display ensures crystal-clear visuals even in bright outdoor conditions. Moreover, the <mark>R36S game console</mark> includes customizable controls that adapt to your unique gaming style. Furthermore, the lightweight yet durable construction makes the R36S perfect for gaming on the go. Meanwhile, the extended battery life keeps you playing for hours without interruption. Subsequently, the intuitive user interface makes navigating between games and settings effortless. In contrast to other portable systems, the <strong>R36S handheld</strong> offers exceptional value without compromising on quality. Consequently, gamers in the <em>United Kingdom</em>, <em>Australia</em>, and <em>Canada</em> can <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Online" target="_blank" rel="nofollow">order online</a> and experience the difference today. However, limited-time promotional pricing makes this the ideal time to purchase your R36S game console.'},{subtitle:"Unmatched Performance in the R36S Game Console",content:"The heart of the <strong>R36S game console</strong> lies in its powerful processing capabilities. Specifically, the custom-designed CPU and GPU combination delivers desktop-quality graphics in a handheld format. In particular, the advanced thermal management system prevents throttling during intensive gaming sessions. Similarly, the high-speed RAM ensures smooth multitasking between games and applications. Likewise, the expandable storage options allow you to carry your entire game library wherever you go. Certainly, the <mark>R36S handheld's</mark> performance metrics exceed industry standards in its price range. Nevertheless, the energy-efficient design maintains battery life without sacrificing processing power. Above all, the <strong>R36S game console's</strong> architecture supports both retro classics and modern gaming experiences. Therefore, gamers looking for performance and versatility consistently choose the R36S. Indeed, retailers across <em>Germany</em>, <em>France</em>, and <em>Japan</em> report steadily increasing demand for this innovative gaming device. Finally, manufacturer specifications confirm that the R36S outperforms competing handhelds costing significantly more."},{subtitle:"Enhanced Gaming Experience with the R36S Handheld's Exclusive Features",content:"The <strong>R36S handheld</strong> comes equipped with numerous exclusive features designed to enhance your gaming experience. First, the haptic feedback system provides immersive tactile responses that correspond with in-game actions. Second, the adjustable performance modes allow you to prioritize either graphical fidelity or battery conservation. Third, the integrated voice chat functionality eliminates the need for external communication devices. Fourth, the customizable RGB lighting adds a personal touch to your gaming setup. Fifth, the quick-resume feature lets you instantly return to your game after a break. Sixth, the dedicated streaming mode optimizes performance for content creators. Meanwhile, the brand's commitment to quality ensures each <mark>R36S game console</mark> meets rigorous standards before shipping. As a result, customers in <em>Spain</em>, <em>Italy</em>, and <em>South Korea</em> can shop confidently knowing they're receiving a premium product. Consequently, the history of the brand demonstrates consistent innovation in the gaming sector. Therefore, the manufacturer continues to support the R36S with regular firmware updates and expanded compatibility."},{subtitle:"Why Gamers Worldwide Choose the R36S Official Website for Their Gaming Needs",content:"The <strong>R36S Official Website</strong> offers distinct advantages for discerning gamers seeking the ultimate handheld experience. Primarily, exclusive online-only configurations provide enhanced specifications unavailable through retail channels. Additionally, direct purchases from the <mark>R36S Official Website</mark> include extended warranty coverage at no additional cost. Furthermore, members of the official online community gain early access to firmware updates and beta features. Moreover, the official online store frequently offers promotional pricing unavailable elsewhere. Consequently, the <strong>R36S game console</strong> purchased directly from the manufacturer includes premium accessories in standard packages. Subsequently, customers in <em>Brazil</em>, <em>Mexico</em>, and <em>India</em> benefit from regionalized payment options and shipping methods. Meanwhile, the brand's commitment to customer satisfaction has established a loyal following in competitive gaming circles. In essence, the <mark>R36S handheld</mark> represents not just a product but an entire ecosystem of gaming innovation. Therefore, visiting the <span>R36S Official Website</span> remains the optimal way to experience everything this revolutionary console offers. Indeed, the manufacturer's direct sales model ensures authenticity and full support for every purchased device."},{subtitle:"The Future of Gaming with the R36S Official Website and Upcoming Innovations",content:"The <strong>R36S Official Website</strong> stands as the definitive source for information about upcoming innovations in the R36S ecosystem. Primarily, the <mark>R36S game console's</mark> modular design allows for future hardware expansions without requiring a completely new device. Additionally, the development team is actively working on cloud gaming integration to further expand the available game library. Furthermore, the <strong>R36S handheld</strong> will soon support cross-platform multiplayer with major gaming systems. Moreover, announced accessories will enhance the versatility of the base R36S game console for specialized gaming genres. Consequently, early adopters of the R36S platform will benefit from a continuously evolving gaming experience. Subsequently, the price point remains competitive despite these substantial additions to functionality. Meanwhile, the brand continues to expand its presence in emerging markets including <em>Southeast Asia</em> and <em>Eastern Europe</em>. Therefore, the <mark>R36S handheld</mark> represents not just current gaming technology but a future-proof investment. In conclusion, whether you're looking to purchase your first R36S or upgrade from a previous model, the <span>R36S Official Website</span> offers the most comprehensive information and purchase options. Indeed, as the gaming landscape evolves, the <strong>R36S game console</strong> evolves with it, maintaining its position at the forefront of handheld gaming innovation."},{subtitle:"Why Choose the R36S: Value, Performance, and Community Support",content:`The <strong>R36S</strong> has established itself as the preferred choice for discerning retro gamers for several compelling reasons. When conducting an <span>R36S vs Anbernic comparison</span>, the R36S consistently offers better specifications at a more competitive price point. The <mark>R36S price</mark> and value for money is unmatched in the portable retro gaming market, delivering premium features without the premium cost. The <strong>R36S portable gaming console</strong> features extend beyond mere hardware specifications – the active community of users continues to develop custom firmware, game ports, and utilities that expand the system's capabilities. The <mark>R36S emulator performance</mark> receives regular optimizations through community contributions, ensuring that even the most demanding games run smoothly. The <strong>R36S handheld gaming console review</strong> scores consistently highlight the device's exceptional build quality, with a solid feel that withstands the rigors of portable gaming. Customers across <em>North America</em>, <em>Europe</em>, <em>Australia</em>, and <em>Asia</em> have made the R36S their go-to retro gaming solution. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Official" target="_blank" rel="nofollow">Order your R36S today</a> from our official website to join this passionate community and take advantage of our current promotional pricing, exclusive bundles, and free worldwide shipping on orders over $100.`},{subtitle:"Welcome to the R36S Official Store",content:`Discover premium products at the <strong>R36S official store</strong>, your ultimate destination for authentic R36S merchandise. Our official store offers an extensive selection of cutting-edge devices designed to enhance your daily experience. Looking to buy <strong>R36S products</strong> at the best price? The <strong>R36S official store</strong> delivers exceptional value with regular promotions and sales events. <mark>Order online today</mark> and experience the convenience of worldwide shipping from the R36S official store. Our team is dedicated to providing superior customer service, ensuring your shopping experience exceeds expectations. Whether you're searching for the latest releases or popular bestsellers, the <strong>R36S official store</strong> has everything you need. Check out our current <span>special offers</span> and take advantage of exclusive deals available only at the R36S official store. With secure payment options and fast delivery, shopping at the <strong>R36S official store</strong> is both safe and convenient. Join thousands of satisfied customers who trust the R36S official store for authentic products and unmatched quality. Visit our website now or contact our support team to learn more about where to buy R36S products. The <strong>R36S official store</strong> ships to major regions including <em>North America</em>, <em>Europe</em>, <em>Asia</em>, and <em>Australia</em>, making our premium products accessible to customers worldwide. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Visit R36S Official Store" target="_blank" rel="nofollow">Shop at the R36S official store today</a> and experience the difference that quality products and exceptional service can make.`}]}],e=i.querySelector(".articles__grid");if(!e){console.error("Элемент .articles__grid не найден в секции Articles");return}(()=>{if(!document.querySelector('meta[name="description"]')){const s=document.createElement("meta");s.name="description",s.content="R36S - The Ultimate Handheld Gaming Console for Retro Gaming. Official website with specifications, reviews, and purchase options.",document.head.appendChild(s)}if(!document.querySelector('meta[name="keywords"]')){const s=document.createElement("meta");s.name="keywords",s.content="R36S, retro gaming, handheld console, portable gaming, R36S specs, R36S review, retro games, emulator, gaming device",document.head.appendChild(s)}})(),n.forEach(s=>{const c=document.createElement("article");c.className="article",c.id=`article-${s.id}`,c.dataset.articleId=s.id,c.setAttribute("itemscope",""),c.setAttribute("itemtype","http://schema.org/Article");const m=document.createElement("h2");m.className="article__title",m.setAttribute("itemprop","headline"),m.innerHTML=s.title,c.appendChild(m);const d=document.createElement("div");d.className="article__content-wrapper",d.setAttribute("itemprop","articleBody"),s.sections.forEach((v,p)=>{const a=document.createElement("section");if(a.className="article__section",a.id=`section-${s.id}-${p}`,p!==0||v.subtitle!==s.title){const h=document.createElement("h3");h.className="article__subtitle",h.innerHTML=v.subtitle,a.appendChild(h)}const r=document.createElement("div");r.className="article__content",r.innerHTML=v.content,a.appendChild(r),d.appendChild(a)}),c.appendChild(d);const g=document.createElement("script");g.type="application/ld+json";const w={"@context":"https://schema.org","@type":"Article",headline:s.title,description:s.sections[0].content.substring(0,150)+"...",keywords:"R36S, retro gaming, handheld console, portable gaming",author:{"@type":"Organization",name:"R36S Official"},publisher:{"@type":"Organization",name:"R36S",logo:{"@type":"ImageObject",url:"/assets/images/r36s-logo.png"}},datePublished:new Date().toISOString(),dateModified:new Date().toISOString()};g.textContent=JSON.stringify(w),c.appendChild(g);const y=document.createElement("footer");y.className="article__footer";const b=document.createElement("a");b.href="https://www.aliexpress.com/item/1005007171465465.html",b.className="article__cta",b.textContent="Order R36S Now",b.setAttribute("itemprop","url"),b.setAttribute("title","Order R36S Gaming Console"),b.setAttribute("rel","nofollow"),b.setAttribute("target","_blank"),y.appendChild(b),c.appendChild(y),e.appendChild(c)}),(()=>{const s=document.createElement("h1");s.className="articles__heading",s.textContent="R36S Gaming Console - Official Information",i.querySelector(".articles__container").insertBefore(s,i.querySelector(".articles__grid"))})(),setTimeout(()=>{C()},500),setTimeout(()=>{console.log("Проверка наличия элементов аккордеона перед инициализацией:");const s=document.querySelectorAll(".accordion__item");console.log(`Найдено ${s.length} элементов аккордеона`),console.log("Первый элемент аккордеона:",s[0]),s.length>0&&(console.log("Структура первого элемента:"),console.log("- Заголовок:",s[0].querySelector(".accordion__header")),console.log("- Кнопка:",s[0].querySelector(".accordion__toggle")),console.log("- Контент:",s[0].querySelector(".accordion__content"))),console.log("Вызываем initFaqAccordion...");const c=C();console.log("Результат инициализации:",c?"успешно":"ошибка")},1e3),console.log("Инициализация секции Articles завершена успешно")}function oe(){if(console.log("Инициализация переключателей яркости текста в блоках - НАЧАЛО"),window._themeToggleInitialized)return console.warn("Обнаружена повторная инициализация переключателей яркости. Пропускаем..."),window._themeToggleCleanup;window._themeToggleInitialized=!0;const i=document.getElementById("articles")||document.querySelector(".articles"),n=document.getElementById("official-website")||document.querySelector(".official-website"),e=document.getElementById("retro-gaming")||document.querySelector(".retro-gaming");if(!i&&!n&&!e){console.error("Секции для добавления переключателей яркости текста не найдены");return}const l=[];function o(d,g){if(!d)return;console.log(`Добавление переключателей в секцию ${d.id||d.className}`);const w=d.querySelectorAll(".article");console.log(`Найдено ${w.length} блоков для добавления переключателей в секции ${d.id||d.className}`),w.forEach((y,b)=>{const v=g!==void 0?g:b%3;if(y.querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label")){console.warn(`Блок #${b} уже содержит кнопку переключения. Пропускаем создание.`);return}const a=document.createElement("button");switch(a.setAttribute("type","button"),v){case 0:a.className="brightness-toggle",a.innerHTML=`
          ...
          `;const r=y.querySelector(".article__title");if(r){const t=document.createElement("div");t.className="article__title-container";const u=r.cloneNode(!0);t.appendChild(u),t.appendChild(a),r.parentNode.replaceChild(t,r)}else y.insertBefore(a,y.firstChild);break;case 1:a.className="brightness-toggle brightness-toggle-corner",a.innerHTML=`
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `,y.appendChild(a);break;case 2:a.className="brightness-toggle-with-label",a.innerHTML=`
            <span class="brightness-toggle-label">Ярче</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `;const h=y.querySelector(".article__title");if(h){const t=document.createElement("div");t.className="article__title-container";const u=h.cloneNode(!0);t.appendChild(u),t.appendChild(a),h.parentNode.replaceChild(t,h)}else y.insertBefore(a,y.firstChild);break}l.push(a)})}i&&o(i);let s;if(e){const d=e.querySelectorAll(".article");if(d.length>0){const g=d[0].querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label");g&&(g.classList.contains("brightness-toggle-corner")?s=1:g.classList.contains("brightness-toggle-with-label")?s=2:s=0,console.log(`Обнаружен стиль кнопки в секции R36S Retro Gaming: ${s}`))}}n&&o(n,s!==void 0?s:1),console.log(`Создано ${l.length} кнопок переключения`),l.forEach(d=>{const g=d.cloneNode(!0);d.parentNode&&d.parentNode.replaceChild(g,d);const w=l.indexOf(d);w!==-1&&(l[w]=g)}),l.forEach(d=>{const g=d.closest(".article");if(!g){console.error("Не найден родительский блок .article для кнопки переключения");return}d.addEventListener("click",function(v){if(v.preventDefault(),v.stopPropagation(),console.log("Клик по кнопке переключения яркости"),console.log("Состояние до переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),g.classList.toggle("bright-text"),d.classList.toggle("active"),console.log("Состояние после переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),d.classList.contains("brightness-toggle-with-label")){const h=d.querySelector(".brightness-toggle-label");h&&(h.textContent=g.classList.contains("bright-text")?"Тусклее":"Ярче",console.log("Изменен текст лейбла на:",h.textContent))}const p=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),a=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown",r=g.classList.contains("bright-text")?"bright":"normal";localStorage.setItem(`r36s-${a}-article-brightness-${p}`,r),console.log(`Яркость текста в блоке ${p} секции ${a} изменена на: ${r}`)});const w=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),y=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown";if(localStorage.getItem(`r36s-${y}-article-brightness-${w}`)==="bright"){if(g.classList.add("bright-text"),d.classList.add("active"),d.classList.contains("brightness-toggle-with-label")){const v=d.querySelector(".brightness-toggle-label");v&&(v.textContent="Тусклее")}console.log(`Восстановлено состояние для блока ${w} в секции ${y}: яркий`)}else console.log(`Блок ${w} в секции ${y} в обычном режиме`)});const c=document.createElement("style");c.textContent=`
  ...
  `,document.head.appendChild(c);const m=function(){l.forEach(d=>{if(d&&d.parentNode){const g=d.closest(".article__title-container");if(g){const w=g.querySelector(".article__title");w&&g.parentNode&&g.parentNode.replaceChild(w,g)}else d.parentNode.removeChild(d)}}),c&&c.parentNode&&c.parentNode.removeChild(c),window._themeToggleInitialized=!1,console.log("Очистка переключателей яркости выполнена")};return window._themeToggleCleanup=m,console.log("Инициализация переключателей яркости текста в блоках - ЗАВЕРШЕНА"),m}const O={"phone-call":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone-call"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path><path d="M14.05 2a9 9 0 0 1 8 7.94"></path><path d="M14.05 6A5 5 0 0 1 18 10"></path></svg>',mail:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>',"map-pin":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>',"message-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle"><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"></path></svg>',send:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send"><path d="m22 2-7 20-4-9-9-4Z"></path><path d="M22 2 11 13"></path></svg>',"alert-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" x2="12" y1="8" y2="12"></line><line x1="12" x2="12.01" y1="16" y2="16"></line></svg>',loader:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-loader animate-spin"><line x1="12" x2="12" y1="2" y2="6"></line><line x1="12" x2="12" y1="18" y2="22"></line><line x1="4.93" x2="7.76" y1="4.93" y2="7.76"></line><line x1="16.24" x2="19.07" y1="16.24" y2="19.07"></line><line x1="2" x2="6" y1="12" y2="12"></line><line x1="18" x2="22" y1="12" y2="12"></line><line x1="4.93" x2="7.76" y1="19.07" y2="16.24"></line><line x1="16.24" x2="19.07" y1="7.76" y2="4.93"></line></svg>'};function I(i,n=24){return O[i]?O[i].replace(/width="24"/,`width="${n}"`).replace(/height="24"/,`height="${n}"`):(console.error(`Icon "${i}" not found`),"")}function ne(){document.querySelectorAll("[data-icon]").forEach(n=>{const e=n.getAttribute("data-icon"),l=parseInt(n.getAttribute("data-size")||"24",10);e&&(n.innerHTML=I(e,l))})}function ie(){console.log("Инициализация секции Contact");const i=document.querySelector(".contact__form"),n=document.getElementById("name"),e=document.getElementById("email"),l=document.getElementById("phone"),o=document.getElementById("message"),s=document.querySelector(".form__button"),c=document.createElement("div");c.className="form__error",c.style.display="none",c.innerHTML=`
    <div class="form__error-icon">${I("alert-circle",16)}</div>
    <span></span>
  `,i.insertBefore(c,i.firstChild);const m={name:"",email:"",phone:"",message:""};function d(v){c.querySelector("span").textContent=v,c.style.display="flex"}function g(){c.style.display="none"}function w(v){const{name:p,value:a}=v.target;m[p]=a,g()}n.addEventListener("input",w),e.addEventListener("input",w),l.addEventListener("input",w),o.addEventListener("input",w);async function y(v){v.preventDefault(),b(!0);try{if(!m.name||!m.email||!m.phone||!m.message)throw new Error("Please fill in all fields");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(m.email))throw new Error("Please enter a valid email");if(!/^\+?[0-9]{10,14}$/.test(m.phone.replace(/\D/g,"")))throw new Error("Please enter a valid phone number.");await new Promise(h=>setTimeout(h,1e3)),n.value="",e.value="",l.value="",o.value="",Object.keys(m).forEach(h=>{m[h]=""}),alert("Message sent successfully! We will contact you shortly.")}catch(a){d(a.message||"There was an error sending your message. Please try again later."),console.error("Form submission error:",a)}finally{b(!1)}}function b(v){[n,e,l,o].forEach(a=>{a.disabled=v}),s.disabled=v,s.innerHTML=v?`<span class="button__icon">${I("loader",20)}</span> Sending...`:`<span class="button__icon">${I("send",20)}</span> Send message`}return i.addEventListener("submit",y),function(){n.removeEventListener("input",w),e.removeEventListener("input",w),l.removeEventListener("input",w),o.removeEventListener("input",w),i.removeEventListener("submit",y)}}function re(){const i="/R36S_STORE_JS/",e={review1:{webp:`${i}img/reviews/imm_1_1x.webp`,jpg:`${i}img/reviews/imm_1_1x.jpg`},review2:{webp:`${i}img/reviews/imm_2_1x.webp`,jpg:`${i}img/reviews/imm_2_1x.jpg`},review3:{webp:`${i}img/reviews/imm_3_1x.webp`,jpg:`${i}img/reviews/imm_3_1x.jpg`},review4:{webp:`${i}img/reviews/imm_4_1x.webp`,jpg:`${i}img/reviews/imm_4_1x.jpg`}},l=[{id:1,rating:5,color:"Purple 64GB",author:"AliExpress Shopper",date:"21 Aug 2024",text:"I just got my hands on the R36S retro console and it's seriously amazing for old-school gaming. The screen is super clear, it runs games smoothly, and battery life is solid. I love how I can load up my favorite classics and play...",images:{webp:e.review1.webp,jpeg:e.review1.jpg},helpful:12,verified:!0},{id:2,rating:5,color:"Yellow 128G",author:"V***h",date:"26 Aug 2024",text:"After playing with the R36S for a week, I'm really impressed and absolutely delighted. The build quality feels great, and switching between different retro games is super easy. The controls are comfortable for long gaming sessions.",images:{webp:e.review4.webp,jpeg:e.review4.jpg},helpful:8,verified:!0},{id:3,rating:5,color:"White 64GB",author:"M***z",date:"22 Aug 2024",text:"The R36S has become my go-to gaming device. I wasn't sure about buying another retro console, but this one surprised me. The screen is bright and sharp, games run without issues, and it's small enough to fit in my pocket.",images:{webp:e.review3.webp,jpeg:e.review3.jpg},helpful:15,verified:!0},{id:4,rating:5,color:"Black 128GB",author:"K***r",date:"28 Aug 2024",text:"I've been using the R36S for a few weeks now, and I'm genuinely impressed. The 3.5-inch IPS screen delivers crisp visuals, and the build quality feels solid. The dual analog sticks are responsive, making retro gaming a joy.",images:{webp:e.review2.webp,jpeg:e.review2.jpg},helpful:10,verified:!0,mobileOnly:!0}],o=new Set;let s=null,c=window.innerWidth<=1200;function m(t=!1){const u=document.createElementNS("http://www.w3.org/2000/svg","svg");u.classList.add("review-card__star"),u.setAttribute("viewBox","0 0 24 24"),u.setAttribute("fill",t?"currentColor":"none"),u.setAttribute("stroke","currentColor"),u.setAttribute("stroke-width","2");const f=document.createElementNS("http://www.w3.org/2000/svg","polygon");return f.setAttribute("points","12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"),u.appendChild(f),u}function d(){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.classList.add("review-card__verified"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("fill","none"),t.setAttribute("stroke","currentColor"),t.setAttribute("stroke-width","2");const u=document.createElementNS("http://www.w3.org/2000/svg","path");return u.setAttribute("d","M20 6L9 17l-5-5"),t.appendChild(u),t}function g(t){const u=document.getElementById("reviewCardTemplate");if(!u)return console.error("Шаблон карточки отзыва не найден"),null;const f=u.content.cloneNode(!0).querySelector(".review-card");f.dataset.id=t.id,t.mobileOnly&&(f.classList.add("mobile-only"),c||(f.style.display="none"));const _=f.querySelector(".review-card__rating");for(let L=0;L<5;L++)_.appendChild(m(L<t.rating));f.querySelector(".review-card__variant").textContent=t.color,f.querySelector(".review-card__text").textContent=t.text;const S=f.querySelector("picture");S.querySelector("source").setAttribute("srcset",t.images.webp);const x=S.querySelector("img");x.setAttribute("src",t.images.jpeg),x.setAttribute("alt",`Review ${t.id}`);const E=f.querySelector(".review-card__name");t.verified&&E.prepend(d()),E.appendChild(document.createTextNode(t.author)),f.querySelector(".review-card__date").textContent=t.date,f.querySelector(".review-card__helpful-count").textContent=`Helpful (${t.helpful})`,f.addEventListener("click",w),f.addEventListener("mouseenter",()=>y(t.id)),f.addEventListener("mouseleave",b);const R=f.querySelector(".review-card__helpful");return R.addEventListener("mouseenter",()=>{R.querySelector("svg").setAttribute("fill","currentColor"),R.querySelector("svg").classList.add("scale-125"),R.querySelector("svg").classList.remove("scale-100")}),R.addEventListener("mouseleave",()=>{R.querySelector("svg").setAttribute("fill","none"),R.querySelector("svg").classList.remove("scale-125"),R.querySelector("svg").classList.add("scale-100")}),f}function w(){window.open("https://www.aliexpress.com/item/1005007226123844.html#feedback","_blank","noopener,noreferrer")}function y(t){s=t;const u=document.querySelector(`.review-card[data-id="${t}"]`);if(u){const f=u.querySelector(".review-card__arrow-wrapper");f&&(f.style.display="flex")}}function b(){const t=document.querySelector(`.review-card[data-id="${s}"]`);if(t){const u=t.querySelector(".review-card__arrow-wrapper");u&&(u.style.display="none")}s=null}function v(){const t=document.getElementById("reviewsGrid");if(!t){console.error("Контейнер для отзывов не найден");return}const u=document.getElementById("reviewCardTemplate"),f={};t.querySelectorAll(".review-card").forEach(x=>{x.dataset.id&&(f[x.dataset.id]=x)});const _=l.filter(x=>!x.mobileOnly||x.mobileOnly&&c),S=[];_.forEach(x=>{if(f[x.id]){const E=f[x.id];E.style.display="block",S.push(E),delete f[x.id]}else{const E=g(x);E&&S.push(E)}}),Object.values(f).forEach(x=>{x!==u&&(x.style.display="none")}),t.innerHTML="",t.appendChild(u),S.forEach(x=>{t.appendChild(x)}),p()}function p(){if(!("IntersectionObserver"in window)){console.warn("IntersectionObserver не поддерживается в этом браузере"),document.querySelectorAll(".review-card").forEach(u=>{u.classList.add("animate-in")});return}const t=new IntersectionObserver(u=>{u.forEach(f=>{if(f.isIntersecting){const _=f.target.dataset.id;o.has(_)||(f.target.classList.add("animate-in"),o.add(_))}})},{threshold:.1});document.querySelectorAll(".review-card").forEach(u=>{t.observe(u)})}function a(){c=window.innerWidth<=1200,v(),document.querySelectorAll(".review-card").forEach(u=>{u.classList.contains("mobile-only")&&(u.style.display=c?"block":"none")})}function r(){v();let t;const u=()=>{clearTimeout(t),t=setTimeout(a,250)};window.addEventListener("resize",u);const f=document.createElement("style");f.textContent=`
      .review-card {
        opacity: 0;
    ...
    `,document.head.appendChild(f),setTimeout(a,100);const _=document.getElementById("reviews");if(_&&!_.hasAttribute("itemscope")){_.setAttribute("itemscope",""),_.setAttribute("itemtype","http://schema.org/Product");const S=document.createElement("meta");S.setAttribute("itemprop","name"),S.setAttribute("content","R36S Handheld Game Console"),_.prepend(S);const x=document.createElement("meta");x.setAttribute("itemprop","description"),x.setAttribute("content","R36S Handheld Game Console with 3.5-inch IPS screen and retro games"),_.prepend(x)}}r();function h(){if(window.removeEventListener("resize",a),window.removeEventListener("resize",()=>{}),"IntersectionObserver"in window){const t=[];new IntersectionObserver(()=>{}).disconnect(),t.forEach(f=>f.disconnect())}document.querySelectorAll(".review-card").forEach(t=>{t.removeEventListener("click",w),t.removeEventListener("mouseenter",()=>{}),t.removeEventListener("mouseleave",b),Object.keys(l).forEach(f=>{t.removeEventListener("mouseenter",()=>y(f))});const u=t.querySelector(".review-card__helpful");u&&(u.removeEventListener("mouseenter",()=>{}),u.removeEventListener("mouseleave",()=>{}))}),console.log("Reviews section cleanup completed")}return{cleanup:h,renderReviewCards:v}}const se={};function ae(){console.log("Products секция инициализирована");const n=!se?"/":"/R36S_STORE_JS/",e={i0_0:{jpg:`${n}img/products/i_0_0x.jpg`,webp:`${n}img/products/i_0_0x.webp`},i1:{jpg:`${n}img/products/i_1_1x.jpg`,webp:`${n}img/products/i_1_1x.webp`},i2:{jpg:`${n}img/products/i_2_1x.jpg`,webp:`${n}img/products/i_2_1x.webp`},i3:{jpg:`${n}img/products/i_3_1x.jpg`,webp:`${n}img/products/i_3_1x.webp`},i4:{jpg:`${n}img/products/i_4_1x.jpg`,webp:`${n}img/products/i_4_1x.webp`},i5:{jpg:`${n}img/products/i_5_1x.jpg`,webp:`${n}img/products/i_5_1x.webp`},i6:{jpg:`${n}img/products/i_6_1x.jpg`,webp:`${n}img/products/i_6_1x.webp`},i7:{jpg:`${n}img/products/i_7_1x.jpg`,webp:`${n}img/products/i_7_1x.webp`},i8:{jpg:`${n}img/products/i_8_1x.jpg`,webp:`${n}img/products/i_8_1x.webp`},i9:{jpg:`${n}img/products/i_9_1x.jpg`,webp:`${n}img/products/i_9_1x.webp`}},l=[{id:"getting-started",title:"Start Guide",content:{text:`Please be aware that this tutorial does not apply to K36 devices or clones marketed as R36S. For additional information about your hardware, please refer to the comprehensive R36S Wiki Page.
...
• A quick press of the power button will put the device into standby mode.`,images:{jpg:e.i9.jpg,webp:e.i9.webp}}},{id:"downloads",title:"Available Downloads",content:{downloads:[{file:"Firmware v1.0.4 2024.04.13",link:"https://drive.google.com/file/d/10z7j7IZ7WX3y10ZJBW_a2-agcIe1Dx9m/edit",date:"2024.04.13",version:"v1.0.4"},{file:"ArkOS_K36_v2.0_03112025.img.xz",link:"https://drive.google.com/file/d/1F93Q1jXYaTCftOlzAt0BaM43rmVexXsn/view",date:"2023.12.22",version:"v1.0.3"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P3.img.xz",link:"https://drive.google.com/file/d/18VL7uLNdyFKDH4_V8YM5zhHSjLiJdkUc/view",date:"2023.11.16",version:"v1.0.2"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P4.img.xz",link:"https://drive.google.com/file/d/1MT1AGGch6Ou4RAfxDvVCxUI4aXX6Qa5v/view",date:"2023.11.05",version:"v1.0.0"}]}}];let o="downloads",s=!1;const c=document.getElementById("products-nav-list"),m=document.getElementById("products-sections"),d=document.getElementById("products-nav");function g(){s=window.innerWidth<=1024,d&&(s?d.classList.add("nav-mobile"):d.classList.remove("nav-mobile"))}function w(a){o=a,document.querySelectorAll(".nav-item").forEach(t=>{t.dataset.sectionId===a?t.classList.add("nav-item-active"):t.classList.remove("nav-item-active")}),document.querySelectorAll(".section").forEach(t=>{t.id===a?t.classList.add("section-active"):t.classList.remove("section-active")}),setTimeout(()=>{const t=document.getElementById(a);if(t){const u=s?80:20,_=t.getBoundingClientRect().top+window.pageYOffset-u;window.scrollTo({top:_,behavior:"smooth"})}},100)}function y(){c.innerHTML="",l.forEach(a=>{const r=document.createElement("button");r.className=`nav-item ${o===a.id?"nav-item-active":""}`,r.dataset.sectionId=a.id,r.innerHTML=`
        ...
        <span>${a.title}</span>
      `,r.addEventListener("click",()=>w(a.id)),c.appendChild(r)})}function b(a){if(a.id==="downloads"){let t='<div class="download-list">';return a.content.downloads.forEach(u=>{t+=`
...
`).forEach(f=>{r+=`<p>${f.trim()}</p>`}),r+="</div>",t.content.images&&(r+=`
            <div class="image-container">
              <picture>
