import{i as E}from"./assets/vendor-C77IuWVK.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();function Q(){console.log("Инициализация кнопки прокрутки вверх и селектора языка");const e={en:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30">
        ...
        </svg>`},o=["en","ru","ar","be","de","es","fr","it","ja","ko","nl","pt","tr","uk"],t={en:"English",ru:"Русский",ar:"العربية",be:"Беларуская",de:"Deutsch",es:"Español",fr:"Français",it:"Italiano",ja:"日本語",ko:"한국어",nl:"Nederlands",pt:"Português",tr:"Türkçe",uk:"Українська"},n=document.createElement("div");n.className="corner-buttons-container";const s=document.createElement("div");s.className="language-selector",s.id="corner-language-selector";const r=document.createElement("button");r.className="language-button",r.setAttribute("aria-label","Выбрать язык");const d=document.createElement("div");d.className="language-button__flag",d.id="current-language-flag";const h=document.createElement("div");h.className="language-dropdown",h.id="language-dropdown";const l=document.createElement("button");l.className="scroll-to-top",l.setAttribute("aria-label","Прокрутить вверх страницы"),l.innerHTML=`
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <polyline points="18 15 12 9 6 15"></polyline>
    </svg>
  `,r.appendChild(d),s.appendChild(r),s.appendChild(h),n.appendChild(s),n.appendChild(l),document.body.appendChild(n),b();function g(f,p){let c;return function(){const a=arguments,m=this;c||(f.apply(m,a),c=!0,setTimeout(()=>c=!1,p))}}const w=g(function(){(window.pageYOffset||document.documentElement.scrollTop)>300?l.classList.add("visible"):l.classList.remove("visible")},100);function y(f){f.preventDefault(),l.classList.add("active"),setTimeout(()=>{l.classList.remove("active")},200),window.scrollTo({top:0,behavior:"smooth"})}function b(){try{let c=function(m){d.innerHTML=e[m]||""},a=function(){h.innerHTML="",o.forEach(m=>{const i=document.createElement("div");i.className=`language-dropdown__item ${m===p?"active":""}`,i.dataset.lang=m;const u=document.createElement("div");u.className="language-dropdown__flag",u.innerHTML=e[m]||"";const v=document.createElement("div");v.className="language-dropdown__name",v.textContent=t[m]||m,i.appendChild(u),i.appendChild(v),h.appendChild(i),i.addEventListener("click",()=>{f&&(f.value=m,f.dispatchEvent(new Event("change"))),s.classList.remove("active"),document.querySelectorAll(".language-dropdown__item").forEach(x=>{x.classList.toggle("active",x.dataset.lang===m)}),c(m)})})},f=document.getElementById("language-selector");f||(f=document.createElement("select"),f.id="language-selector",f.style.display="none",document.body.appendChild(f),o.forEach(m=>{const i=document.createElement("option");i.value=m,i.textContent=t[m]||m,f.appendChild(i)}));const p=localStorage.getItem("userLanguage")||"en";f&&(f.value=p),c(p),a(),r.addEventListener("click",function(m){m.preventDefault(),m.stopPropagation(),s.classList.toggle("active")}),document.addEventListener("click",m=>{s.contains(m.target)||s.classList.remove("active")}),window.addEventListener("languageChanged",m=>{m.detail&&m.detail.language&&(c(m.detail.language),document.querySelectorAll(".language-dropdown__item").forEach(i=>{i.classList.toggle("active",i.dataset.lang===m.detail.language)}))})}catch(f){console.error("Ошибка при инициализации селектора языка:",f)}}return window.addEventListener("scroll",w,{passive:!0}),l.addEventListener("click",y),w(),function(){console.log("Очистка кнопки прокрутки вверх и селектора языка"),window.removeEventListener("scroll",w),l.removeEventListener("click",y),r.removeEventListener("click",()=>{}),document.querySelectorAll(".language-dropdown__item").forEach(p=>{p.removeEventListener("click",()=>{})}),n&&n.parentNode&&n.parentNode.removeChild(n)}}function X(e,o){try{const t=sessionStorage.getItem("detectedBrowserLanguage");if(t&&e.includes(t))return console.log("Using cached browser language detection:",t),t;if(!Array.isArray(e)||e.length===0)return console.warn("Invalid supportedLanguages array, using default language"),o;console.log("Detecting user language with:",{supportedLanguages:e,defaultLanguage:o});const n=h=>{if(!h)return!1;const l=h.split("-")[0].toLowerCase();return e.includes(l)?l:null},s=localStorage.getItem("userLanguage");console.log("Saved language in localStorage:",s);const r=s&&s.trim()!==""&&n(s);if(r)return console.log("Using saved language preference:",r),r;let d=[];navigator.languages&&navigator.languages.length?d=[...navigator.languages]:navigator.language?d=[navigator.language]:navigator.userLanguage?d=[navigator.userLanguage]:navigator.browserLanguage?d=[navigator.browserLanguage]:navigator.systemLanguage&&(d=[navigator.systemLanguage]),console.log("Browser language preferences:",d);for(const h of d){const l=n(h);if(l)return console.log("Found supported browser language:",l),sessionStorage.setItem("detectedBrowserLanguage",l),l}return console.log("No matching language found, using default:",o),o}catch(t){return console.error("Error in detectUserLanguage:",t),console.error("Stack trace:",t.stack),o}}function z(e){try{if(!Array.isArray(e)||e.length===0)return console.warn("Invalid supportedLanguages array passed to getLanguageFromURL"),null;const o=window.location.pathname,t="/R36S_CONSOLE_STORE_JS/";if(console.log("Current path for language detection:",o),console.log("Base URL for language detection:",t),!o||o==="/")return console.log("Empty path, no language prefix"),null;let n=o;t!=="/"&&o.startsWith(t)&&(n=o.substring(t.length)||"/"),console.log("Path without base for language detection:",n);const s=n.split("/").filter(r=>r.trim()!=="");if(console.log("Path parts for language detection:",s),s.length>0){const r=s[0].toLowerCase();if(e.includes(r))return console.log(`Found language in URL: ${r}`),r}return null}catch(o){return console.error("Error getting language from URL:",o),null}}function W(e){try{if(!e){console.warn("No language provided to updateLanguageURL");return}if(typeof e!="string"||e.trim()===""){console.warn("Invalid language value provided to updateLanguageURL");return}if(z(["en","ru","ar","be","de","es","fr","it","ja","ko","nl","pt","tr","uk"])===e){console.log("URL already has the correct language prefix, no update needed");return}console.log("Current localStorage userLanguage before URL update:",localStorage.getItem("userLanguage")),console.log("Before language URL update, current URL:",window.location.href),console.log("Updating URL for language:",e);try{if(e==="en"){const h="/R36S_CONSOLE_STORE_JS/";console.log(`Updating URL to base URL for English: ${h}`),window.history.pushState({},"",h);return}const n=new URL(window.location.href).pathname;if(n.includes(".")&&!n.endsWith("index.html")){console.log("Skipping URL update for resource file");return}const s="/R36S_CONSOLE_STORE_JS/";let d=`${s.endsWith("/")?s:s+"/"}${e}/`;if(console.log("New path with language:",d),d===n){console.log("No URL change needed, paths are identical");return}window.history.pushState({},"",d),console.log("URL updated successfully")}catch(t){console.error("Error updating URL with language:",t)}}catch(o){console.error("Error updating URL with language:",o)}}const I={},M=e=>{try{const t=`${E.language}_${e}`;if(I[t])return I[t];let n=E.t(`hero.pricing.${e}`,{defaultValue:null});return n||(e==="current"?n="$35.48 US":e==="original"?n="US $108.06":e==="discount"&&(n="-68%")),I[t]=n,n}catch(o){return console.error("Error in getLocalizedPrice:",o),""}},N=()=>{for(const e in I)delete I[e]},F={},T=["en","ru","ar","be","de","es","fr","it","ja","ko","nl","pt","tr","uk"],ee={en:"English",ru:"Русский",ar:"العربية",be:"Беларуская",de:"Deutsch",es:"Español",fr:"Français",it:"Italiano",ja:"日本語",ko:"한국어",nl:"Nederlands",pt:"Português",tr:"Türkçe",uk:"Українська"},O=["header","hero","mobilemenu"],te="languageChanged",oe=(e,o)=>`/R36S_CONSOLE_STORE_JS/locales/${e}/${o}.json`,$=async(e,o)=>{const t=`${e}_${o}`;if(F[t])return F[t];try{const n=oe(e,o);console.log(`Загрузка перевода: ${n}`);const s=await fetch(n,{cache:"no-store",headers:{"Cache-Control":"no-cache"}});if(!s.ok)return console.warn(`Не удалось загрузить перевод ${e}/${o}: ${s.status}`),e!=="en"?(console.log(`Пробуем загрузить запасной перевод (en) для ${o}`),$("en",o)):{};const r=await s.json();return F[t]=r,r}catch(n){return console.error(`Ошибка загрузки ${e}/${o} переводов:`,n),e!=="en"?(console.log(`Пробуем загрузить запасной перевод (en) для ${o} после ошибки`),$("en",o)):{}}},j=async e=>{try{const o=await Promise.allSettled(O.map(n=>$(e,n))),t={};return o.forEach((n,s)=>{if(n.status==="fulfilled"){const r=n.value,d=O[s];t[d]=r}else console.warn(`Не удалось загрузить секцию: ${O[s]}`)}),t}catch(o){return console.error(`Ошибка загрузки переводов для ${e}:`,o),{}}},ne=()=>{try{document.querySelectorAll("[data-i18n]").forEach(e=>{const o=e.getAttribute("data-i18n");if(o)if(o.startsWith("[")){const t=o.match(/^\[(.*)\](.*)$/);if(t){const[,n,s]=t,r=E.t(s);r&&r!==s&&e.setAttribute(n,r)}}else{const t=E.t(o);t&&t!==o?e.hasAttribute("content")?e.setAttribute("content",t):(!e.dataset.originalText&&E.language!=="en"&&(e.dataset.originalText=e.textContent),e.textContent=t):e.dataset.originalText&&E.language==="en"&&(e.textContent=e.dataset.originalText)}})}catch(e){console.error("Ошибка обновления текстовых элементов:",e)}},ie=()=>{try{const e=["ar"];document.documentElement.dir=e.includes(E.language)?"rtl":"ltr",document.documentElement.setAttribute("lang",E.language)}catch(e){console.error("Ошибка обновления поддержки RTL:",e)}},q=async()=>{try{ne(),ie(),window.dispatchEvent(new CustomEvent(te,{detail:{language:E.language}}))}catch(e){console.error("Ошибка в updateAllContent:",e)}};async function re(e={}){try{console.log("Setting up i18n with options:",e),console.log("Current localStorage userLanguage:",localStorage.getItem("userLanguage")),console.log("Current BASE_URL:","/R36S_CONSOLE_STORE_JS/");const{forcedLanguage:o}=e,t=localStorage.getItem("userLanguage"),n=t&&T.includes(t),s=o||(n?t:null)||X(T,"en");console.log("Selected user language:",s);const r=await j(s);console.log(`Загруженные переводы для ${s}:`,r);const d=s!=="en"?await j("en"):null,h={[s]:{translation:r}};return d&&(h.en={translation:d}),await E.init({lng:s,fallbackLng:"en",resources:h,interpolation:{escapeValue:!1},debug:!0,load:"languageOnly",returnNull:!1,returnEmptyString:!1,saveMissing:!1,keySeparator:".",nsSeparator:":",missingKeyHandler:(l,g,w,y)=>{console.warn(`Отсутствует ключ перевода: ${w} для языка ${l} в пространстве ${g}. Используется HTML-текст.`)},parseMissingKeyHandler:l=>null}),localStorage.setItem("userLanguage",s),E.on("languageChanged",l=>{console.log("Language changed to:",l),localStorage.setItem("userLanguage",l),W(l),typeof N=="function"&&N(),q()}),window.updateContent=q,await q(),E}catch(o){throw console.error("Error in setupI18n:",o),o}}function se(){const e=document.getElementById("language-selector");if(e)try{if(e.childElementCount===0){const o=document.createDocumentFragment();T.forEach(t=>{const n=document.createElement("option");n.value=t,n.textContent=ee[t]||t,o.appendChild(n)}),e.appendChild(o)}e.value=E.language,e.addEventListener("change",async function(o){o.preventDefault();try{const t=o.target.value;if(console.log(`Language selector changed to: ${t}`),!document.contains(e)){console.log("Language selector no longer in DOM, aborting");return}if(!E.hasResourceBundle(t,"translation")){const n=await j(t);if(!document.contains(e)){console.log("Language selector no longer in DOM after loading translations, aborting");return}E.addResourceBundle(t,"translation",n,!0,!0)}localStorage.setItem("userLanguage",t),await E.changeLanguage(t),W(t),typeof window.updateContent=="function"&&window.updateContent()}catch(t){console.error("Error changing language:",t),e.value=E.language}})}catch(o){console.error("Error setting up language selector:",o)}}function ae(){let e=!1,o=window.scrollY,t=null;const n=document.querySelector(".header"),s=document.querySelector(".burger-btn"),r=document.querySelector(".burger-line"),d=document.querySelector(".mobile-menu"),h=document.querySelectorAll(".our-menu-link, .mobile-menu__link");function l(){const a=window.scrollY,m=o<a;t&&clearTimeout(t),a>100?b(!m):b(!0),o=a,y(a>0),t=setTimeout(()=>{},150)}function g(){e=!e,w()}function w(){e?(n.classList.add("menu-open"),s.setAttribute("aria-expanded","true"),r.classList.add("open"),d.classList.add("open"),document.body.style.overflow="hidden"):(n.classList.remove("menu-open"),s.setAttribute("aria-expanded","false"),r.classList.remove("open"),d.classList.remove("open"),document.body.style.overflow="unset")}function y(a){a?n.classList.add("scrolled"):n.classList.remove("scrolled")}function b(a){a?(n.classList.add("visible"),n.classList.remove("hidden")):(n.classList.add("hidden"),n.classList.remove("visible"))}function f(a){a.preventDefault();const m=a.currentTarget.getAttribute("href"),i=m.replace("#",""),u=document.getElementById(i);u&&(b(!0),setTimeout(()=>{n.offsetHeight;const x=u.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:x,behavior:"smooth"}),e&&(e=!1,w()),window.history.replaceState(null,"",`${window.location.pathname}${m}`),setTimeout(()=>{o=window.scrollY},100)},50))}function p(){if(window.location.hash){const a=window.location.hash.replace("#",""),m=document.getElementById(a);m&&setTimeout(()=>{const i=n.offsetHeight,v=m.getBoundingClientRect().top+window.scrollY-i;window.scrollTo({top:v,behavior:"smooth"})},100)}}function c(a){var u;const m=["ar"],i=((u=a==null?void 0:a.detail)==null?void 0:u.language)||E.language;m.includes(i)?n.classList.add("rtl"):n.classList.remove("rtl"),console.log("Language changed in header to:",i)}return window.addEventListener("scroll",l),window.addEventListener("resize",()=>{!(window.innerWidth<=768)&&e&&(e=!1,w())}),window.addEventListener("languageChanged",c),s&&s.addEventListener("click",g),h.forEach(a=>{a.addEventListener("click",f)}),p(),c(),function(){window.removeEventListener("scroll",l),window.removeEventListener("languageChanged",c),window.removeEventListener("resize",()=>{}),s&&s.removeEventListener("click",g),h.forEach(m=>{m.removeEventListener("click",f)})}}function le(){const e=document.querySelector(".mobile-menu");if(!e){console.error("Мобильное меню не найдено в DOM");return}const o=e.querySelector(".close-button");if(!o){console.error("Кнопка закрытия не найдена в мобильном меню");return}o.addEventListener("click",()=>{t()});function t(){e.classList.remove("open");const h=document.querySelector(".burger-line");h&&h.classList.remove("open"),document.body.style.overflow="unset";const l=document.querySelector(".header");l&&l.classList.remove("menu-open");const g=document.querySelector(".burger-btn");g&&g.setAttribute("aria-expanded","false")}const n=e.querySelectorAll(".mobile-menu__link");n.forEach(h=>{h.addEventListener("click",()=>{setTimeout(()=>{t()},150)})});const s=e.querySelector(".mobile-menu__background");s&&s.addEventListener("click",()=>{t()});function r(){e.querySelectorAll(".mobile-menu__icon").forEach((l,g)=>{l.style.opacity="0",l.style.transform="translateX(-20px)",new MutationObserver(y=>{y.forEach(b=>{b.attributeName==="class"&&(e.classList.contains("open")?setTimeout(()=>{l.style.transition="all 0.4s ease",l.style.opacity="1",l.style.transform="translateX(0)"},100+g*70):(l.style.opacity="0",l.style.transform="translateX(-20px)"))})}).observe(e,{attributes:!0})})}function d(h){var w;const l=["ar"],g=((w=h==null?void 0:h.detail)==null?void 0:w.language)||E.language;l.includes(g)?e.classList.add("rtl"):e.classList.remove("rtl"),console.log("Language changed in mobile menu to:",g)}return window.addEventListener("languageChanged",d),r(),d(),console.log("Мобильное меню с иконками инициализировано"),function(){o&&o.removeEventListener("click",t),n.forEach(l=>{l.removeEventListener("click",()=>{})}),s&&s.removeEventListener("click",t),window.removeEventListener("languageChanged",d)}}function ce(){const e=document.querySelector(".hero"),o=document.querySelector(".hero__console-img"),t=document.querySelector(".hero__content"),n=document.querySelector(".hero__description--desktop"),s=document.querySelector(".hero__description--mobile");document.querySelector(".hero__pricing");const r=document.getElementById("buy-button"),d=document.getElementById("more-details-button"),h=document.querySelector(".hero__current-price"),l=document.querySelector(".hero__original-price"),g=document.querySelector(".hero__discount-badge");let w=null,y,b;function f(){try{if(h){const S=M("current");S&&(h.innerHTML=S)}if(l){const S=M("original");S&&(l.textContent=S)}if(g){const S=M("discount");S&&(g.textContent=S)}}catch(S){console.error("Ошибка при обновлении цен:",S)}}function p(){!o||!e||(o.onload=()=>e.classList.add("hero--loaded"),o.onerror=()=>{console.error("Не удалось загрузить изображение:",o.src),e.classList.add("hero--loaded")},o.complete&&e.classList.add("hero--loaded"))}function c(){if(!n||!s)return;const S=window.innerWidth>992;n.style.display=S?"block":"none",s.style.display=S?"none":"block"}function a(){t&&(w&&(w.disconnect(),w=null),w=new IntersectionObserver(S=>{S.forEach(_=>{var C;_.isIntersecting&&((C=_.target)!=null&&C.isConnected)&&(_.target.classList.add("animate-in"),w==null||w.unobserve(_.target))})},{threshold:.1}),t.isConnected&&w.observe(t))}function m(){r&&r.addEventListener("click",u),d&&d.addEventListener("click",v)}function i(){b=S=>{console.log("Hero секция получила событие изменения языка:",S.detail),f()},window.addEventListener("languageChanged",b)}function u(){window.open("https://www.aliexpress.com/item/1005007171465465.html","_blank","noopener,noreferrer")}function v(S){S.preventDefault();const _=document.getElementById("features");if(!_){window.location.hash="features";return}const R=_.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:R,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features`)}function x(){w&&w.disconnect(),clearTimeout(y),window.removeEventListener("resize",k),b&&window.removeEventListener("languageChanged",b),r&&r.removeEventListener("click",u),d&&d.removeEventListener("click",v)}function k(){clearTimeout(y),y=setTimeout(c,200)}return p(),c(),a(),m(),i(),f(),window.addEventListener("resize",k),x}function de(e){let o=null,t=null,n=!1,s=0,r=null;(()=>{document.getElementById("modal-about-styles")||console.log("Проверка стилей модального окна")})();function h(a){a.key==="Escape"&&n&&p()}function l(){const a=document.createElement("div");return a.className="modal-about-overlay",a.setAttribute("role","dialog"),a.setAttribute("aria-modal","true"),a.setAttribute("tabindex","-1"),a.style.display="none",a.addEventListener("click",p),e.appendChild(a),a}function g(){return t?t.title==="Extensive color selection"&&t.colorImages?`
      <img
        src="${t.colorImages[s]}"
  ...
  `:""}function w(){(t==null?void 0:t.title)==="Extensive color selection"&&t.colorImages&&(r&&clearInterval(r),r=setInterval(()=>{s=s===t.colorImages.length-1?0:s+1;const a=o.querySelector(".modal-about-image");a&&(a.src=t.colorImages[s],a.alt=`R36S Color Variant ${s+1}`)},1e3))}function y(){if(!o||!t)return;const a={"@context":"https://schema.org","@type":"ItemPage",mainEntity:{"@type":"Product",name:"R36S Handheld Game Console",description:t.fullDescription,image:t.imageUrl||(t.colorImages?t.colorImages[0]:""),offers:{"@type":"Offer",price:"35.48",priceCurrency:"USD",url:"https://www.aliexpress.com/item/1005007171465465.html"},category:"Video Game Console",feature:t.title}};t.id===1&&(a.mainEntity.faqPage={"@type":"FAQPage",mainEntity:[{"@type":"Question",name:"How many games are included in the R36S console?",acceptedAnswer:{"@type":"Answer",text:"The R36S console includes over 15,000 classic retro games from various platforms."}}]});const m=`
...
• Quick startup for instant gaming access`,videoUrl:me,imageAlt:"R36S Portability"}];function r(){console.log("Начинаем рендеринг карточек..."),e.innerHTML="";const p=s.map(a=>`
    ...
    `).join("");e.innerHTML=p;const c=e.querySelectorAll(".about-card");console.log(`Отрендерено ${c.length} карточек из ${s.length} необходимых`),c.length!==s.length?console.warn(`Ошибка рендеринга: отрендерено ${c.length} карточек вместо ${s.length}`):console.log("Рендеринг карточек успешно завершен")}const d=h(function(p){if(!p||!p.currentTarget)return;const c=p.currentTarget;if(!c||!c.getBoundingClientRect){console.warn("handleMouseMove: элемент карточки не существует или недоступен");return}try{const a=c.getBoundingClientRect();o={x:p.clientX-a.left,y:p.clientY-a.top},c.style.setProperty("--mouse-x",`${o.x}px`),c.style.setProperty("--mouse-y",`${o.y}px`)}catch(a){console.error("Ошибка при обработке движения мыши:",a)}},16);function h(p,c){let a,m;return function(){const i=this,u=arguments;m?(clearTimeout(a),a=setTimeout(function(){Date.now()-m>=c&&(p.apply(i,u),m=Date.now())},c-(Date.now()-m))):(p.apply(i,u),m=Date.now())}}function l(p){if(!p||!p.currentTarget){console.warn("handleButtonClick: событие или цель события не существует");return}p.stopPropagation();try{const c=parseInt(p.currentTarget.dataset.featureId);console.log("Клик по кнопке карточки ID:",c);const a=s.find(m=>m.id===c);if(!a){console.error("Данные для карточки не найдены");return}t&&t.open(a)}catch(c){console.error("Ошибка при обработке клика по кнопке:",c)}}function g(p,c){let a;return function(){const m=this,i=arguments;clearTimeout(a),a=setTimeout(()=>{p.apply(m,i)},c)}}function w(){console.log("Очистка обработчиков событий карточек...");try{const p=document.querySelectorAll(".about-card");p&&p.length>0&&p.forEach(a=>{a&&(a.removeEventListener("mouseenter",()=>{}),a.removeEventListener("mouseleave",()=>{}),a.removeEventListener("mousemove",d))});const c=document.querySelectorAll(".about-card__button");c&&c.length>0&&c.forEach(a=>{a&&a.removeEventListener("click",l)}),e&&e.removeEventListener("click",()=>{}),console.log("Очистка обработчиков завершена")}catch(p){console.error("Ошибка при очистке обработчиков событий:",p)}}function y(){console.log("Настройка обработчиков событий для карточек...");const p=()=>{console.log("Проверяем наличие карточек для установки обработчиков...");const c=document.querySelectorAll(".about-card");if(!c||c.length===0){console.warn("Не найдены карточки для установки обработчиков событий"),setTimeout(p,200);return}console.log(`Устанавливаем обработчики событий для ${c.length} карточек`);const a=window.matchMedia("(max-width: 768px)").matches;!a&&e&&e.addEventListener("click",function(i){const u=i.target.closest(".about-card");if(u&&!i.target.closest(".about-card__button")){const v=parseInt(u.dataset.id);console.log("Клик по карточке ID:",v);const x=s.find(k=>k.id===v);if(!x){console.error("Данные для карточки не найдены");return}t&&t.open(x)}}),c.forEach(i=>{i&&(i.addEventListener("mouseenter",function(){i&&(parseInt(i.dataset.id),i.classList.add("active"))}),i.addEventListener("mouseleave",function(){i&&i.classList.remove("active")}),i.addEventListener("mousemove",d))});const m=document.querySelectorAll(".about-card__button");m&&m.length>0?(m.forEach(i=>{i&&i.addEventListener("click",l)}),console.log(`Установлены обработчики для ${m.length} кнопок`)):console.warn("Не найдены кнопки карточек"),window.addEventListener("resize",g(()=>{const i=!a,u=!window.matchMedia("(max-width: 768px)").matches;i!==u&&(w(),y())},250)),console.log("Настройка обработчиков событий успешно завершена")};document.readyState==="complete"||document.readyState==="interactive"?setTimeout(p,10):document.addEventListener("DOMContentLoaded",p)}function b(){console.log("Очистка всех обработчиков событий..."),w(),window.removeEventListener("resize",g),t=null,console.log("Очистка обработчиков событий завершена")}function f(){return function(){console.log("Запуск функции очистки секции About"),b()}}try{return console.log("Начинаем инициализацию секции About..."),console.log("Рендерим карточки..."),r(),console.log("Устанавливаем обработчики событий..."),y(),console.log("Инициализация About завершена успешно"),f()}catch(p){return console.error("Ошибка при инициализации About:",p),null}}function we(){const e=document.getElementById("features"),o=document.getElementById("featuresVideo"),t=document.getElementById("soundToggleButton"),n=document.getElementById("volumeOffIcon"),s=document.getElementById("volumeOnIcon"),r=document.getElementById("buyButton"),d=document.getElementById("moreInfoButton");if(!e){console.warn("Features section not found");return}o&&(o.volume=.5,o.play().catch(l=>{console.log("Автовоспроизведение не удалось:",l)})),r&&r.addEventListener("click",U),d&&d.addEventListener("click",H),t&&t.addEventListener("click",()=>P(o,n,s));const h=()=>{ve(e,o,n,s)};return window.addEventListener("scroll",h),function(){r&&r.removeEventListener("click",U),d&&d.removeEventListener("click",H),t&&t.removeEventListener("click",()=>P(o,n,s)),window.removeEventListener("scroll",h),console.log("Features component cleaned up")}}function P(e,o,t){if(e)if(e.muted=!e.muted,e.muted){o.style.display="block",t.style.display="none";const n=document.getElementById("soundToggleButton");n&&n.setAttribute("aria-label","Включить звук")}else{e.volume=.5,o.style.display="none",t.style.display="block";const n=document.getElementById("soundToggleButton");n&&n.setAttribute("aria-label","Выключить звук")}}function ve(e,o,t,n){if(!e||!o||o.muted)return;const s=e.getBoundingClientRect();if(!(s.top<window.innerHeight&&s.bottom>0)){o.muted=!0,t.style.display="block",n.style.display="none";const d=document.getElementById("soundToggleButton");d&&d.setAttribute("aria-label","Включить звук")}}function U(){window.open("https://www.aliexpress.com/item/1005007171465465.html?spm=a2g0o.store_pc_home.0.0.70583a88IDCuNJ&pdp_npi=4%40dis%21UAH%214%C2%A0485%2C21%20%D0%B3%D1%80%D0%BD.%211%C2%A0472%2C53%20%D0%B3%D1%80%D0%BD.%21%21%21767.45%21251.96%21%40211b498b17390151033607761d21d7%2112000039694115852%21sh%21UA%211927913003%21X","_blank","noopener,noreferrer")}function H(){const e=document.getElementById("features-r36s");if(e){const o=e.getBoundingClientRect().top,t=window.scrollY||window.pageYOffset,n=o+t;window.scrollTo({top:n,behavior:"smooth"}),window.history.replaceState(null,"",`${window.location.pathname}#features-r36s`)}}function ye(){try{let p=function(){n&&(n.innerHTML=g?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},c=function(){s&&(s.innerHTML=w?`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
           ...
           </svg>`)},a=function(){if(!(!e||b))if(g)e.pause(),g=!1,p();else{const i=e.play();i!==void 0?i.then(()=>{g=!0,p()}).catch(u=>{console.warn("Не удалось воспроизвести видео:",u),g=!1,p()}):(g=!0,p())}},m=function(){d&&(b=!0,e&&(e.style.display="none"),d.innerHTML=`
      ...
      `)};console.log("Инициализация секции Categories");const e=document.querySelector(".categories__video"),o=document.getElementById("categories"),t=document.querySelector(".categories__content"),n=document.querySelector(".categories__video-play"),s=document.querySelector(".categories__video-mute"),r=document.querySelector(".categories__video-slider"),d=document.querySelector(".categories__video-container"),h=document.querySelector(".categories__video-time span:first-child"),l=document.querySelector(".categories__video-time span:last-child");if(!o)return console.error("Секция Categories не найдена в DOM"),{};if(t&&t.classList.add("animate-in"),!e)return console.error("Видео элемент не найден в DOM"),m(),{};let g=!1,w=!0,y=!1,b=!1;const f=i=>{if(isNaN(i)||i<0)return"0:00";const u=Math.floor(i/60),v=Math.floor(i%60);return`${u}:${v.toString().padStart(2,"0")}`};return e&&(e.muted=!0,e.loop=!0,e.playsInline=!0,e.style.display="block",e.style.visibility="visible",e.style.opacity="1",e.style.width="100%",e.style.borderRadius="24px",d&&(d.style.minHeight="200px"),e.addEventListener("loadedmetadata",()=>{try{console.log("Метаданные видео загружены"),y=!0,r&&!isNaN(e.duration)&&(r.max=e.duration,l&&(l.textContent=f(e.duration)))}catch(i){console.error("Ошибка при обработке метаданных видео:",i)}}),e.addEventListener("timeupdate",()=>{try{r&&!isNaN(e.currentTime)&&(r.value=e.currentTime,h&&(h.textContent=f(e.currentTime)))}catch(i){console.error("Ошибка при обновлении времени видео:",i)}}),e.addEventListener("error",()=>{console.error("Ошибка при загрузке видео"),m()}),setTimeout(()=>{if(e&&!b){const i=e.play();i!==void 0&&i.then(()=>{console.log("Автовоспроизведение видео успешно"),g=!0,p()}).catch(u=>{console.warn("Не удалось автовоспроизвести видео:",u)})}},1e3)),n&&n.addEventListener("click",i=>{i.stopPropagation(),a()}),s&&s.addEventListener("click",i=>{i.stopPropagation(),e&&(w=!w,e.muted=w,c())}),r&&r.addEventListener("input",i=>{if(e)try{const u=parseFloat(i.target.value);isNaN(u)||(e.currentTime=u)}catch(u){console.error("Ошибка при изменении времени видео:",u)}}),d&&d.addEventListener("click",i=>{i.target.closest(".categories__video-controls")||a()}),p(),c(),o.classList.add("initialized"),{togglePlay:a,cleanup:()=>{e&&(e.pause(),e.removeAttribute("src"),e.load())}}}catch(e){console.error("Критическая ошибка в initCategories:",e);const o=document.getElementById("categories");return o&&(o.style.display="block"),{}}}function B(){const e=document.querySelectorAll(".accordion__item");if(e.length===0){console.warn("FAQ аккордеон: элементы не найдены");return}console.log(`FAQ аккордеон: найдено ${e.length} вопросов`);const o=(n=null)=>{e.forEach(s=>{s!==n&&s.classList.contains("active")&&s.classList.remove("active")})};e.forEach(n=>{const s=n.querySelector(".accordion__header"),r=n.querySelector(".accordion__toggle"),d=n.querySelector(".accordion__content");if(!s||!r||!d){console.warn("FAQ аккордеон: структура элемента неполная",n);return}n===e[0]&&setTimeout(()=>{r.classList.add("pulse"),setTimeout(()=>{r.classList.remove("pulse")},1500)},1e3);const h=y=>{if(y.preventDefault(),y.stopPropagation(),r.classList.add("clicked"),setTimeout(()=>r.classList.remove("clicked"),300),n.classList.contains("active")){n.classList.remove("active");return}o(n),n.classList.add("active");const b=s.getBoundingClientRect();b.top>=10&&b.bottom<=window.innerHeight-10||setTimeout(()=>{window.scrollTo({top:window.scrollY+b.top-100,behavior:"smooth"})},100)};s.addEventListener("click",h),r.addEventListener("click",y=>{y.stopPropagation(),h(y)});const l=`faq-question-${Math.random().toString(36).substring(2,9)}`,g=`faq-answer-${Math.random().toString(36).substring(2,9)}`;s.setAttribute("id",l),s.setAttribute("aria-expanded","false"),s.setAttribute("aria-controls",g),d.setAttribute("id",g),d.setAttribute("aria-labelledby",l),d.setAttribute("role","region"),d.setAttribute("hidden","true"),new MutationObserver(y=>{y.forEach(b=>{if(b.type==="attributes"&&b.attributeName==="class"){const f=n.classList.contains("active");s.setAttribute("aria-expanded",f?"true":"false"),f?d.removeAttribute("hidden"):setTimeout(()=>{n.classList.contains("active")||d.setAttribute("hidden","true")},500)}})}).observe(n,{attributes:!0})});const t=n=>{if(n.key==="Escape"){o();return}const s=document.activeElement.closest(".accordion__item");if(!s)return;const r=Array.from(e),d=r.indexOf(s);if(d===-1)return;let h;switch(n.key){case"ArrowDown":h=(d+1)%r.length;break;case"ArrowUp":h=(d-1+r.length)%r.length;break;case"Home":h=0;break;case"End":h=r.length-1;break;default:return}const l=r[h].querySelector(".accordion__header");l&&(l.focus(),n.preventDefault())};return document.addEventListener("keydown",t),console.log("FAQ аккордеон успешно инициализирован"),{openItem:n=>{n>=0&&n<e.length&&(o(e[n]),e[n].classList.add("active"))},closeAll:()=>o()}}typeof window<"u"&&(document.addEventListener("DOMContentLoaded",()=>{window.faqAccordeon=B()}),window.initFaqAccordion=B);function be(){const e=document.getElementById("articles");if(!e){console.warn("Секция Articles не найдена в DOM, пробуем найти с другим id");const r=document.querySelector(".articles")||document.querySelector('section[id^="articles"]')||document.querySelector("section.articles");if(!r){console.error("Не удалось найти секцию Articles в DOM никаким способом"),console.debug("Структура DOM:",document.body.innerHTML);return}r.id||(r.id="articles"),console.log("Найден альтернативный элемент для секции Articles:",r)}console.log("Инициализация секции Articles с SEO-оптимизацией");const o=[{id:1,title:"R36S Retro Gaming",sections:[{subtitle:"R36S: The Ultimate Handheld Gaming Console for Retro Gaming Enthusiasts",content:"Welcome to the official home of the <strong>R36S handheld gaming console</strong>. The R36S has quickly become the go-to device for retro gaming enthusiasts across the <em>United States</em>, <em>United Kingdom</em>, and <em>Australia</em>. This powerful portable gaming system offers an exceptional combination of performance, versatility, and value that puts other retro consoles to shame. Whether you're reliving childhood classics or discovering retro gems for the first time, the <mark>R36S console</mark> delivers an unmatched gaming experience. Many gamers compare the <span>R36S vs Anbernic</span> models and consistently find that the R36S offers superior features at a more competitive price point. Ready to elevate your portable gaming experience? The R36S is now available for purchase online with special promotional pricing for a limited time."},{subtitle:"Comprehensive R36S Review: Performance That Exceeds Expectations",content:'After extensive testing, our <strong>R36S review</strong> confirms what many gamers have discovered – this console punches well above its weight class. The <mark>R36S emulator performance</mark> is particularly impressive, handling everything from 8-bit classics to more demanding 32-bit titles with remarkable smoothness. Games load quickly and run without the lag or frame drops that plague lesser devices. The <strong>R36S specs</strong> include a powerful processor paired with ample RAM that ensures consistent performance across various emulation platforms. What truly sets the R36S console apart in our review is its ability to handle multiple emulation systems without compromising on quality. Unlike competitors in the same price range, the R36S maintains excellent performance even with graphically intensive games. Players across <em>North America</em> and <em>Europe</em> have shared <mark>R36S reviews</mark> praising its reliable performance during extended gaming sessions. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> to experience this exceptional performance firsthand at our special online price.'},{subtitle:"How to Install Games on R36S: Simple Setup for Maximum Fun",content:`Learning <strong>how to install ROMs on R36S</strong> is refreshingly straightforward. The console's user-friendly interface makes the process accessible even for those new to retro gaming handhelds. First, you'll need to format a microSD card (up to 512GB supported) using your computer. Then, download your preferred game files and organize them in folders corresponding to each console type. After inserting the card into your R36S, the built-in menu system automatically detects and categorizes your games for easy access. The <mark>R36S setup guide</mark> included with every purchase walks you through this process with clear, step-by-step instructions. Additionally, the R36S console supports various file formats, eliminating compatibility headaches common with other devices. Customers in <em>Canada</em>, <em>Australia</em>, and throughout <em>Europe</em> appreciate how the R36S simplifies the game installation process. Need more guidance? The complete <strong>R36S setup guide</strong> is available on our website, along with video tutorials. Don't miss our current sale price on the R36S – <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Now" target="_blank" rel="nofollow">order now</a> while supplies last!`},{subtitle:"R36S Specifications: Hardware That Delivers Premium Gaming Experience",content:"The impressive <strong>R36S specifications</strong> explain why this console has garnered such positive attention. At its heart, the R36S boasts a quad-core processor clocked at 1.5GHz, paired with 1GB of DDR3 RAM for smooth multitasking. The <mark>R36S screen resolution</mark> of 640x480 on its 3.5-inch IPS display delivers crisp visuals with excellent color reproduction and wide viewing angles. This display quality significantly enhances the gaming experience, particularly for pixel-art classics. The <strong>R36S battery life</strong> extends to an impressive 6-8 hours of continuous play on a single charge, with charging time of approximately 2-3 hours via the USB-C port. Storage options are flexible, with support for microSD cards up to 512GB, allowing an extensive game library. The <mark>R36S controller layout</mark> features a responsive D-pad, dual analog sticks, four action buttons, and shoulder triggers that provide precise control across different game genres. Available in multiple colors, the R36S is currently offered at a special promotional price in the <em>UK</em>, <em>USA</em>, and throughout <em>Asia</em>. Check our website for the current <strong>R36S price</strong> and available discount offers."},{subtitle:"Best Games for R36S: Thousands of Classics at Your Fingertips",content:`The <strong>R36S console</strong> truly shines when loaded with the best games that showcase its capabilities. The system excels at running 8-bit and 16-bit classics from Nintendo, Sega, and other iconic platforms with perfect emulation. More impressively, the R36S handles PlayStation 1 titles with remarkable fidelity, maintaining smooth framerates even in 3D games. Fighting game enthusiasts praise the <mark>R36S controller layout</mark> and responsive buttons, which make titles like Street Fighter and King of Fighters a joy to play. RPG fans can enjoy lengthy adventures like Final Fantasy and Chrono Trigger with the benefit of the extended <strong>R36S battery life</strong>. The console's excellent <mark>R36S sound quality</mark> and speakers deliver immersive audio, though many users opt for headphones for the full experience. The R36S firmware supports save states across all emulators, allowing you to pause and resume your progress at any time. Gamers in <em>Mexico</em>, <em>Brazil</em>, and across <em>South America</em> have particularly embraced the R36S for its extensive game compatibility. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Gaming Console" target="_blank" rel="nofollow">Order your R36S today</a> from our official online store to receive exclusive bonus content and take advantage of our current sale price.`},{subtitle:"A Unique Gaming Experience with R36S",content:`The <strong>R36S</strong> has garnered attention for its impressive gaming library, housing over 15,000 titles in the 64GB model and expanding to approximately 20,000 games in the 128GB version. This comprehensive collection spans across several iconic gaming platforms, including: <ul><li><strong>Nintendo Entertainment System (NES)</strong></li><li><strong>Super Nintendo Entertainment System (SNES)</strong></li><li><strong>Sega Genesis</strong></li><li><strong>PlayStation 1</strong></li><li><strong>Nintendo 64</strong></li><li><strong>Game Boy Advance</strong></li><li><strong>Nintendo DS</strong></li><li><strong>PlayStation Portable (PSP)</strong></li></ul><p>This extraordinary compilation allows enthusiasts to journey through the golden era of gaming across multiple legendary platforms, all within a single portable device.</p><p class="article__highlight"><strong>R36S Standout Gaming Experiences</strong><br>While the device offers thousands of nostalgic adventures, certain masterpieces particularly shine through:<ul><li><strong>Super Mario Bros.</strong> (NES): The revolutionary platformer that defined an entire genre and laid the groundwork for countless games to follow.</li><li><strong>The Legend of Zelda: A Link to the Past</strong> (SNES): A timeless adventure that masterfully combines puzzle-solving, exploration, and combat into an unforgettable experience.</li><li><strong>Sonic the Hedgehog</strong> (Sega Genesis): Sega's signature blue speedster that challenged Nintendo's dominance with its distinctive fast-paced gameplay.</li><li><strong>Final Fantasy VII</strong> (PlayStation 1): The groundbreaking RPG that transformed video game storytelling with its complex characters and emotional narrative.</li><li><strong>Super Mario 64</strong> (Nintendo 64): The trailblazing 3D platformer that revolutionized how players interact with virtual worlds.</li><li><strong>Pokémon FireRed</strong> (Game Boy Advance): The beloved reimagining of the original Pokémon Red, enhanced with additional features and improved graphics.</li><li><strong>Mario Kart DS</strong> (Nintendo DS): An exhilarating racing experience offering endless entertainment through its inventive tracks and competitive multiplayer.</li><li><strong>God of War: Chains of Olympus</strong> (PSP): An action-packed epic showcasing the impressive capabilities of Sony's handheld console.</li></ul>These highlighted gems represent merely a glimpse into the vast array of quality titles available on the <mark>R36S</mark>, catering to diverse gaming preferences from casual play to hardcore challenges.</p>`},{subtitle:"R36S Firmware Update Guide: Keeping Your Console at Peak Performance",content:`Maintaining the latest <strong>R36S firmware</strong> ensures you'll enjoy optimal performance and access to the newest features. The <mark>R36S firmware update</mark> process is straightforward and user-friendly. Begin by downloading the latest firmware package from our official website. Then, place the file in the root directory of your microSD card. After inserting the card into your powered-off R36S, hold the select button while powering on the device to enter update mode. The console will automatically detect and install the new firmware, typically completing in 2-3 minutes. Each <strong>R36S firmware update</strong> brings performance optimizations, new emulators, and interface improvements. Following the update, the <mark>R36S user manual</mark> recommends recalibrating your controls for the best gaming experience. Our technical support team, available to customers worldwide including <em>Japan</em>, <em>South Korea</em>, and across <em>Europe</em>, can assist with any firmware update questions. Subscribe to our newsletter for notifications about new R36S firmware releases and special offers on accessories. Don't miss our <a href="https://www.aliexpress.com/item/1005007171465465.html" title="R36S Limited Time Promotion" target="_blank" rel="nofollow">limited-time promotion</a> with discounted pricing on the R36S console and accessory bundles.`}]},{id:2,title:"R36S Official Website",sections:[{subtitle:"R36S Official Website - The Ultimate Gaming Experience at Your Fingertips",content:"Welcome to the <strong>R36S Official Website</strong>, your premier destination for cutting-edge handheld gaming technology. Our revolutionary gaming console has transformed the portable gaming landscape, offering unprecedented performance in a sleek, ergonomic design. The <mark>R36S</mark> combines powerful hardware with intuitive controls to deliver an immersive gaming experience wherever you go. Whether you're a casual gamer or a dedicated enthusiast, the <strong>R36S game console</strong> provides the perfect balance of power, portability, and playability. Discover why gamers across <em>North America</em>, <em>Europe</em>, and <em>Asia</em> are choosing the R36S as their preferred handheld gaming device. Continue reading to learn about our exclusive features, technical specifications, and why the R36S stands apart from other gaming consoles on the market today."},{subtitle:"Discover the Revolutionary R36S Handheld Gaming Experience",content:'The <strong>R36S handheld</strong> represents the next generation of portable gaming technology. Unlike conventional gaming devices, the R36S handheld features an advanced cooling system that prevents overheating during extended gaming sessions. Additionally, the vibrant high-resolution display ensures crystal-clear visuals even in bright outdoor conditions. Moreover, the <mark>R36S game console</mark> includes customizable controls that adapt to your unique gaming style. Furthermore, the lightweight yet durable construction makes the R36S perfect for gaming on the go. Meanwhile, the extended battery life keeps you playing for hours without interruption. Subsequently, the intuitive user interface makes navigating between games and settings effortless. In contrast to other portable systems, the <strong>R36S handheld</strong> offers exceptional value without compromising on quality. Consequently, gamers in the <em>United Kingdom</em>, <em>Australia</em>, and <em>Canada</em> can <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Online" target="_blank" rel="nofollow">order online</a> and experience the difference today. However, limited-time promotional pricing makes this the ideal time to purchase your R36S game console.'},{subtitle:"Unmatched Performance in the R36S Game Console",content:"The heart of the <strong>R36S game console</strong> lies in its powerful processing capabilities. Specifically, the custom-designed CPU and GPU combination delivers desktop-quality graphics in a handheld format. In particular, the advanced thermal management system prevents throttling during intensive gaming sessions. Similarly, the high-speed RAM ensures smooth multitasking between games and applications. Likewise, the expandable storage options allow you to carry your entire game library wherever you go. Certainly, the <mark>R36S handheld's</mark> performance metrics exceed industry standards in its price range. Nevertheless, the energy-efficient design maintains battery life without sacrificing processing power. Above all, the <strong>R36S game console's</strong> architecture supports both retro classics and modern gaming experiences. Therefore, gamers looking for performance and versatility consistently choose the R36S. Indeed, retailers across <em>Germany</em>, <em>France</em>, and <em>Japan</em> report steadily increasing demand for this innovative gaming device. Finally, manufacturer specifications confirm that the R36S outperforms competing handhelds costing significantly more."},{subtitle:"Enhanced Gaming Experience with the R36S Handheld's Exclusive Features",content:"The <strong>R36S handheld</strong> comes equipped with numerous exclusive features designed to enhance your gaming experience. First, the haptic feedback system provides immersive tactile responses that correspond with in-game actions. Second, the adjustable performance modes allow you to prioritize either graphical fidelity or battery conservation. Third, the integrated voice chat functionality eliminates the need for external communication devices. Fourth, the customizable RGB lighting adds a personal touch to your gaming setup. Fifth, the quick-resume feature lets you instantly return to your game after a break. Sixth, the dedicated streaming mode optimizes performance for content creators. Meanwhile, the brand's commitment to quality ensures each <mark>R36S game console</mark> meets rigorous standards before shipping. As a result, customers in <em>Spain</em>, <em>Italy</em>, and <em>South Korea</em> can shop confidently knowing they're receiving a premium product. Consequently, the history of the brand demonstrates consistent innovation in the gaming sector. Therefore, the manufacturer continues to support the R36S with regular firmware updates and expanded compatibility."},{subtitle:"Why Gamers Worldwide Choose the R36S Official Website for Their Gaming Needs",content:"The <strong>R36S Official Website</strong> offers distinct advantages for discerning gamers seeking the ultimate handheld experience. Primarily, exclusive online-only configurations provide enhanced specifications unavailable through retail channels. Additionally, direct purchases from the <mark>R36S Official Website</mark> include extended warranty coverage at no additional cost. Furthermore, members of the official online community gain early access to firmware updates and beta features. Moreover, the official online store frequently offers promotional pricing unavailable elsewhere. Consequently, the <strong>R36S game console</strong> purchased directly from the manufacturer includes premium accessories in standard packages. Subsequently, customers in <em>Brazil</em>, <em>Mexico</em>, and <em>India</em> benefit from regionalized payment options and shipping methods. Meanwhile, the brand's commitment to customer satisfaction has established a loyal following in competitive gaming circles. In essence, the <mark>R36S handheld</mark> represents not just a product but an entire ecosystem of gaming innovation. Therefore, visiting the <span>R36S Official Website</span> remains the optimal way to experience everything this revolutionary console offers. Indeed, the manufacturer's direct sales model ensures authenticity and full support for every purchased device."},{subtitle:"The Future of Gaming with the R36S Official Website and Upcoming Innovations",content:"The <strong>R36S Official Website</strong> stands as the definitive source for information about upcoming innovations in the R36S ecosystem. Primarily, the <mark>R36S game console's</mark> modular design allows for future hardware expansions without requiring a completely new device. Additionally, the development team is actively working on cloud gaming integration to further expand the available game library. Furthermore, the <strong>R36S handheld</strong> will soon support cross-platform multiplayer with major gaming systems. Moreover, announced accessories will enhance the versatility of the base R36S game console for specialized gaming genres. Consequently, early adopters of the R36S platform will benefit from a continuously evolving gaming experience. Subsequently, the price point remains competitive despite these substantial additions to functionality. Meanwhile, the brand continues to expand its presence in emerging markets including <em>Southeast Asia</em> and <em>Eastern Europe</em>. Therefore, the <mark>R36S handheld</mark> represents not just current gaming technology but a future-proof investment. In conclusion, whether you're looking to purchase your first R36S or upgrade from a previous model, the <span>R36S Official Website</span> offers the most comprehensive information and purchase options. Indeed, as the gaming landscape evolves, the <strong>R36S game console</strong> evolves with it, maintaining its position at the forefront of handheld gaming innovation."},{subtitle:"Why Choose the R36S: Value, Performance, and Community Support",content:`The <strong>R36S</strong> has established itself as the preferred choice for discerning retro gamers for several compelling reasons. When conducting an <span>R36S vs Anbernic comparison</span>, the R36S consistently offers better specifications at a more competitive price point. The <mark>R36S price</mark> and value for money is unmatched in the portable retro gaming market, delivering premium features without the premium cost. The <strong>R36S portable gaming console</strong> features extend beyond mere hardware specifications – the active community of users continues to develop custom firmware, game ports, and utilities that expand the system's capabilities. The <mark>R36S emulator performance</mark> receives regular optimizations through community contributions, ensuring that even the most demanding games run smoothly. The <strong>R36S handheld gaming console review</strong> scores consistently highlight the device's exceptional build quality, with a solid feel that withstands the rigors of portable gaming. Customers across <em>North America</em>, <em>Europe</em>, <em>Australia</em>, and <em>Asia</em> have made the R36S their go-to retro gaming solution. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Order R36S Official" target="_blank" rel="nofollow">Order your R36S today</a> from our official website to join this passionate community and take advantage of our current promotional pricing, exclusive bundles, and free worldwide shipping on orders over $100.`},{subtitle:"Welcome to the R36S Official Store",content:`Discover premium products at the <strong>R36S official store</strong>, your ultimate destination for authentic R36S merchandise. Our official store offers an extensive selection of cutting-edge devices designed to enhance your daily experience. Looking to buy <strong>R36S products</strong> at the best price? The <strong>R36S official store</strong> delivers exceptional value with regular promotions and sales events. <mark>Order online today</mark> and experience the convenience of worldwide shipping from the R36S official store. Our team is dedicated to providing superior customer service, ensuring your shopping experience exceeds expectations. Whether you're searching for the latest releases or popular bestsellers, the <strong>R36S official store</strong> has everything you need. Check out our current <span>special offers</span> and take advantage of exclusive deals available only at the R36S official store. With secure payment options and fast delivery, shopping at the <strong>R36S official store</strong> is both safe and convenient. Join thousands of satisfied customers who trust the R36S official store for authentic products and unmatched quality. Visit our website now or contact our support team to learn more about where to buy R36S products. The <strong>R36S official store</strong> ships to major regions including <em>North America</em>, <em>Europe</em>, <em>Asia</em>, and <em>Australia</em>, making our premium products accessible to customers worldwide. <a href="https://www.aliexpress.com/item/1005007171465465.html" title="Visit R36S Official Store" target="_blank" rel="nofollow">Shop at the R36S official store today</a> and experience the difference that quality products and exceptional service can make.`}]}],t=e.querySelector(".articles__grid");if(!t){console.error("Элемент .articles__grid не найден в секции Articles");return}(()=>{if(!document.querySelector('meta[name="description"]')){const r=document.createElement("meta");r.name="description",r.content="R36S - The Ultimate Handheld Gaming Console for Retro Gaming. Official website with specifications, reviews, and purchase options.",document.head.appendChild(r)}if(!document.querySelector('meta[name="keywords"]')){const r=document.createElement("meta");r.name="keywords",r.content="R36S, retro gaming, handheld console, portable gaming, R36S specs, R36S review, retro games, emulator, gaming device",document.head.appendChild(r)}})(),o.forEach(r=>{const d=document.createElement("article");d.className="article",d.id=`article-${r.id}`,d.dataset.articleId=r.id,d.setAttribute("itemscope",""),d.setAttribute("itemtype","http://schema.org/Article");const h=document.createElement("h2");h.className="article__title",h.setAttribute("itemprop","headline"),h.innerHTML=r.title,d.appendChild(h);const l=document.createElement("div");l.className="article__content-wrapper",l.setAttribute("itemprop","articleBody"),r.sections.forEach((f,p)=>{const c=document.createElement("section");if(c.className="article__section",c.id=`section-${r.id}-${p}`,p!==0||f.subtitle!==r.title){const m=document.createElement("h3");m.className="article__subtitle",m.innerHTML=f.subtitle,c.appendChild(m)}const a=document.createElement("div");a.className="article__content",a.innerHTML=f.content,c.appendChild(a),l.appendChild(c)}),d.appendChild(l);const g=document.createElement("script");g.type="application/ld+json";const w={"@context":"https://schema.org","@type":"Article",headline:r.title,description:r.sections[0].content.substring(0,150)+"...",keywords:"R36S, retro gaming, handheld console, portable gaming",author:{"@type":"Organization",name:"R36S Official"},publisher:{"@type":"Organization",name:"R36S",logo:{"@type":"ImageObject",url:"/assets/images/r36s-logo.png"}},datePublished:new Date().toISOString(),dateModified:new Date().toISOString()};g.textContent=JSON.stringify(w),d.appendChild(g);const y=document.createElement("footer");y.className="article__footer";const b=document.createElement("a");b.href="https://www.aliexpress.com/item/1005007171465465.html",b.className="article__cta",b.textContent="Order R36S Now",b.setAttribute("itemprop","url"),b.setAttribute("title","Order R36S Gaming Console"),b.setAttribute("rel","nofollow"),b.setAttribute("target","_blank"),y.appendChild(b),d.appendChild(y),t.appendChild(d)}),(()=>{const r=document.createElement("h1");r.className="articles__heading",r.textContent="R36S Gaming Console - Official Information",e.querySelector(".articles__container").insertBefore(r,e.querySelector(".articles__grid"))})(),setTimeout(()=>{B()},500),setTimeout(()=>{console.log("Проверка наличия элементов аккордеона перед инициализацией:");const r=document.querySelectorAll(".accordion__item");console.log(`Найдено ${r.length} элементов аккордеона`),console.log("Первый элемент аккордеона:",r[0]),r.length>0&&(console.log("Структура первого элемента:"),console.log("- Заголовок:",r[0].querySelector(".accordion__header")),console.log("- Кнопка:",r[0].querySelector(".accordion__toggle")),console.log("- Контент:",r[0].querySelector(".accordion__content"))),console.log("Вызываем initFaqAccordion...");const d=B();console.log("Результат инициализации:",d?"успешно":"ошибка")},1e3),console.log("Инициализация секции Articles завершена успешно")}function Se(){if(console.log("Инициализация переключателей яркости текста в блоках - НАЧАЛО"),window._themeToggleInitialized)return console.warn("Обнаружена повторная инициализация переключателей яркости. Пропускаем..."),window._themeToggleCleanup;window._themeToggleInitialized=!0;const e=document.getElementById("articles")||document.querySelector(".articles"),o=document.getElementById("official-website")||document.querySelector(".official-website"),t=document.getElementById("retro-gaming")||document.querySelector(".retro-gaming");if(!e&&!o&&!t){console.error("Секции для добавления переключателей яркости текста не найдены");return}const n=[];function s(l,g){if(!l)return;console.log(`Добавление переключателей в секцию ${l.id||l.className}`);const w=l.querySelectorAll(".article");console.log(`Найдено ${w.length} блоков для добавления переключателей в секции ${l.id||l.className}`),w.forEach((y,b)=>{const f=g!==void 0?g:b%3;if(y.querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label")){console.warn(`Блок #${b} уже содержит кнопку переключения. Пропускаем создание.`);return}const c=document.createElement("button");switch(c.setAttribute("type","button"),f){case 0:c.className="brightness-toggle",c.innerHTML=`
          ...
          `;const a=y.querySelector(".article__title");if(a){const u=document.createElement("div");u.className="article__title-container";const v=a.cloneNode(!0);u.appendChild(v),u.appendChild(c),a.parentNode.replaceChild(u,a)}else y.insertBefore(c,y.firstChild);break;case 1:c.className="brightness-toggle",c.innerHTML=`
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="#3B82F6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `;const m=y.querySelector(".article__title");if(m){const u=document.createElement("div");u.className="article__title-container";const v=m.cloneNode(!0);u.appendChild(v),u.appendChild(c),m.parentNode.replaceChild(u,m)}else y.insertBefore(c,y.firstChild);break;case 2:c.className="brightness-toggle-with-label",c.innerHTML=`
            <span class="brightness-toggle-label">Ярче</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="brightness-toggle__icon">
              <path fill="none" stroke="#3B82F6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
            </svg>
          `;const i=y.querySelector(".article__title");if(i){const u=document.createElement("div");u.className="article__title-container";const v=i.cloneNode(!0);u.appendChild(v),u.appendChild(c),i.parentNode.replaceChild(u,i)}else y.insertBefore(c,y.firstChild);break}n.push(c)})}e&&s(e);let r;if(t){const l=t.querySelectorAll(".article");if(l.length>0){const g=l[0].querySelector(".brightness-toggle, .brightness-toggle-corner, .brightness-toggle-with-label");g&&(g.classList.contains("brightness-toggle-corner")?r=1:g.classList.contains("brightness-toggle-with-label")?r=2:r=0,console.log(`Обнаружен стиль кнопки в секции R36S Retro Gaming: ${r}`))}}o&&s(o,r!==void 0?r:1),console.log(`Создано ${n.length} кнопок переключения`),n.forEach(l=>{const g=l.cloneNode(!0);l.parentNode&&l.parentNode.replaceChild(g,l);const w=n.indexOf(l);w!==-1&&(n[w]=g)}),n.forEach(l=>{const g=l.closest(".article");if(!g){console.error("Не найден родительский блок .article для кнопки переключения");return}l.addEventListener("click",function(f){if(f.preventDefault(),f.stopPropagation(),console.log("Клик по кнопке переключения яркости"),console.log("Состояние до переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),g.classList.toggle("bright-text"),l.classList.toggle("active"),console.log("Состояние после переключения:",g.classList.contains("bright-text")?"яркий":"обычный"),l.classList.contains("brightness-toggle-with-label")){const m=l.querySelector(".brightness-toggle-label");m&&(m.textContent=g.classList.contains("bright-text")?"Тусклее":"Ярче",console.log("Изменен текст лейбла на:",m.textContent))}const p=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),c=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown",a=g.classList.contains("bright-text")?"bright":"normal";localStorage.setItem(`r36s-${c}-article-brightness-${p}`,a),console.log(`Яркость текста в блоке ${p} секции ${c} изменена на: ${a}`)});const w=g.getAttribute("data-article-id")||g.id||Array.from(g.closest("section").querySelectorAll(".article")).indexOf(g),y=g.closest("section")?g.closest("section").id||g.closest("section").className.split(" ")[0]:"unknown";if(localStorage.getItem(`r36s-${y}-article-brightness-${w}`)==="bright"){if(g.classList.add("bright-text"),l.classList.add("active"),l.classList.contains("brightness-toggle-with-label")){const f=l.querySelector(".brightness-toggle-label");f&&(f.textContent="Тусклее")}console.log(`Восстановлено состояние для блока ${w} в секции ${y}: яркий`)}else console.log(`Блок ${w} в секции ${y} в обычном режиме`)});const d=document.createElement("style");d.textContent=`
  ...
  `,document.head.appendChild(d);const h=function(){n.forEach(l=>{if(l&&l.parentNode){const g=l.closest(".article__title-container");if(g){const w=g.querySelector(".article__title");w&&g.parentNode&&g.parentNode.replaceChild(w,g)}else l.parentNode.removeChild(l)}}),d&&d.parentNode&&d.parentNode.removeChild(d),window._themeToggleInitialized=!1,console.log("Очистка переключателей яркости выполнена")};return window._themeToggleCleanup=h,console.log("Инициализация переключателей яркости текста в блоках - ЗАВЕРШЕНА"),h}const G={"phone-call":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone-call"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path><path d="M14.05 2a9 9 0 0 1 8 7.94"></path><path d="M14.05 6A5 5 0 0 1 18 10"></path></svg>',mail:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>',"map-pin":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>',"message-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle"><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"></path></svg>',send:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send"><path d="m22 2-7 20-4-9-9-4Z"></path><path d="M22 2 11 13"></path></svg>',"alert-circle":'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" x2="12" y1="8" y2="12"></line><line x1="12" x2="12.01" y1="16" y2="16"></line></svg>',loader:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-loader animate-spin"><line x1="12" x2="12" y1="2" y2="6"></line><line x1="12" x2="12" y1="18" y2="22"></line><line x1="4.93" x2="7.76" y1="4.93" y2="7.76"></line><line x1="16.24" x2="19.07" y1="16.24" y2="19.07"></line><line x1="2" x2="6" y1="12" y2="12"></line><line x1="18" x2="22" y1="12" y2="12"></line><line x1="4.93" x2="7.76" y1="19.07" y2="16.24"></line><line x1="16.24" x2="19.07" y1="7.76" y2="4.93"></line></svg>'};function A(e,o=24){return G[e]?G[e].replace(/width="24"/,`width="${o}"`).replace(/height="24"/,`height="${o}"`):(console.error(`Icon "${e}" not found`),"")}function xe(){document.querySelectorAll("[data-icon]").forEach(o=>{const t=o.getAttribute("data-icon"),n=parseInt(o.getAttribute("data-size")||"24",10);t&&(o.innerHTML=A(t,n))})}function Ee(){console.log("Инициализация секции Contact");const e=document.querySelector(".contact__form"),o=document.getElementById("name"),t=document.getElementById("email"),n=document.getElementById("phone"),s=document.getElementById("message"),r=document.querySelector(".form__button"),d=document.createElement("div");d.className="form__error",d.style.display="none",d.innerHTML=`
    <div class="form__error-icon">${A("alert-circle",16)}</div>
    <span></span>
  `,e.insertBefore(d,e.firstChild);const h={name:"",email:"",phone:"",message:""};function l(f){d.querySelector("span").textContent=f,d.style.display="flex"}function g(){d.style.display="none"}function w(f){const{name:p,value:c}=f.target;h[p]=c,g()}o.addEventListener("input",w),t.addEventListener("input",w),n.addEventListener("input",w),s.addEventListener("input",w);async function y(f){f.preventDefault(),b(!0);try{if(!h.name||!h.email||!h.phone||!h.message)throw new Error("Please fill in all fields");if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(h.email))throw new Error("Please enter a valid email");if(!/^\+?[0-9]{10,14}$/.test(h.phone.replace(/\D/g,"")))throw new Error("Please enter a valid phone number.");await new Promise(m=>setTimeout(m,1e3)),o.value="",t.value="",n.value="",s.value="",Object.keys(h).forEach(m=>{h[m]=""}),alert("Message sent successfully! We will contact you shortly.")}catch(c){l(c.message||"There was an error sending your message. Please try again later."),console.error("Form submission error:",c)}finally{b(!1)}}function b(f){[o,t,n,s].forEach(c=>{c.disabled=f}),r.disabled=f,r.innerHTML=f?`<span class="button__icon">${A("loader",20)}</span> Sending...`:`<span class="button__icon">${A("send",20)}</span> Send message`}return e.addEventListener("submit",y),function(){o.removeEventListener("input",w),t.removeEventListener("input",w),n.removeEventListener("input",w),s.removeEventListener("input",w),e.removeEventListener("submit",y)}}function _e(){const e="/R36S_STORE_JS/",t={review1:{webp:`${e}img/reviews/imm_1_1x.webp`,jpg:`${e}img/reviews/imm_1_1x.jpg`},review2:{webp:`${e}img/reviews/imm_2_1x.webp`,jpg:`${e}img/reviews/imm_2_1x.jpg`},review3:{webp:`${e}img/reviews/imm_3_1x.webp`,jpg:`${e}img/reviews/imm_3_1x.jpg`},review4:{webp:`${e}img/reviews/imm_4_1x.webp`,jpg:`${e}img/reviews/imm_4_1x.jpg`}},n=[{id:1,rating:5,color:"Purple 64GB",author:"AliExpress Shopper",date:"21 Aug 2024",text:"I just got my hands on the R36S retro console and it's seriously amazing for old-school gaming. The screen is super clear, it runs games smoothly, and battery life is solid. I love how I can load up my favorite classics and play...",images:{webp:t.review1.webp,jpeg:t.review1.jpg},helpful:12,verified:!0},{id:2,rating:5,color:"Yellow 128G",author:"V***h",date:"26 Aug 2024",text:"After playing with the R36S for a week, I'm really impressed and absolutely delighted. The build quality feels great, and switching between different retro games is super easy. The controls are comfortable for long gaming sessions.",images:{webp:t.review4.webp,jpeg:t.review4.jpg},helpful:8,verified:!0},{id:3,rating:5,color:"White 64GB",author:"M***z",date:"22 Aug 2024",text:"The R36S has become my go-to gaming device. I wasn't sure about buying another retro console, but this one surprised me. The screen is bright and sharp, games run without issues, and it's small enough to fit in my pocket.",images:{webp:t.review3.webp,jpeg:t.review3.jpg},helpful:15,verified:!0},{id:4,rating:5,color:"Black 128GB",author:"K***r",date:"28 Aug 2024",text:"I've been using the R36S for a few weeks now, and I'm genuinely impressed. The 3.5-inch IPS screen delivers crisp visuals, and the build quality feels solid. The dual analog sticks are responsive, making retro gaming a joy.",images:{webp:t.review2.webp,jpeg:t.review2.jpg},helpful:10,verified:!0,mobileOnly:!0}],s=new Set;let r=null,d=window.innerWidth<=1200;function h(i=!1){const u=document.createElementNS("http://www.w3.org/2000/svg","svg");u.classList.add("review-card__star"),u.setAttribute("viewBox","0 0 24 24"),u.setAttribute("fill",i?"currentColor":"none"),u.setAttribute("stroke","currentColor"),u.setAttribute("stroke-width","2");const v=document.createElementNS("http://www.w3.org/2000/svg","polygon");return v.setAttribute("points","12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"),u.appendChild(v),u}function l(){const i=document.createElementNS("http://www.w3.org/2000/svg","svg");i.classList.add("review-card__verified"),i.setAttribute("width","16"),i.setAttribute("height","16"),i.setAttribute("viewBox","0 0 24 24"),i.setAttribute("fill","none"),i.setAttribute("stroke","currentColor"),i.setAttribute("stroke-width","2");const u=document.createElementNS("http://www.w3.org/2000/svg","path");return u.setAttribute("d","M20 6L9 17l-5-5"),i.appendChild(u),i}function g(i){const u=document.getElementById("reviewCardTemplate");if(!u)return console.error("Шаблон карточки отзыва не найден"),null;const v=u.content.cloneNode(!0).querySelector(".review-card");v.dataset.id=i.id,i.mobileOnly&&(v.classList.add("mobile-only"),d||(v.style.display="none"));const x=v.querySelector(".review-card__rating");for(let R=0;R<5;R++)x.appendChild(h(R<i.rating));v.querySelector(".review-card__variant").textContent=i.color,v.querySelector(".review-card__text").textContent=i.text;const k=v.querySelector("picture");k.querySelector("source").setAttribute("srcset",i.images.webp);const S=k.querySelector("img");S.setAttribute("src",i.images.jpeg),S.setAttribute("alt",`Review ${i.id}`);const _=v.querySelector(".review-card__name");i.verified&&_.prepend(l()),_.appendChild(document.createTextNode(i.author)),v.querySelector(".review-card__date").textContent=i.date,v.querySelector(".review-card__helpful-count").textContent=`Helpful (${i.helpful})`,v.addEventListener("click",w),v.addEventListener("mouseenter",()=>y(i.id)),v.addEventListener("mouseleave",b);const C=v.querySelector(".review-card__helpful");return C.addEventListener("mouseenter",()=>{C.querySelector("svg").setAttribute("fill","currentColor"),C.querySelector("svg").classList.add("scale-125"),C.querySelector("svg").classList.remove("scale-100")}),C.addEventListener("mouseleave",()=>{C.querySelector("svg").setAttribute("fill","none"),C.querySelector("svg").classList.remove("scale-125"),C.querySelector("svg").classList.add("scale-100")}),v}function w(){window.open("https://www.aliexpress.com/item/1005007226123844.html#feedback","_blank","noopener,noreferrer")}function y(i){r=i;const u=document.querySelector(`.review-card[data-id="${i}"]`);if(u){const v=u.querySelector(".review-card__arrow-wrapper");v&&(v.style.display="flex")}}function b(){const i=document.querySelector(`.review-card[data-id="${r}"]`);if(i){const u=i.querySelector(".review-card__arrow-wrapper");u&&(u.style.display="none")}r=null}function f(){const i=document.getElementById("reviewsGrid");if(!i){console.error("Контейнер для отзывов не найден");return}const u=document.getElementById("reviewCardTemplate"),v={};i.querySelectorAll(".review-card").forEach(S=>{S.dataset.id&&(v[S.dataset.id]=S)});const x=n.filter(S=>!S.mobileOnly||S.mobileOnly&&d),k=[];x.forEach(S=>{if(v[S.id]){const _=v[S.id];_.style.display="block",k.push(_),delete v[S.id]}else{const _=g(S);_&&k.push(_)}}),Object.values(v).forEach(S=>{S!==u&&(S.style.display="none")}),i.innerHTML="",i.appendChild(u),k.forEach(S=>{i.appendChild(S)}),p()}function p(){if(!("IntersectionObserver"in window)){console.warn("IntersectionObserver не поддерживается в этом браузере"),document.querySelectorAll(".review-card").forEach(u=>{u.classList.add("animate-in")});return}const i=new IntersectionObserver(u=>{u.forEach(v=>{if(v.isIntersecting){const x=v.target.dataset.id;s.has(x)||(v.target.classList.add("animate-in"),s.add(x))}})},{threshold:.1});document.querySelectorAll(".review-card").forEach(u=>{i.observe(u)})}function c(){d=window.innerWidth<=1200,f(),document.querySelectorAll(".review-card").forEach(u=>{u.classList.contains("mobile-only")&&(u.style.display=d?"block":"none")})}function a(){f();let i;const u=()=>{clearTimeout(i),i=setTimeout(c,250)};window.addEventListener("resize",u);const v=document.createElement("style");v.textContent=`
      .review-card {
        opacity: 0;
    ...
    `,document.head.appendChild(v),setTimeout(c,100);const x=document.getElementById("reviews");if(x&&!x.hasAttribute("itemscope")){x.setAttribute("itemscope",""),x.setAttribute("itemtype","http://schema.org/Product");const k=document.createElement("meta");k.setAttribute("itemprop","name"),k.setAttribute("content","R36S Handheld Game Console"),x.prepend(k);const S=document.createElement("meta");S.setAttribute("itemprop","description"),S.setAttribute("content","R36S Handheld Game Console with 3.5-inch IPS screen and retro games"),x.prepend(S)}}a();function m(){if(window.removeEventListener("resize",c),window.removeEventListener("resize",()=>{}),"IntersectionObserver"in window){const i=[];new IntersectionObserver(()=>{}).disconnect(),i.forEach(v=>v.disconnect())}document.querySelectorAll(".review-card").forEach(i=>{i.removeEventListener("click",w),i.removeEventListener("mouseenter",()=>{}),i.removeEventListener("mouseleave",b),Object.keys(n).forEach(v=>{i.removeEventListener("mouseenter",()=>y(v))});const u=i.querySelector(".review-card__helpful");u&&(u.removeEventListener("mouseenter",()=>{}),u.removeEventListener("mouseleave",()=>{}))}),console.log("Reviews section cleanup completed")}return{cleanup:m,renderReviewCards:f}}const ke={};function Le(){console.log("Products секция инициализирована");const o=!ke?"/":"/R36S_STORE_JS/",t={i0_0:{jpg:`${o}img/products/i_0_0x.jpg`,webp:`${o}img/products/i_0_0x.webp`},i1:{jpg:`${o}img/products/i_1_1x.jpg`,webp:`${o}img/products/i_1_1x.webp`},i2:{jpg:`${o}img/products/i_2_1x.jpg`,webp:`${o}img/products/i_2_1x.webp`},i3:{jpg:`${o}img/products/i_3_1x.jpg`,webp:`${o}img/products/i_3_1x.webp`},i4:{jpg:`${o}img/products/i_4_1x.jpg`,webp:`${o}img/products/i_4_1x.webp`},i5:{jpg:`${o}img/products/i_5_1x.jpg`,webp:`${o}img/products/i_5_1x.webp`},i6:{jpg:`${o}img/products/i_6_1x.jpg`,webp:`${o}img/products/i_6_1x.webp`},i7:{jpg:`${o}img/products/i_7_1x.jpg`,webp:`${o}img/products/i_7_1x.webp`},i8:{jpg:`${o}img/products/i_8_1x.jpg`,webp:`${o}img/products/i_8_1x.webp`},i9:{jpg:`${o}img/products/i_9_1x.jpg`,webp:`${o}img/products/i_9_1x.webp`}},n=[{id:"getting-started",title:"Start Guide",content:{text:`Please be aware that this tutorial does not apply to K36 devices or clones marketed as R36S. For additional information about your hardware, please refer to the comprehensive R36S Wiki Page.
...
• A quick press of the power button will put the device into standby mode.`,images:{jpg:t.i9.jpg,webp:t.i9.webp}}},{id:"downloads",title:"Available Downloads",content:{downloads:[{file:"Firmware v1.0.4 2024.04.13",link:"https://drive.google.com/file/d/10z7j7IZ7WX3y10ZJBW_a2-agcIe1Dx9m/edit",date:"2024.04.13",version:"v1.0.4"},{file:"ArkOS_K36_v2.0_03112025.img.xz",link:"https://drive.google.com/file/d/1F93Q1jXYaTCftOlzAt0BaM43rmVexXsn/view",date:"2023.12.22",version:"v1.0.3"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P3.img.xz",link:"https://drive.google.com/file/d/18VL7uLNdyFKDH4_V8YM5zhHSjLiJdkUc/view",date:"2023.11.16",version:"v1.0.2"},{file:"ArkOS_R35S-R36S_v2.0_02092025_P4.img.xz",link:"https://drive.google.com/file/d/1MT1AGGch6Ou4RAfxDvVCxUI4aXX6Qa5v/view",date:"2023.11.05",version:"v1.0.0"}]}}];let s="downloads",r=!1;const d=document.getElementById("products-nav-list"),h=document.getElementById("products-sections"),l=document.getElementById("products-nav");function g(){r=window.innerWidth<=1024,l&&(r?l.classList.add("nav-mobile"):l.classList.remove("nav-mobile"))}function w(c){s=c,document.querySelectorAll(".nav-item").forEach(i=>{i.dataset.sectionId===c?i.classList.add("nav-item-active"):i.classList.remove("nav-item-active")}),document.querySelectorAll(".section").forEach(i=>{i.id===c?i.classList.add("section-active"):i.classList.remove("section-active")}),setTimeout(()=>{const i=document.getElementById(c);if(i){const u=r?80:20,x=i.getBoundingClientRect().top+window.pageYOffset-u;window.scrollTo({top:x,behavior:"smooth"})}},100)}function y(){d.innerHTML="",n.forEach(c=>{const a=document.createElement("button");a.className=`nav-item ${s===c.id?"nav-item-active":""}`,a.dataset.sectionId=c.id,a.innerHTML=`
        ...
        <span>${c.title}</span>
      `,a.addEventListener("click",()=>w(c.id)),d.appendChild(a)})}function b(c){if(c.id==="downloads"){let i='<div class="download-list">';return c.content.downloads.forEach(u=>{i+=`
        ...
        `}),i+="</div>",i}let a='<div class="section-content"><div class="text-content">';return c.content.text.split(`
`).forEach(i=>{a+=`<p>${i.trim()}</p>`}),a+="</div>",c.content.images&&(a+=`
      ...
      `),c.content.subsections&&(a+='<div class="subsections">',c.content.subsections.forEach(i=>{a+=`
          <div class="subsection">
            <h3 class="subsection-title">${i.title}</h3>
            <div class="subsection-content">
              <div class="text-content">
        `,i.content.text.split(`
`).forEach(v=>{a+=`<p>${v.trim()}</p>`}),a+="</div>",i.content.images&&(a+=`
            <div class="image-container">
              <picture>
          ...
          `),a+="</div></div>"}),a+="</div>"),a+="</div>",a}function f(){h.innerHTML="",n.forEach(c=>{const a=document.createElement("section");a.id=c.id,a.className=`section ${s===c.id?"section-active":""}`,a.innerHTML=`
        <h2 class="section-title">${c.title}</h2>
        ${b(c)}
      `,h.appendChild(a)})}function p(){g(),y(),f(),window.addEventListener("resize",g),console.log("Products: Инициализация завершена. Используются пути к изображениям без /public/")}return d&&h&&l?p():console.error("Не найдены необходимые DOM элементы для секции Products"),{handleSectionClick:w,checkMobile:g}}function Ce(){console.log("Инициализация Footer");const e=document.querySelector(".footer");if(!e){console.error("Элемент footer не найден");return}const o=e.querySelector(".partnership-button");o&&o.addEventListener("click",()=>{const t=document.querySelector(".partnership-modal-overlay");if(t){t.classList.add("active");const n=t.querySelector(".partnership-modal-content");n&&n.classList.add("active"),document.body.style.overflow="hidden"}}),Re()}function Re(){const e=document.querySelector(".partnership-modal-overlay");if(!e){console.warn("Модальное окно не найдено");return}const o=e.querySelector(".partnership-modal-close");o&&o.addEventListener("click",t),e.addEventListener("click",n=>{n.target===e&&t()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&e.classList.contains("active")&&t()});function t(){const n=e.querySelector(".partnership-modal-content");e.classList.remove("active"),n&&n.classList.remove("active"),document.body.style.overflow=""}}console.log("Main.js инициализирован");let L=[];function Ie(){const e="IntersectionObserver"in window,o=function(){const n=document.createElement("div");return n.style.display="flex",n.style.display==="flex"}(),t=function(){const n=document.createElement("div");return n.style.display="grid",n.style.display==="grid"}();return console.log("Поддержка браузера:"),console.log("- IntersectionObserver:",e),console.log("- Flexbox:",o),console.log("- CSS Grid:",t),e||document.body.classList.add("no-intersection-observer"),o||document.body.classList.add("no-flexbox"),t||document.body.classList.add("no-grid"),{hasIntersectionObserver:e,hasFlexbox:o,hasGrid:t}}function Ae(){try{L.forEach(e=>{typeof e=="function"&&e()}),L=[]}catch(e){console.warn("Error during global cleanup:",e)}}async function Te(){try{const e=z(T);console.log("Language from URL:",e),await re({forcedLanguage:e}),se()}catch(e){console.error("Error initializing i18n:",e)}}document.addEventListener("DOMContentLoaded",async()=>{console.log("DOM загружен");try{await Te();const e=ae();typeof e=="function"&&L.push(e);const o=le();typeof o=="function"&&L.push(o),xe();const t=Ie(),n=ce();typeof n=="function"&&L.push(n);const s=fe();typeof s=="function"&&L.push(s);const r=we();typeof r=="function"&&L.push(r);const d=ye();typeof d=="function"&&L.push(d);const h=be();typeof h=="function"&&L.push(h);const l=Se();typeof l=="function"&&L.push(l);const g=Ee();typeof g=="function"&&L.push(g);const w=_e();typeof w=="function"&&L.push(w);const y=Le();typeof y=="function"&&L.push(y);const b=Ce();typeof b=="function"&&L.push(b);const f=Q();typeof f=="function"&&L.push(f);const p=performance.now();console.log(`Страница загружена за ${p.toFixed(2)}ms`),window.addEventListener("beforeunload",Ae)}catch(e){console.error("Ошибка при инициализации страницы:",e)}});window.onerror=function(e,o,t,n,s){return console.error("Глобальная ошибка:",{message:e,source:o,lineno:t,colno:n,error:s}),!1};window.addEventListener("unhandledrejection",function(e){console.warn("Непойманное отклонение промиса (unhandled promise rejection):",e.reason)});window.appVersion={version:"1.0.0",buildDate:new Date().toISOString(),environment:"production",basePath:"/R36S_CONSOLE_STORE_JS/"};console.log("Main.js выполнение завершено");
