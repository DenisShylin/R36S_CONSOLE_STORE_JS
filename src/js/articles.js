...
export function initArticles() {
  ...
  setTimeout(() => {
    ...
    console.log('Первый элемент аккордеона:', items[0]);
    ...
    console.log('Вызываем initFaqAccordion...');
    const accordion = initFaqAccordion();
    console.log('Результат инициализации:', accordion ? 'успешно' : 'ошибка');
  }, 1000);
